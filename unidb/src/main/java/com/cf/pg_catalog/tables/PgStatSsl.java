...
import com.cf.pg_catalog.tables.records.PgStatSslRecord;
...
public class PgStatSsl extends TableImpl<PgStatSslRecord> {
    ...
    private static final long serialVersionUID = -1202930332;
    ...
    private PgStatSsl(String alias, Table<PgStatSslRecord> aliased) {
        this(alias, aliased, null);
    }

    private PgStatSsl(String alias, Table<PgStatSslRecord> aliased, Field<?>[] parameters) {
