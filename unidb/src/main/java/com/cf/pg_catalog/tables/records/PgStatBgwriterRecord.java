...
public class PgStatBgwriterRecord extends TableRecordImpl<PgStatBgwriterRecord> implements Record11<Long, Long, Double, Double, Long, Long, Long, Long, Long, Long, Timestamp> {

    private static final long serialVersionUID = 902140714;
     ...
     */
    @Override
    public Row11<Long, Long, Double, Double, Long, Long, Long, Long, Long, Long, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row11<Long, Long, Double, Double, Long, Long, Long, Long, Long, Long, Timestamp> valuesRow() {
     ...
     */
    @Override
    public PgStatBgwriterRecord value11(Timestamp value) {
        setStatsReset(value);
        return this;
    }
     ...
     */
    @Override
    public PgStatBgwriterRecord values(Long value1, Long value2, Double value3, Double value4, Long value5, Long value6, Long value7, Long value8, Long value9, Long value10, Timestamp value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PgStatBgwriterRecord(Long checkpointsTimed, Long checkpointsReq, Double checkpointWriteTime, Double checkpointSyncTime, Long buffersCheckpoint, Long buffersClean, Long maxwrittenClean, Long buffersBackend, Long buffersBackendFsync, Long buffersAlloc, Timestamp statsReset) {
        super(PgStatBgwriter.PG_STAT_BGWRITER);
