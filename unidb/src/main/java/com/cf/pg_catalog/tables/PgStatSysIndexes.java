...
import com.cf.pg_catalog.tables.records.PgStatSysIndexesRecord;
...
public class PgStatSysIndexes extends TableImpl<PgStatSysIndexesRecord> {
    ...
    private static final long serialVersionUID = 1592979794;
    ...
    private PgStatSysIndexes(String alias, Table<PgStatSysIndexesRecord> aliased) {
        this(alias, aliased, null);
    }

    private PgStatSysIndexes(String alias, Table<PgStatSysIndexesRecord> aliased, Field<?>[] parameters) {
