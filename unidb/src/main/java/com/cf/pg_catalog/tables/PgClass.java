...
import com.cf.pg_catalog.tables.records.PgClassRecord;
...
public class PgClass extends TableImpl<PgClassRecord> {
    ...
    private static final long serialVersionUID = -17712720;
    ...
    private PgClass(String alias, Table<PgClassRecord> aliased) {
        this(alias, aliased, null);
    }

    private PgClass(String alias, Table<PgClassRecord> aliased, Field<?>[] parameters) {
