...
import com.cf.pg_catalog.tables.records.PgShdescriptionRecord;
...
public class PgShdescription extends TableImpl<PgShdescriptionRecord> {
    ...
    private static final long serialVersionUID = 397804391;
    ...
    private PgShdescription(String alias, Table<PgShdescriptionRecord> aliased) {
        this(alias, aliased, null);
    }

    private PgShdescription(String alias, Table<PgShdescriptionRecord> aliased, Field<?>[] parameters) {
