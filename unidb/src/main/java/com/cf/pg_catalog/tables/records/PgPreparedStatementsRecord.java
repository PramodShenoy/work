...
public class PgPreparedStatementsRecord extends TableRecordImpl<PgPreparedStatementsRecord> implements Record5<String, String, Timestamp, Object[], Boolean> {

    private static final long serialVersionUID = -1606308934;
     ...
     */
    public void setPrepareTime(Timestamp value) {
        set(2, value);
    }
     ...
     */
    @Override
    public Row5<String, String, Timestamp, Object[], Boolean> fieldsRow() {
     ...
     */
    @Override
    public Row5<String, String, Timestamp, Object[], Boolean> valuesRow() {
     ...
     */
    @Override
    public PgPreparedStatementsRecord value3(Timestamp value) {
     ...
     */
    @Override
    public PgPreparedStatementsRecord values(String value1, String value2, Timestamp value3, Object[] value4, Boolean value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PgPreparedStatementsRecord(String name, String statement, Timestamp prepareTime, Object[] parameterTypes, Boolean fromSql) {
        super(PgPreparedStatements.PG_PREPARED_STATEMENTS);
