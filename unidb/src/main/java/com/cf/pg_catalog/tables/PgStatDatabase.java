...
import com.cf.pg_catalog.tables.records.PgStatDatabaseRecord;
...
public class PgStatDatabase extends TableImpl<PgStatDatabaseRecord> {
    ...
    private static final long serialVersionUID = -2095118425;
     ...
     */
    public final TableField<PgStatDatabaseRecord, Timestamp> STATS_RESET = createField("stats_reset", org.jooq.impl.SQLDataType.TIMESTAMP, this, "");

    /**
     * Create a <code>pg_catalog.pg_stat_database</code> table reference
     */
    public PgStatDatabase() {
        this("pg_stat_database", null);
    }
    ...
    private PgStatDatabase(String alias, Table<PgStatDatabaseRecord> aliased) {
        this(alias, aliased, null);
    }

    private PgStatDatabase(String alias, Table<PgStatDatabaseRecord> aliased, Field<?>[] parameters) {
