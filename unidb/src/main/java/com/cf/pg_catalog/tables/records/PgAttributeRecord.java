...
public class PgAttributeRecord extends TableRecordImpl<PgAttributeRecord> implements Record21<Long, String, Long, Integer, Short, Short, Integer, Integer, Integer, Boolean, String, String, Boolean, Boolean, Boolean, Boolean, Integer, Long, String[], String[], String[]> {

    private static final long serialVersionUID = 1882822579;
     ...
     */
    @Override
    public Row21<Long, String, Long, Integer, Short, Short, Integer, Integer, Integer, Boolean, String, String, Boolean, Boolean, Boolean, Boolean, Integer, Long, String[], String[], String[]> fieldsRow() {
     ...
     */
    @Override
    public Row21<Long, String, Long, Integer, Short, Short, Integer, Integer, Integer, Boolean, String, String, Boolean, Boolean, Boolean, Boolean, Integer, Long, String[], String[], String[]> valuesRow() {
     ...
     */
    @Override
    public PgAttributeRecord value15(Boolean value) {
     ...
     */
    @Override
    public PgAttributeRecord value17(Integer value) {
     ...
     */
    @Override
    public PgAttributeRecord value18(Long value) {
     ...
     */
    @Override
    public PgAttributeRecord value19(String[] value) {
        setAttacl(value);
        return this;
    }
     ...
     */
    public PgAttributeRecord(Long attrelid, String attname, Long atttypid, Integer attstattarget, Short attlen, Short attnum, Integer attndims, Integer attcacheoff, Integer atttypmod, Boolean attbyval, String attstorage, String attalign, Boolean attnotnull, Boolean atthasdef, Boolean attisdropped, Boolean attislocal, Integer attinhcount, Long attcollation, String[] attacl, String[] attoptions, String[] attfdwoptions) {
        super(PgAttribute.PG_ATTRIBUTE);
