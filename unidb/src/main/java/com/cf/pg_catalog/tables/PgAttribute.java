...
import com.cf.pg_catalog.tables.records.PgAttributeRecord;
...
public class PgAttribute extends TableImpl<PgAttributeRecord> {
    ...
    private static final long serialVersionUID = -1237836669;
    ...
    private PgAttribute(String alias, Table<PgAttributeRecord> aliased) {
        this(alias, aliased, null);
    }

    private PgAttribute(String alias, Table<PgAttributeRecord> aliased, Field<?>[] parameters) {
