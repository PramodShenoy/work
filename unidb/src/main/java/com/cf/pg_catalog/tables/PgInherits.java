...
import com.cf.pg_catalog.tables.records.PgInheritsRecord;
...
public class PgInherits extends TableImpl<PgInheritsRecord> {
    ...
    private static final long serialVersionUID = 51103925;
    ...
    private PgInherits(String alias, Table<PgInheritsRecord> aliased) {
        this(alias, aliased, null);
    }

    private PgInherits(String alias, Table<PgInheritsRecord> aliased, Field<?>[] parameters) {
