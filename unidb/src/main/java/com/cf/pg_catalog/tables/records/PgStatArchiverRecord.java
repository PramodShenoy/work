...
public class PgStatArchiverRecord extends TableRecordImpl<PgStatArchiverRecord> implements Record7<Long, String, Timestamp, Long, String, Timestamp, Timestamp> {

    private static final long serialVersionUID = 1010906218;
     ...
     */
    public void setLastArchivedTime(Timestamp value) {
        set(2, value);
    }
     ...
     */
    public void setLastFailedTime(Timestamp value) {
        set(5, value);
    }
     ...
     */
    public void setStatsReset(Timestamp value) {
        set(6, value);
    }
     ...
     */
    @Override
    public Row7<Long, String, Timestamp, Long, String, Timestamp, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row7<Long, String, Timestamp, Long, String, Timestamp, Timestamp> valuesRow() {
     ...
     */
    @Override
    public PgStatArchiverRecord value3(Timestamp value) {
     ...
     */
    @Override
    public PgStatArchiverRecord value6(Timestamp value) {
     ...
     */
    @Override
    public PgStatArchiverRecord value7(Timestamp value) {
        setStatsReset(value);
        return this;
    }
     ...
     */
    @Override
    public PgStatArchiverRecord values(Long value1, String value2, Timestamp value3, Long value4, String value5, Timestamp value6, Timestamp value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PgStatArchiverRecord(Long archivedCount, String lastArchivedWal, Timestamp lastArchivedTime, Long failedCount, String lastFailedWal, Timestamp lastFailedTime, Timestamp statsReset) {
        super(PgStatArchiver.PG_STAT_ARCHIVER);
