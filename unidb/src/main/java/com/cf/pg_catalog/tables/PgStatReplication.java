...
import com.cf.pg_catalog.tables.records.PgStatReplicationRecord;
...
public class PgStatReplication extends TableImpl<PgStatReplicationRecord> {
    ...
    private static final long serialVersionUID = 518648674;
    ...
    /**
     * The column <code>pg_catalog.pg_stat_replication.sent_location</code>.
     */
    public final TableField<PgStatReplicationRecord, Object> SENT_LOCATION = createField("sent_location", org.jooq.impl.DefaultDataType.getDefaultDataType("pg_lsn"), this, "");

    /**
     * The column <code>pg_catalog.pg_stat_replication.write_location</code>.
     */
    public final TableField<PgStatReplicationRecord, Object> WRITE_LOCATION = createField("write_location", org.jooq.impl.DefaultDataType.getDefaultDataType("pg_lsn"), this, "");

    /**
     * The column <code>pg_catalog.pg_stat_replication.flush_location</code>.
     */
    public final TableField<PgStatReplicationRecord, Object> FLUSH_LOCATION = createField("flush_location", org.jooq.impl.DefaultDataType.getDefaultDataType("pg_lsn"), this, "");

    /**
     * The column <code>pg_catalog.pg_stat_replication.replay_location</code>.
     */
    public final TableField<PgStatReplicationRecord, Object> REPLAY_LOCATION = createField("replay_location", org.jooq.impl.DefaultDataType.getDefaultDataType("pg_lsn"), this, "");
