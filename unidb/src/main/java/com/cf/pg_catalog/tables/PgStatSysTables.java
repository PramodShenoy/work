...
import com.cf.pg_catalog.tables.records.PgStatSysTablesRecord;
...
public class PgStatSysTables extends TableImpl<PgStatSysTablesRecord> {
    ...
    private static final long serialVersionUID = 1318807195;
     ...
     */
    public final TableField<PgStatSysTablesRecord, Timestamp> LAST_VACUUM = createField("last_vacuum", org.jooq.impl.SQLDataType.TIMESTAMP, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_sys_tables.last_autovacuum</code>.
     */
    public final TableField<PgStatSysTablesRecord, Timestamp> LAST_AUTOVACUUM = createField("last_autovacuum", org.jooq.impl.SQLDataType.TIMESTAMP, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_sys_tables.last_analyze</code>.
     */
    public final TableField<PgStatSysTablesRecord, Timestamp> LAST_ANALYZE = createField("last_analyze", org.jooq.impl.SQLDataType.TIMESTAMP, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_sys_tables.last_autoanalyze</code>.
     */
    public final TableField<PgStatSysTablesRecord, Timestamp> LAST_AUTOANALYZE = createField("last_autoanalyze", org.jooq.impl.SQLDataType.TIMESTAMP, this, "");
    ...
    private PgStatSysTables(String alias, Table<PgStatSysTablesRecord> aliased) {
        this(alias, aliased, null);
    }

    private PgStatSysTables(String alias, Table<PgStatSysTablesRecord> aliased, Field<?>[] parameters) {
