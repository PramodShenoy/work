...
import com.cf.pg_catalog.tables.records.PgRolesRecord;
...
public class PgRoles extends TableImpl<PgRolesRecord> {
    ...
    private static final long serialVersionUID = 344639066;
     ...
     */
    public final TableField<PgRolesRecord, Timestamp> ROLVALIDUNTIL = createField("rolvaliduntil", org.jooq.impl.SQLDataType.TIMESTAMP, this, "");
    ...
    private PgRoles(String alias, Table<PgRolesRecord> aliased) {
        this(alias, aliased, null);
    }

    private PgRoles(String alias, Table<PgRolesRecord> aliased, Field<?>[] parameters) {
