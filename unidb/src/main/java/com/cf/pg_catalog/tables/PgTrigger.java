...
import com.cf.pg_catalog.tables.records.PgTriggerRecord;
...
public class PgTrigger extends TableImpl<PgTriggerRecord> {
    ...
    private static final long serialVersionUID = -845069344;
     ...
     */
    public final TableField<PgTriggerRecord, Object[]> TGATTR = createField("tgattr", org.jooq.impl.DefaultDataType.getDefaultDataType("int2vector").getArrayDataType(), this, "");
    ...
    /**
     * The column <code>pg_catalog.pg_trigger.tgqual</code>.
     */
    public final TableField<PgTriggerRecord, Object> TGQUAL = createField("tgqual", org.jooq.impl.DefaultDataType.getDefaultDataType("pg_node_tree"), this, "");

    /**
     * Create a <code>pg_catalog.pg_trigger</code> table reference
     */
    public PgTrigger() {
        this("pg_trigger", null);
    }
    ...
    private PgTrigger(String alias, Table<PgTriggerRecord> aliased) {
        this(alias, aliased, null);
    }

    private PgTrigger(String alias, Table<PgTriggerRecord> aliased, Field<?>[] parameters) {
