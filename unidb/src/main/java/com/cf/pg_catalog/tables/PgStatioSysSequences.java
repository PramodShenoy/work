...
import com.cf.pg_catalog.tables.records.PgStatioSysSequencesRecord;
...
public class PgStatioSysSequences extends TableImpl<PgStatioSysSequencesRecord> {
    ...
    private static final long serialVersionUID = -214796098;
    ...
    public PgStatioSysSequences() {
        this("pg_statio_sys_sequences", null);
    }
    ...
    private PgStatioSysSequences(String alias, Table<PgStatioSysSequencesRecord> aliased) {
        this(alias, aliased, null);
    }

    private PgStatioSysSequences(String alias, Table<PgStatioSysSequencesRecord> aliased, Field<?>[] parameters) {
