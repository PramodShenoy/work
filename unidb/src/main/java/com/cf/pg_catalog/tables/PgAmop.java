...
import com.cf.pg_catalog.tables.records.PgAmopRecord;
...
public class PgAmop extends TableImpl<PgAmopRecord> {
    ...
    private static final long serialVersionUID = 1970853823;
    ...
    private PgAmop(String alias, Table<PgAmopRecord> aliased) {
        this(alias, aliased, null);
    }

    private PgAmop(String alias, Table<PgAmopRecord> aliased, Field<?>[] parameters) {
