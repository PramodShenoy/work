...
import com.cf.pg_catalog.tables.records.PgStatActivityRecord;
...
public class PgStatActivity extends TableImpl<PgStatActivityRecord> {
    ...
    private static final long serialVersionUID = 492736955;
    ...
    /**
     * The column <code>pg_catalog.pg_stat_activity.waiting</code>.
     */
    public final TableField<PgStatActivityRecord, Boolean> WAITING = createField("waiting", org.jooq.impl.SQLDataType.BOOLEAN, this, "");
