...
public class VarSamp4 extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1277084562;
     ...
     */
    public VarSamp4() {
        super("var_samp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
