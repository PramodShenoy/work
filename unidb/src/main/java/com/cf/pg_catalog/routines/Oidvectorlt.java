...
public class Oidvectorlt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1900105150;

    /**
     * The parameter <code>pg_catalog.oidvectorlt.RETURN_VALUE</code>.
     */
     ...
     */
    public Oidvectorlt() {
        super("oidvectorlt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
