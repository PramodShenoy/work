...
public class Nameiclike extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1385636015;

    /**
     * The parameter <code>pg_catalog.nameiclike.RETURN_VALUE</code>.
     */
     ...
     */
    public Nameiclike() {
        super("nameiclike", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
