...
public class Varbitlt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 926119838;

    /**
     * The parameter <code>pg_catalog.varbitlt.RETURN_VALUE</code>.
     */
     ...
     */
    public Varbitlt() {
        super("varbitlt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
