...
public class TimestampEq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -130440394;
     ...
     */
    public TimestampEq() {
        super("timestamp_eq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
