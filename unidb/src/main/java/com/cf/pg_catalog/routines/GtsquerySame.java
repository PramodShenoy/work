...
public class GtsquerySame extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -1980727540;

    /**
     * The parameter <code>pg_catalog.gtsquery_same.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.gtsquery_same._3</code>.
     */
     ...
     */
    public GtsquerySame() {
        super("gtsquery_same", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
