...
public class DateEqTimestamptz extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 943150040;

    /**
     * The parameter <code>pg_catalog.date_eq_timestamptz.RETURN_VALUE</code>.
     */
     ...
     */
    public DateEqTimestamptz() {
        super("date_eq_timestamptz", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
