...
public class UuidLt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1703992897;

    /**
     * The parameter <code>pg_catalog.uuid_lt.RETURN_VALUE</code>.
     */
     ...
     */
    public UuidLt() {
        super("uuid_lt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
