...
public class TextSmaller extends AbstractRoutine<String> {

    private static final long serialVersionUID = -1391277832;
     ...
     */
    public TextSmaller() {
        super("text_smaller", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
