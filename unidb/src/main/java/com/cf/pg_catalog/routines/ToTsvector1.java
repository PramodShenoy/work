...
public class ToTsvector1 extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1277995244;

    /**
     * The parameter <code>pg_catalog.to_tsvector.RETURN_VALUE</code>.
     */
