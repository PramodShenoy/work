...
public class Texteq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1359082118;

    /**
     * The parameter <code>pg_catalog.texteq.RETURN_VALUE</code>.
     */
     ...
     */
    public Texteq() {
        super("texteq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
