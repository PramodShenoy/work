...
public class Min3 extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -1558327561;
     ...
     */
    public Min3() {
        super("min", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
