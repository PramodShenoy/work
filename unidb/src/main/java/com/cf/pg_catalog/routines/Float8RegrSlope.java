...
public class Float8RegrSlope extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -416913256;

    /**
     * The parameter <code>pg_catalog.float8_regr_slope.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.float8_regr_slope._1</code>.
     */
     ...
     */
    public Float8RegrSlope() {
        super("float8_regr_slope", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
