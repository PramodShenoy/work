...
public class PgStatGetXactFunctionSelfTime extends AbstractRoutine<Double> {
    ...
    private static final long serialVersionUID = 292663601;

    /**
     * The parameter <code>pg_catalog.pg_stat_get_xact_function_self_time.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.pg_stat_get_xact_function_self_time._1</code>.
     */
    ...
    public PgStatGetXactFunctionSelfTime() {
        super("pg_stat_get_xact_function_self_time", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
