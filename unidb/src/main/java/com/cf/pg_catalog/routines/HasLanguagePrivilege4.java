...
public class HasLanguagePrivilege4 extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1885710145;

    /**
     * The parameter <code>pg_catalog.has_language_privilege.RETURN_VALUE</code>.
     */
     ...
     */
    public HasLanguagePrivilege4() {
        super("has_language_privilege", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
