...
public class Float48mul extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 928489458;

    /**
     * The parameter <code>pg_catalog.float48mul.RETURN_VALUE</code>.
     */
     ...
     */
    public Float48mul() {
        super("float48mul", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
