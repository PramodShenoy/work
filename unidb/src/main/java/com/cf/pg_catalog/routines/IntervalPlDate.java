...
public class IntervalPlDate extends AbstractRoutine<Timestamp> {

    private static final long serialVersionUID = -1311265191;
    ...
    public IntervalPlDate() {
        super("interval_pl_date", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIMESTAMP);
