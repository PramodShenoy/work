...
public class Dexp extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1477185051;
     ...
     */
    public Dexp() {
        super("dexp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
