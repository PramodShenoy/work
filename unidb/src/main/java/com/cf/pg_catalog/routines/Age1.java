...
public class Age1 extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -336259573;
     ...
     */
    public Age1() {
        super("age", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
