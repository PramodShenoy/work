...
public class Int24pl extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 2010704500;
     ...
     */
    public Int24pl() {
        super("int24pl", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
