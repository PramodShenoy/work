...
public class VarPop5 extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -1357937076;
     ...
     */
    public VarPop5() {
        super("var_pop", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
