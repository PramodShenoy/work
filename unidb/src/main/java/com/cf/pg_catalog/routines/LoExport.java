...
public class LoExport extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1719487282;
     ...
     */
    public LoExport() {
        super("lo_export", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
