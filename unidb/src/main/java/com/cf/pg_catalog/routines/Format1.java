...
public class Format1 extends AbstractRoutine<String> {

    private static final long serialVersionUID = 1294761853;
    ...
    /**
     * The parameter <code>pg_catalog.format._2</code>.
     */
     ...
     */
    public Format1() {
        super("format", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
