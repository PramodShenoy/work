...
public class Money2 extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1942292045;

    /**
     * The parameter <code>pg_catalog.money.RETURN_VALUE</code>.
     */
     ...
     */
    public Money2() {
        super("money", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
