...
public class Float4le extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 974237574;

    /**
     * The parameter <code>pg_catalog.float4le.RETURN_VALUE</code>.
     */
     ...
     */
    public Float4le() {
        super("float4le", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
