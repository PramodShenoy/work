...
public class NumericEq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -322524295;
     ...
     */
    public NumericEq() {
        super("numeric_eq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
