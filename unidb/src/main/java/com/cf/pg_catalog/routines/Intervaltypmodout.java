...
public class Intervaltypmodout extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 712637228;

    /**
     * The parameter <code>pg_catalog.intervaltypmodout.RETURN_VALUE</code>.
     */
     ...
     */
    public Intervaltypmodout() {
        super("intervaltypmodout", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("cstring"));
