...
public class MakeTimestamptz2 extends AbstractRoutine<Timestamp> {

    private static final long serialVersionUID = -1539516122;
     ...
     */
    public static final Parameter<String> TIMEZONE = createParameter("timezone", org.jooq.impl.SQLDataType.CLOB, false, false);

    /**
     * Create a new routine call instance
     */
    public MakeTimestamptz2() {
        super("make_timestamptz", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIMESTAMP);
    ...
    /**
     * Set the <code>timezone</code> parameter to the function to be used with a {@link org.jooq.Select} statement
     */
