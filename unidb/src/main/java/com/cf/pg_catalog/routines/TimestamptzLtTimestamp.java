...
public class TimestamptzLtTimestamp extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1804446428;

    /**
     * The parameter <code>pg_catalog.timestamptz_lt_timestamp.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.timestamptz_lt_timestamp._1</code>.
     */
    public static final Parameter<Timestamp> _1 = createParameter("_1", org.jooq.impl.SQLDataType.TIMESTAMP, false, true);

    /**
     * The parameter <code>pg_catalog.timestamptz_lt_timestamp._2</code>.
     */
     ...
     */
    public TimestamptzLtTimestamp() {
        super("timestamptz_lt_timestamp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
