...
public class Int84gt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -691680431;

    /**
     * The parameter <code>pg_catalog.int84gt.RETURN_VALUE</code>.
     */
     ...
     */
    public Int84gt() {
        super("int84gt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
