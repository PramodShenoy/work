...
public class RecordImageNe extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1154201738;

    /**
     * The parameter <code>pg_catalog.record_image_ne.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.record_image_ne._1</code>.
     */
    public static final Parameter<Record> _1 = createParameter("_1", org.jooq.impl.SQLDataType.RECORD, false, true);

    /**
     * The parameter <code>pg_catalog.record_image_ne._2</code>.
     */
     ...
     */
    public RecordImageNe() {
        super("record_image_ne", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
