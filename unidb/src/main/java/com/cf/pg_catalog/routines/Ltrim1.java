...
public class Ltrim1 extends AbstractRoutine<String> {

    private static final long serialVersionUID = 1885707179;

    /**
     * The parameter <code>pg_catalog.ltrim.RETURN_VALUE</code>.
     */
     ...
     */
    public Ltrim1() {
        super("ltrim", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
