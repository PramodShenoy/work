...
public class HasTablespacePrivilege1 extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 2024022448;

    /**
     * The parameter <code>pg_catalog.has_tablespace_privilege.RETURN_VALUE</code>.
     */
     ...
     */
    public HasTablespacePrivilege1() {
        super("has_tablespace_privilege", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
