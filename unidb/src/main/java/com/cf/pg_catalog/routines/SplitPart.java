...
public class SplitPart extends AbstractRoutine<String> {

    private static final long serialVersionUID = 821106248;
     ...
     */
    public SplitPart() {
        super("split_part", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
