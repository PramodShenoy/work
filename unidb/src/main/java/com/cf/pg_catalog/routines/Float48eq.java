...
public class Float48eq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -317610558;

    /**
     * The parameter <code>pg_catalog.float48eq.RETURN_VALUE</code>.
     */
     ...
     */
    public Float48eq() {
        super("float48eq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
