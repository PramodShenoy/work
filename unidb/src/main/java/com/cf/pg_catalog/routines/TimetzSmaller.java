...
public class TimetzSmaller extends AbstractRoutine<Time> {

    private static final long serialVersionUID = 126226025;

    /**
     * The parameter <code>pg_catalog.timetz_smaller.RETURN_VALUE</code>.
     */
    public static final Parameter<Time> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.TIME, false, false);

    /**
     * The parameter <code>pg_catalog.timetz_smaller._1</code>.
     */
    public static final Parameter<Time> _1 = createParameter("_1", org.jooq.impl.SQLDataType.TIME, false, true);

    /**
     * The parameter <code>pg_catalog.timetz_smaller._2</code>.
     */
     ...
     */
    public TimetzSmaller() {
        super("timetz_smaller", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIME);
