...
public class XpathExists1 extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -2098568802;
     ...
     */
    public XpathExists1() {
        super("xpath_exists", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
