...
public class Timetypmodout extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1380743076;

    /**
     * The parameter <code>pg_catalog.timetypmodout.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.timetypmodout._1</code>.
     */
     ...
     */
    public Timetypmodout() {
        super("timetypmodout", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("cstring"));
