...
public class IntervalRecv extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1002376932;

    /**
     * The parameter <code>pg_catalog.interval_recv.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.interval_recv._1</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.interval_recv._2</code>.
     */
    public static final Parameter<Long> _2 = createParameter("_2", org.jooq.impl.SQLDataType.BIGINT, false, true);

    /**
     * The parameter <code>pg_catalog.interval_recv._3</code>.
     */
     ...
     */
    public IntervalRecv() {
        super("interval_recv", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("interval"));
