...
public class Gistcanreturn extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1481112435;

    /**
     * The parameter <code>pg_catalog.gistcanreturn.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.gistcanreturn._1</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.gistcanreturn._2</code>.
     */
     ...
     */
    public Gistcanreturn() {
        super("gistcanreturn", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
