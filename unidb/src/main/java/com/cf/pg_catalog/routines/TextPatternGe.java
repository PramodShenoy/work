...
public class TextPatternGe extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 252680532;
     ...
     */
    public TextPatternGe() {
        super("text_pattern_ge", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
