...
public class UpperInc extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1371965450;

    /**
     * The parameter <code>pg_catalog.upper_inc.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.upper_inc._1</code>.
     */
     ...
     */
    public UpperInc() {
        super("upper_inc", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
