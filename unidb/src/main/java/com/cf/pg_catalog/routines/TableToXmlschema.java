...
public class TableToXmlschema extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -929681815;

    /**
     * The parameter <code>pg_catalog.table_to_xmlschema.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.table_to_xmlschema.tbl</code>.
     */
    ...
    public TableToXmlschema() {
        super("table_to_xmlschema", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("xml"));
