...
public class CashNe extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1554656887;

    /**
     * The parameter <code>pg_catalog.cash_ne.RETURN_VALUE</code>.
     */
     ...
     */
    public CashNe() {
        super("cash_ne", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
