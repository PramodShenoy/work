...
public class Float84gt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1085281212;

    /**
     * The parameter <code>pg_catalog.float84gt.RETURN_VALUE</code>.
     */
     ...
     */
    public Float84gt() {
        super("float84gt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
