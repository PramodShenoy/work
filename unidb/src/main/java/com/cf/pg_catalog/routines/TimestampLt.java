...
public class TimestampLt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -2008336602;
     ...
     */
    public TimestampLt() {
        super("timestamp_lt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
