...
public class PgGetFunctionResult extends AbstractRoutine<String> {
    ...
    private static final long serialVersionUID = -1493241246;

    /**
     * The parameter <code>pg_catalog.pg_get_function_result.RETURN_VALUE</code>.
     */
    ...
    public PgGetFunctionResult() {
        super("pg_get_function_result", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
