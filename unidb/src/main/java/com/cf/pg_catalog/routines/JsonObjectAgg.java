...
public class JsonObjectAgg extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -108685172;

    /**
     * The parameter <code>pg_catalog.json_object_agg.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.json_object_agg._1</code>.
     */
    public static final Parameter<Object> _1 = createParameter("_1", org.jooq.impl.SQLDataType.OTHER, false, true);

    /**
     * The parameter <code>pg_catalog.json_object_agg._2</code>.
     */
    ...
    public JsonObjectAgg() {
        super("json_object_agg", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.OTHER);
