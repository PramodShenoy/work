...
public class Int8pl extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -2105311488;

    /**
     * The parameter <code>pg_catalog.int8pl.RETURN_VALUE</code>.
     */
     ...
     */
    public Int8pl() {
        super("int8pl", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
