...
public class Bttidcmp extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -1464313430;

    /**
     * The parameter <code>pg_catalog.bttidcmp.RETURN_VALUE</code>.
     */
    public static final Parameter<Integer> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>pg_catalog.bttidcmp._1</code>.
     */
    public static final Parameter<Long> _1 = createParameter("_1", org.jooq.impl.SQLDataType.BIGINT, false, true);

    /**
     * The parameter <code>pg_catalog.bttidcmp._2</code>.
     */
     ...
     */
    public Bttidcmp() {
        super("bttidcmp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
