...
public class JsonEachText extends AbstractRoutine<Void> {

    private static final long serialVersionUID = -1309877216;

    /**
     * The parameter <code>pg_catalog.json_each_text.from_json</code>.
     */
    public static final Parameter<Object> FROM_JSON = createParameter("from_json", org.jooq.impl.SQLDataType.OTHER, false, false);

    /**
     * The parameter <code>pg_catalog.json_each_text.key</code>.
     */
    public static final Parameter<String> KEY = createParameter("key", org.jooq.impl.SQLDataType.CLOB, false, false);

    /**
     * The parameter <code>pg_catalog.json_each_text.value</code>.
     */
     ...
     */
    public JsonEachText() {
        super("json_each_text", PgCatalog.PG_CATALOG);
