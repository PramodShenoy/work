...
public class Float8VarSamp extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 616919609;
     ...
     */
    public Float8VarSamp() {
        super("float8_var_samp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
