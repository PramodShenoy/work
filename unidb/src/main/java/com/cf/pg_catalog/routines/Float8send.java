...
public class Float8send extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = 842687492;

    /**
     * The parameter <code>pg_catalog.float8send.RETURN_VALUE</code>.
     */
    public static final Parameter<byte[]> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.BLOB, false, false);

    /**
     * The parameter <code>pg_catalog.float8send._1</code>.
     */
     ...
     */
    public Float8send() {
        super("float8send", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
