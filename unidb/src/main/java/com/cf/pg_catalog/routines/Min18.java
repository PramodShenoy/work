...
public class Min18 extends AbstractRoutine<String> {

    private static final long serialVersionUID = -399944000;
     ...
     */
    public Min18() {
        super("min", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CHAR);
