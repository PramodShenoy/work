...
public class CashLt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 312484819;

    /**
     * The parameter <code>pg_catalog.cash_lt.RETURN_VALUE</code>.
     */
     ...
     */
    public CashLt() {
        super("cash_lt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
