...
public class PostgresqlFdwValidator extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1547295316;

    /**
     * The parameter <code>pg_catalog.postgresql_fdw_validator.RETURN_VALUE</code>.
     */
     ...
     */
    public PostgresqlFdwValidator() {
        super("postgresql_fdw_validator", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
