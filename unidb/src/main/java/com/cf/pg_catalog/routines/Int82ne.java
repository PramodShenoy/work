...
public class Int82ne extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1191106931;

    /**
     * The parameter <code>pg_catalog.int82ne.RETURN_VALUE</code>.
     */
     ...
     */
    public Int82ne() {
        super("int82ne", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
