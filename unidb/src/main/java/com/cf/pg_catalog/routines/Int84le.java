...
public class Int84le extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 505123433;

    /**
     * The parameter <code>pg_catalog.int84le.RETURN_VALUE</code>.
     */
     ...
     */
    public Int84le() {
        super("int84le", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
