...
public class PercentileCont4 extends AbstractRoutine<Object[]> {

    private static final long serialVersionUID = 1516020725;
     ...
     */
    public PercentileCont4() {
        super("percentile_cont", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("interval").getArrayDataType());
