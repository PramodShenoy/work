...
public class JsonStripNulls extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1525683493;
    ...
    public JsonStripNulls() {
        super("json_strip_nulls", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.OTHER);
