...
public class NumericUplus extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 1291541934;

    /**
     * The parameter <code>pg_catalog.numeric_uplus.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.numeric_uplus._1</code>.
     */
     ...
     */
    public NumericUplus() {
        super("numeric_uplus", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
