...
public class Int42gt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 417189030;

    /**
     * The parameter <code>pg_catalog.int42gt.RETURN_VALUE</code>.
     */
     ...
     */
    public Int42gt() {
        super("int42gt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
