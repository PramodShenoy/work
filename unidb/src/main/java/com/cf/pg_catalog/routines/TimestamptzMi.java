...
public class TimestamptzMi extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -1588191812;
    ...
    public TimestamptzMi() {
        super("timestamptz_mi", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("interval"));
