...
public class TimeLarger extends AbstractRoutine<Time> {

    private static final long serialVersionUID = 378665225;
     ...
     */
    public TimeLarger() {
        super("time_larger", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIME);
