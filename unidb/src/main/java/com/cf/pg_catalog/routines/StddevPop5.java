...
public class StddevPop5 extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 765267757;
     ...
     */
    public StddevPop5() {
        super("stddev_pop", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
