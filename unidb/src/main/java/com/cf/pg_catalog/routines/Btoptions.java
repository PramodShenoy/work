...
public class Btoptions extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = 1859917549;

    /**
     * The parameter <code>pg_catalog.btoptions.RETURN_VALUE</code>.
     */
    public static final Parameter<byte[]> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.BLOB, false, false);

    /**
     * The parameter <code>pg_catalog.btoptions._1</code>.
     */
    public static final Parameter<String[]> _1 = createParameter("_1", org.jooq.impl.SQLDataType.CLOB.getArrayDataType(), false, true);

    /**
     * The parameter <code>pg_catalog.btoptions._2</code>.
     */
     ...
     */
    public Btoptions() {
        super("btoptions", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
