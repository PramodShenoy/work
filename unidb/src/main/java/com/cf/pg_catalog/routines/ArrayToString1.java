...
public class ArrayToString1 extends AbstractRoutine<String> {

    private static final long serialVersionUID = -1444379227;
    ...
    /**
     * The parameter <code>pg_catalog.array_to_string._3</code>.
     */
     ...
     */
    public ArrayToString1() {
        super("array_to_string", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
