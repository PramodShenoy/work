...
public class Cidrecv extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 178753527;
    ...
    /**
     * The parameter <code>pg_catalog.cidrecv._1</code>.
     */
     ...
     */
    public Cidrecv() {
        super("cidrecv", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
