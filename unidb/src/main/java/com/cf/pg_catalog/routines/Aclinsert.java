...
public class Aclinsert extends AbstractRoutine<String[]> {

    private static final long serialVersionUID = -761823656;
     ...
     */
    public Aclinsert() {
        super("aclinsert", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.VARCHAR.getArrayDataType());
