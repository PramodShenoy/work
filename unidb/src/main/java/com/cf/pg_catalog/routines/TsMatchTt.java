...
public class TsMatchTt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1561831926;

    /**
     * The parameter <code>pg_catalog.ts_match_tt.RETURN_VALUE</code>.
     */
     ...
     */
    public TsMatchTt() {
        super("ts_match_tt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
