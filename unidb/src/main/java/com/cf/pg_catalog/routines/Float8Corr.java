...
public class Float8Corr extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 2013847076;
     ...
     */
    public Float8Corr() {
        super("float8_corr", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
