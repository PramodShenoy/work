...
public class Int82lt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1828997099;

    /**
     * The parameter <code>pg_catalog.int82lt.RETURN_VALUE</code>.
     */
     ...
     */
    public Int82lt() {
        super("int82lt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
