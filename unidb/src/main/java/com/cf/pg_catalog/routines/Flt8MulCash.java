...
public class Flt8MulCash extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1004595403;

    /**
     * The parameter <code>pg_catalog.flt8_mul_cash.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.flt8_mul_cash._1</code>.
     */
    public static final Parameter<Double> _1 = createParameter("_1", org.jooq.impl.SQLDataType.DOUBLE, false, true);

    /**
     * The parameter <code>pg_catalog.flt8_mul_cash._2</code>.
     */
     ...
     */
    public Flt8MulCash() {
        super("flt8_mul_cash", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
