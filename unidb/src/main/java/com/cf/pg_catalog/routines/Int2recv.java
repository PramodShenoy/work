...
public class Int2recv extends AbstractRoutine<Short> {

    private static final long serialVersionUID = -1231266334;

    /**
     * The parameter <code>pg_catalog.int2recv.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.int2recv._1</code>.
     */
     ...
     */
    public Int2recv() {
        super("int2recv", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.SMALLINT);
