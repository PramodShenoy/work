...
public class Int2AvgAccum extends AbstractRoutine<Long[]> {

    private static final long serialVersionUID = 492163003;

    /**
     * The parameter <code>pg_catalog.int2_avg_accum.RETURN_VALUE</code>.
     */
     ...
     */
    public Int2AvgAccum() {
        super("int2_avg_accum", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT.getArrayDataType());
