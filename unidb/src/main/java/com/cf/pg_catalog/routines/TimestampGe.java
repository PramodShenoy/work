...
public class TimestampGe extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1923815490;

    /**
     * The parameter <code>pg_catalog.timestamp_ge.RETURN_VALUE</code>.
     */
     ...
     */
    public TimestampGe() {
        super("timestamp_ge", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
