...
public class DateEqTimestamp extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -244454132;
    ...
    public DateEqTimestamp() {
        super("date_eq_timestamp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
