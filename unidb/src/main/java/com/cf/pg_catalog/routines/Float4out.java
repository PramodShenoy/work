...
public class Float4out extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1165171560;

    /**
     * The parameter <code>pg_catalog.float4out.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.float4out._1</code>.
     */
     ...
     */
    public Float4out() {
        super("float4out", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("cstring"));
