...
public class Xmlcomment extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 315251687;
     ...
     */
    public Xmlcomment() {
        super("xmlcomment", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("xml"));
