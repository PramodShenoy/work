...
public class Bpcharlike extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 12789152;

    /**
     * The parameter <code>pg_catalog.bpcharlike.RETURN_VALUE</code>.
     */
     ...
     */
    public Bpcharlike() {
        super("bpcharlike", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
