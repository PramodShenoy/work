...
public class DateRecv extends AbstractRoutine<Date> {
    ...
    private static final long serialVersionUID = -1631314950;
    ...
    /**
     * The parameter <code>pg_catalog.date_recv._1</code>.
     */
     ...
     */
    public DateRecv() {
        super("date_recv", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DATE);
