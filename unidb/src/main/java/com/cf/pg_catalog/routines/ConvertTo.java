...
public class ConvertTo extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = -1559451775;
     ...
     */
    public ConvertTo() {
        super("convert_to", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
