...
public class TimeSmaller extends AbstractRoutine<Time> {

    private static final long serialVersionUID = -2111908875;
     ...
     */
    public TimeSmaller() {
        super("time_smaller", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIME);
