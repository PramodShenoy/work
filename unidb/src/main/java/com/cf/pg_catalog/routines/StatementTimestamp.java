...
public class StatementTimestamp extends AbstractRoutine<Timestamp> {

    private static final long serialVersionUID = -1383070711;
    ...
    public StatementTimestamp() {
        super("statement_timestamp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIMESTAMP);
