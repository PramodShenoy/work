...
public class Float48ge extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 107982778;

    /**
     * The parameter <code>pg_catalog.float48ge.RETURN_VALUE</code>.
     */
     ...
     */
    public Float48ge() {
        super("float48ge", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
