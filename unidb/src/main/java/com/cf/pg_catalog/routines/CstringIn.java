...
public class CstringIn extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1090223092;

    /**
     * The parameter <code>pg_catalog.cstring_in.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.cstring_in._1</code>.
     */
     ...
     */
    public CstringIn() {
        super("cstring_in", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("cstring"));
