...
public class Xml extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1623740362;
     ...
     */
    public Xml() {
        super("xml", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("xml"));
