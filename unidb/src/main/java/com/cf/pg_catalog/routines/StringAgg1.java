...
public class StringAgg1 extends AbstractRoutine<String> {
    ...
    private static final long serialVersionUID = -505908969;
     ...
     */
    public StringAgg1() {
        super("string_agg", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
