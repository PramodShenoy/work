...
public class TimeGe extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1925773983;
     ...
     */
    public TimeGe() {
        super("time_ge", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
