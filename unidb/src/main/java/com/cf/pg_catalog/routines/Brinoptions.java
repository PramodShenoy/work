...
public class Brinoptions extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = 573281511;

    /**
     * The parameter <code>pg_catalog.brinoptions.RETURN_VALUE</code>.
     */
    public static final Parameter<byte[]> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.BLOB, false, false);

    /**
     * The parameter <code>pg_catalog.brinoptions._1</code>.
     */
    public static final Parameter<String[]> _1 = createParameter("_1", org.jooq.impl.SQLDataType.CLOB.getArrayDataType(), false, true);

    /**
     * The parameter <code>pg_catalog.brinoptions._2</code>.
     */
     ...
     */
    public Brinoptions() {
        super("brinoptions", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
