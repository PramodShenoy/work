...
public class Netmask extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1395504637;

    /**
     * The parameter <code>pg_catalog.netmask.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.netmask._1</code>.
     */
     ...
     */
    public Netmask() {
        super("netmask", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("inet"));
