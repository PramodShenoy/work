...
public class UuidRecv extends AbstractRoutine<UUID> {

    private static final long serialVersionUID = -1244810132;

    /**
     * The parameter <code>pg_catalog.uuid_recv.RETURN_VALUE</code>.
     */
    public static final Parameter<UUID> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.UUID, false, false);

    /**
     * The parameter <code>pg_catalog.uuid_recv._1</code>.
     */
     ...
     */
    public UuidRecv() {
        super("uuid_recv", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.UUID);
