...
public class TextLt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 92280952;

    /**
     * The parameter <code>pg_catalog.text_lt.RETURN_VALUE</code>.
     */
     ...
     */
    public TextLt() {
        super("text_lt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
