...
public class RegrSyy extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1609006882;

    /**
     * The parameter <code>pg_catalog.regr_syy.RETURN_VALUE</code>.
     */
     ...
     */
    public RegrSyy() {
        super("regr_syy", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
