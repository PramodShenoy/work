...
public class Lpad2 extends AbstractRoutine<String> {

    private static final long serialVersionUID = 1884409598;

    /**
     * The parameter <code>pg_catalog.lpad.RETURN_VALUE</code>.
     */
     ...
     */
    public Lpad2() {
        super("lpad", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
