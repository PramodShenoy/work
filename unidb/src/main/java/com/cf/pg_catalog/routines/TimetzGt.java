...
public class TimetzGt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 786416181;

    /**
     * The parameter <code>pg_catalog.timetz_gt.RETURN_VALUE</code>.
     */
     ...
     */
    public TimetzGt() {
        super("timetz_gt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
