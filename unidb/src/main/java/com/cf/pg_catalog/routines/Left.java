...
public class Left extends AbstractRoutine<String> {

    private static final long serialVersionUID = -58125079;
     ...
     */
    public Left() {
        super("left", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
