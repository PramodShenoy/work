...
public class VarbitRecv extends AbstractRoutine<String> {
    ...
    private static final long serialVersionUID = 1866635889;

    /**
     * The parameter <code>pg_catalog.varbit_recv.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.varbit_recv._1</code>.
     */
     ...
     */
    public VarbitRecv() {
        super("varbit_recv", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.VARCHAR);
