...
public class Mod3 extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 678083079;
     ...
     */
    public Mod3() {
        super("mod", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
