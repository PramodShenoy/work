...
public class Tideq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -638072884;

    /**
     * The parameter <code>pg_catalog.tideq.RETURN_VALUE</code>.
     */
     ...
     */
    public Tideq() {
        super("tideq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
