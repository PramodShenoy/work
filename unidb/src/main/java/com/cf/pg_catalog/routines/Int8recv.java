...
public class Int8recv extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 83225656;

    /**
     * The parameter <code>pg_catalog.int8recv.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.int8recv._1</code>.
     */
     ...
     */
    public Int8recv() {
        super("int8recv", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
