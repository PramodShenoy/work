...
public class Int48gt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -410057195;

    /**
     * The parameter <code>pg_catalog.int48gt.RETURN_VALUE</code>.
     */
     ...
     */
    public Int48gt() {
        super("int48gt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
