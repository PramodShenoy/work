...
public class Tidrecv extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -701137274;

    /**
     * The parameter <code>pg_catalog.tidrecv.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.tidrecv._1</code>.
     */
     ...
     */
    public Tidrecv() {
        super("tidrecv", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
