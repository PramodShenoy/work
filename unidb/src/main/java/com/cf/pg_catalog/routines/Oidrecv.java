...
public class Oidrecv extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -694990997;

    /**
     * The parameter <code>pg_catalog.oidrecv.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.oidrecv._1</code>.
     */
     ...
     */
    public Oidrecv() {
        super("oidrecv", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
