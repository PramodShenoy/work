...
public class TsMatchTq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1153609226;
    ...
    /**
     * The parameter <code>pg_catalog.ts_match_tq._2</code>.
     */
     ...
     */
    public TsMatchTq() {
        super("ts_match_tq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
