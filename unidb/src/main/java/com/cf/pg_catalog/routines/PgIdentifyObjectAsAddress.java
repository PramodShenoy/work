...
public class PgIdentifyObjectAsAddress extends AbstractRoutine<Void> {

    private static final long serialVersionUID = -1004447438;
    ...
    /**
     * The parameter <code>pg_catalog.pg_identify_object_as_address.subobjid</code>.
     */
