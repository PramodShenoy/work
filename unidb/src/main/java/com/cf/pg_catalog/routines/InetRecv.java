...
public class InetRecv extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -616312282;

    /**
     * The parameter <code>pg_catalog.inet_recv.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.inet_recv._1</code>.
     */
     ...
     */
    public InetRecv() {
        super("inet_recv", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("inet"));
