...
public class ColDescription extends AbstractRoutine<String> {

    private static final long serialVersionUID = 1576111593;

    /**
     * The parameter <code>pg_catalog.col_description.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.col_description._1</code>.
     */
    public static final Parameter<Long> _1 = createParameter("_1", org.jooq.impl.SQLDataType.BIGINT, false, true);

    /**
     * The parameter <code>pg_catalog.col_description._2</code>.
     */
    ...
    public ColDescription() {
        super("col_description", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
