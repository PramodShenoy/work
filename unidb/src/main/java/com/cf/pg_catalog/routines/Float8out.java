...
public class Float8out extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -233186122;

    /**
     * The parameter <code>pg_catalog.float8out.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.float8out._1</code>.
     */
     ...
     */
    public Float8out() {
        super("float8out", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("cstring"));
