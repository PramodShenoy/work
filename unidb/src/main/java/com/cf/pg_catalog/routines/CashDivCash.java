...
public class CashDivCash extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -1917785387;
     ...
     */
    public CashDivCash() {
        super("cash_div_cash", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
