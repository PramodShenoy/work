...
public class SpgRangeQuadChoose extends AbstractRoutine<Void> {

    private static final long serialVersionUID = -290764387;

    /**
     * The parameter <code>pg_catalog.spg_range_quad_choose._1</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.spg_range_quad_choose._2</code>.
     */
     ...
     */
    public SpgRangeQuadChoose() {
        super("spg_range_quad_choose", PgCatalog.PG_CATALOG);
