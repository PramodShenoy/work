...
public class Int2gt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -120844284;

    /**
     * The parameter <code>pg_catalog.int2gt.RETURN_VALUE</code>.
     */
     ...
     */
    public Int2gt() {
        super("int2gt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
