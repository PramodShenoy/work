...
public class StringToArray1 extends AbstractRoutine<String[]> {

    private static final long serialVersionUID = 84686453;

    /**
     * The parameter <code>pg_catalog.string_to_array.RETURN_VALUE</code>.
     */
     ...
     */
    public StringToArray1() {
        super("string_to_array", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB.getArrayDataType());
