...
public class XmlIn extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 714634409;

    /**
     * The parameter <code>pg_catalog.xml_in.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.xml_in._1</code>.
     */
     ...
     */
    public XmlIn() {
        super("xml_in", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("xml"));
