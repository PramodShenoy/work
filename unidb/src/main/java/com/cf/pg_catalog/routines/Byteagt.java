...
public class Byteagt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1440784286;

    /**
     * The parameter <code>pg_catalog.byteagt.RETURN_VALUE</code>.
     */
     ...
     */
    public Byteagt() {
        super("byteagt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
