...
public class Int24gt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 361930468;

    /**
     * The parameter <code>pg_catalog.int24gt.RETURN_VALUE</code>.
     */
     ...
     */
    public Int24gt() {
        super("int24gt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
