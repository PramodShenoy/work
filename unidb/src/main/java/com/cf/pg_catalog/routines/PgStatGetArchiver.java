...
public class PgStatGetArchiver extends AbstractRoutine<Void> {

    private static final long serialVersionUID = -90239461;
     ...
     */
    public static final Parameter<Timestamp> LAST_ARCHIVED_TIME = createParameter("last_archived_time", org.jooq.impl.SQLDataType.TIMESTAMP, false, false);
     ...
     */
    public static final Parameter<Timestamp> LAST_FAILED_TIME = createParameter("last_failed_time", org.jooq.impl.SQLDataType.TIMESTAMP, false, false);

    /**
     * The parameter <code>pg_catalog.pg_stat_get_archiver.stats_reset</code>.
     */
    public static final Parameter<Timestamp> STATS_RESET = createParameter("stats_reset", org.jooq.impl.SQLDataType.TIMESTAMP, false, false);
