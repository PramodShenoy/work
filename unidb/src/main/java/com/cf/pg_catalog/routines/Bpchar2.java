...
public class Bpchar2 extends AbstractRoutine<String> {

    private static final long serialVersionUID = 2078655260;
     ...
     */
    public Bpchar2() {
        super("bpchar", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CHAR);
