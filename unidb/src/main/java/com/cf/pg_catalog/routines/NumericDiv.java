...
public class NumericDiv extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -2093911015;
     ...
     */
    public NumericDiv() {
        super("numeric_div", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
