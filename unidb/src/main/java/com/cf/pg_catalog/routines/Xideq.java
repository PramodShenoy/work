...
public class Xideq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -805795628;

    /**
     * The parameter <code>pg_catalog.xideq.RETURN_VALUE</code>.
     */
     ...
     */
    public Xideq() {
        super("xideq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
