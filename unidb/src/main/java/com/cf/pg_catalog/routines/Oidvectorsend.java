...
public class Oidvectorsend extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = 1616332102;
     ...
     */
    public Oidvectorsend() {
        super("oidvectorsend", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
