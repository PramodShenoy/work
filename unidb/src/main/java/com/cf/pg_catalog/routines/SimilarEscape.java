...
public class SimilarEscape extends AbstractRoutine<String> {

    private static final long serialVersionUID = -320315950;

    /**
     * The parameter <code>pg_catalog.similar_escape.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.similar_escape._1</code>.
     */
    public static final Parameter<String> _1 = createParameter("_1", org.jooq.impl.SQLDataType.CLOB, false, true);

    /**
     * The parameter <code>pg_catalog.similar_escape._2</code>.
     */
     ...
     */
    public SimilarEscape() {
        super("similar_escape", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
