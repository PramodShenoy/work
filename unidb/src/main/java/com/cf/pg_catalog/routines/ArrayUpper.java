...
public class ArrayUpper extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -1741782621;
     ...
     */
    public ArrayUpper() {
        super("array_upper", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
