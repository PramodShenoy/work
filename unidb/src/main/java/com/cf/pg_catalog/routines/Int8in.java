...
public class Int8in extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -631971988;

    /**
     * The parameter <code>pg_catalog.int8in.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.int8in._1</code>.
     */
     ...
     */
    public Int8in() {
        super("int8in", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
