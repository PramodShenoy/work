...
public class Regclass extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1971086471;

    /**
     * The parameter <code>pg_catalog.regclass.RETURN_VALUE</code>.
     */
     ...
     */
    public Regclass() {
        super("regclass", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("regclass"));
