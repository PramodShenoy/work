...
public class JsonIn extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1668025370;

    /**
     * The parameter <code>pg_catalog.json_in.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.json_in._1</code>.
     */
     ...
     */
    public JsonIn() {
        super("json_in", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.OTHER);
