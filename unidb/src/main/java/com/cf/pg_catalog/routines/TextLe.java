...
public class TextLe extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1013589482;
     ...
     */
    public TextLe() {
        super("text_le", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
