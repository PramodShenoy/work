...
public class Int28ne extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1835244959;

    /**
     * The parameter <code>pg_catalog.int28ne.RETURN_VALUE</code>.
     */
     ...
     */
    public Int28ne() {
        super("int28ne", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
