...
public class Nameout extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1324593761;

    /**
     * The parameter <code>pg_catalog.nameout.RETURN_VALUE</code>.
     */
     ...
     */
    public Nameout() {
        super("nameout", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("cstring"));
