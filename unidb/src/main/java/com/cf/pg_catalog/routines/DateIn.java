...
public class DateIn extends AbstractRoutine<Date> {

    private static final long serialVersionUID = 910503806;

    /**
     * The parameter <code>pg_catalog.date_in.RETURN_VALUE</code>.
     */
    public static final Parameter<Date> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.DATE, false, false);

    /**
     * The parameter <code>pg_catalog.date_in._1</code>.
     */
     ...
     */
    public DateIn() {
        super("date_in", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DATE);
