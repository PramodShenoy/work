...
public class Ln1 extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -431589985;
     ...
     */
    public Ln1() {
        super("ln", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
