...
public class CashMulFlt4 extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 1013730301;

    /**
     * The parameter <code>pg_catalog.cash_mul_flt4.RETURN_VALUE</code>.
     */
     ...
     */
    public CashMulFlt4() {
        super("cash_mul_flt4", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
