...
public class JsonArrayElementsText extends AbstractRoutine<Void> {

    private static final long serialVersionUID = 1178568289;

    /**
     * The parameter <code>pg_catalog.json_array_elements_text.from_json</code>.
     */
    public static final Parameter<Object> FROM_JSON = createParameter("from_json", org.jooq.impl.SQLDataType.OTHER, false, false);

    /**
     * The parameter <code>pg_catalog.json_array_elements_text.value</code>.
     */
    ...
    public JsonArrayElementsText() {
        super("json_array_elements_text", PgCatalog.PG_CATALOG);
