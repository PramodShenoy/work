...
public class Btcanreturn extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 240502447;

    /**
     * The parameter <code>pg_catalog.btcanreturn.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.btcanreturn._1</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.btcanreturn._2</code>.
     */
     ...
     */
    public Btcanreturn() {
        super("btcanreturn", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
