...
public class Nameicregexeq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1303076779;

    /**
     * The parameter <code>pg_catalog.nameicregexeq.RETURN_VALUE</code>.
     */
     ...
     */
    public Nameicregexeq() {
        super("nameicregexeq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
