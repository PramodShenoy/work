...
public class QueryToXmlAndXmlschema extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -427523080;

    /**
     * The parameter <code>pg_catalog.query_to_xml_and_xmlschema.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.query_to_xml_and_xmlschema.tableforest</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.query_to_xml_and_xmlschema.targetns</code>.
     */
    ...
    public QueryToXmlAndXmlschema() {
        super("query_to_xml_and_xmlschema", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("xml"));
