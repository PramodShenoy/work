...
public class IntervalOut extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 1685856751;

    /**
     * The parameter <code>pg_catalog.interval_out.RETURN_VALUE</code>.
     */
     ...
     */
    public IntervalOut() {
        super("interval_out", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("cstring"));
