...
public class Int84ne extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -437423643;

    /**
     * The parameter <code>pg_catalog.int84ne.RETURN_VALUE</code>.
     */
     ...
     */
    public Int84ne() {
        super("int84ne", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
