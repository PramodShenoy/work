...
public class DateGtTimestamptz extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -169050790;

    /**
     * The parameter <code>pg_catalog.date_gt_timestamptz.RETURN_VALUE</code>.
     */
     ...
     */
    public DateGtTimestamptz() {
        super("date_gt_timestamptz", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
