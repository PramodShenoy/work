...
public class Exp2 extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 871325689;

    /**
     * The parameter <code>pg_catalog.exp.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.exp._1</code>.
     */
     ...
     */
    public Exp2() {
        super("exp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
