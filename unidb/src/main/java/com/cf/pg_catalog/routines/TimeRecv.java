...
public class TimeRecv extends AbstractRoutine<Time> {

    private static final long serialVersionUID = 9092533;

    /**
     * The parameter <code>pg_catalog.time_recv.RETURN_VALUE</code>.
     */
    public static final Parameter<Time> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.TIME, false, false);

    /**
     * The parameter <code>pg_catalog.time_recv._1</code>.
     */
     ...
     */
    public TimeRecv() {
        super("time_recv", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIME);
