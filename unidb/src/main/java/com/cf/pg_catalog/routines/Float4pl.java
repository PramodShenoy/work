...
public class Float4pl extends AbstractRoutine<Float> {

    private static final long serialVersionUID = 591264766;

    /**
     * The parameter <code>pg_catalog.float4pl.RETURN_VALUE</code>.
     */
    public static final Parameter<Float> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.REAL, false, false);

    /**
     * The parameter <code>pg_catalog.float4pl._1</code>.
     */
    public static final Parameter<Float> _1 = createParameter("_1", org.jooq.impl.SQLDataType.REAL, false, true);

    /**
     * The parameter <code>pg_catalog.float4pl._2</code>.
     */
     ...
     */
    public Float4pl() {
        super("float4pl", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.REAL);
