...
public class DateGtTimestamp extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1104837810;

    /**
     * The parameter <code>pg_catalog.date_gt_timestamp.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.date_gt_timestamp._1</code>.
     */
    public static final Parameter<Date> _1 = createParameter("_1", org.jooq.impl.SQLDataType.DATE, false, true);

    /**
     * The parameter <code>pg_catalog.date_gt_timestamp._2</code>.
     */
     ...
     */
    public DateGtTimestamp() {
        super("date_gt_timestamp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
