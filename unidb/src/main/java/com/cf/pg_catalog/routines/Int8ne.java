...
public class Int8ne extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -194457290;

    /**
     * The parameter <code>pg_catalog.int8ne.RETURN_VALUE</code>.
     */
     ...
     */
    public Int8ne() {
        super("int8ne", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
