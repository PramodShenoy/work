...
public class Texticregexeq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 516931374;
     ...
     */
    public Texticregexeq() {
        super("texticregexeq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
