...
public class RecordGe extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 23579814;
     ...
     */
    public RecordGe() {
        super("record_ge", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
