...
public class Int48div extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -582370355;

    /**
     * The parameter <code>pg_catalog.int48div.RETURN_VALUE</code>.
     */
     ...
     */
    public Int48div() {
        super("int48div", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
