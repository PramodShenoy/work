...
public class Min7 extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1576502679;
     ...
     */
    public Min7() {
        super("min", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
