...
public class Substring7 extends AbstractRoutine<String> {

    private static final long serialVersionUID = 2082149441;
     ...
     */
    public Substring7() {
        super("substring", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
