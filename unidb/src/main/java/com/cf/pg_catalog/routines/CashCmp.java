...
public class CashCmp extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 96839941;

    /**
     * The parameter <code>pg_catalog.cash_cmp.RETURN_VALUE</code>.
     */
    public static final Parameter<Integer> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>pg_catalog.cash_cmp._1</code>.
     */
    public static final Parameter<BigDecimal> _1 = createParameter("_1", org.jooq.impl.SQLDataType.NUMERIC, false, true);

    /**
     * The parameter <code>pg_catalog.cash_cmp._2</code>.
     */
     ...
     */
    public CashCmp() {
        super("cash_cmp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
