...
public class Textcat extends AbstractRoutine<String> {

    private static final long serialVersionUID = -655834034;

    /**
     * The parameter <code>pg_catalog.textcat.RETURN_VALUE</code>.
     */
     ...
     */
    public Textcat() {
        super("textcat", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
