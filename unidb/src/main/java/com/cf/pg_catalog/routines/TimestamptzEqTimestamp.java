...
public class TimestamptzEqTimestamp extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1091398052;

    /**
     * The parameter <code>pg_catalog.timestamptz_eq_timestamp.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.timestamptz_eq_timestamp._1</code>.
     */
    public static final Parameter<Timestamp> _1 = createParameter("_1", org.jooq.impl.SQLDataType.TIMESTAMP, false, true);

    /**
     * The parameter <code>pg_catalog.timestamptz_eq_timestamp._2</code>.
     */
     ...
     */
    public TimestamptzEqTimestamp() {
        super("timestamptz_eq_timestamp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
