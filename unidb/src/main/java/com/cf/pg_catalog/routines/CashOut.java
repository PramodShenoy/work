...
public class CashOut extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1109124271;

    /**
     * The parameter <code>pg_catalog.cash_out.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.cash_out._1</code>.
     */
     ...
     */
    public CashOut() {
        super("cash_out", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("cstring"));
