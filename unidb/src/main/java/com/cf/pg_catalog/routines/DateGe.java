...
public class DateGe extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1187226780;
     ...
     */
    public DateGe() {
        super("date_ge", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
