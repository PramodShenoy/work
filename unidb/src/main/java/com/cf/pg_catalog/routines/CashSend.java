...
public class CashSend extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = -1021740177;

    /**
     * The parameter <code>pg_catalog.cash_send.RETURN_VALUE</code>.
     */
    public static final Parameter<byte[]> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.BLOB, false, false);

    /**
     * The parameter <code>pg_catalog.cash_send._1</code>.
     */
     ...
     */
    public CashSend() {
        super("cash_send", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
