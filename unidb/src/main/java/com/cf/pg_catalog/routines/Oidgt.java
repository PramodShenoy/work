...
public class Oidgt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 70633540;

    /**
     * The parameter <code>pg_catalog.oidgt.RETURN_VALUE</code>.
     */
     ...
     */
    public Oidgt() {
        super("oidgt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
