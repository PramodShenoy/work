...
public class PgHasRole4 extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -2037729371;

    /**
     * The parameter <code>pg_catalog.pg_has_role.RETURN_VALUE</code>.
     */
     ...
     */
    public PgHasRole4() {
        super("pg_has_role", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
