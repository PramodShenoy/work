...
public class BoolAnd extends AbstractRoutine<Boolean> {
    ...
    private static final long serialVersionUID = -1435552478;

    /**
     * The parameter <code>pg_catalog.bool_and.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.bool_and._1</code>.
     */
     ...
     */
    public BoolAnd() {
        super("bool_and", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
