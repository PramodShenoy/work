...
public class Charin extends AbstractRoutine<String> {

    private static final long serialVersionUID = -196988711;

    /**
     * The parameter <code>pg_catalog.charin.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.charin._1</code>.
     */
     ...
     */
    public Charin() {
        super("charin", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CHAR);
