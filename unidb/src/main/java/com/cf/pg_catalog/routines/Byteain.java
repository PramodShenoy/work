...
public class Byteain extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = 619355216;

    /**
     * The parameter <code>pg_catalog.byteain.RETURN_VALUE</code>.
     */
    public static final Parameter<byte[]> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.BLOB, false, false);

    /**
     * The parameter <code>pg_catalog.byteain._1</code>.
     */
     ...
     */
    public Byteain() {
        super("byteain", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
