...
public class Nlikejoinsel extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -486129217;

    /**
     * The parameter <code>pg_catalog.nlikejoinsel.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.nlikejoinsel._1</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.nlikejoinsel._2</code>.
     */
    public static final Parameter<Long> _2 = createParameter("_2", org.jooq.impl.SQLDataType.BIGINT, false, true);

    /**
     * The parameter <code>pg_catalog.nlikejoinsel._3</code>.
     */
     ...
     */
    public Nlikejoinsel() {
        super("nlikejoinsel", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
