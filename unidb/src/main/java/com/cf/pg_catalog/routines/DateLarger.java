...
public class DateLarger extends AbstractRoutine<Date> {

    private static final long serialVersionUID = -1197744182;
     ...
     */
    public DateLarger() {
        super("date_larger", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DATE);
