...
public class Float8abs extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -1962632156;

    /**
     * The parameter <code>pg_catalog.float8abs.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.float8abs._1</code>.
     */
     ...
     */
    public Float8abs() {
        super("float8abs", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
