...
public class TimestamptzNeDate extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1934803744;

    /**
     * The parameter <code>pg_catalog.timestamptz_ne_date.RETURN_VALUE</code>.
     */
     ...
     */
    public TimestamptzNeDate() {
        super("timestamptz_ne_date", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
