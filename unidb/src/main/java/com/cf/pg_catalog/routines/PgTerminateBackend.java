...
public class PgTerminateBackend extends AbstractRoutine<Boolean> {
    ...
    private static final long serialVersionUID = -1317330774;
    ...
    /**
     * The parameter <code>pg_catalog.pg_terminate_backend._1</code>.
     */
    ...
    public PgTerminateBackend() {
        super("pg_terminate_backend", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
