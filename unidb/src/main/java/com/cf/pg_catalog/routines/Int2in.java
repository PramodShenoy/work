...
public class Int2in extends AbstractRoutine<Short> {
    ...
    private static final long serialVersionUID = -1161983434;

    /**
     * The parameter <code>pg_catalog.int2in.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.int2in._1</code>.
     */
     ...
     */
    public Int2in() {
        super("int2in", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.SMALLINT);
