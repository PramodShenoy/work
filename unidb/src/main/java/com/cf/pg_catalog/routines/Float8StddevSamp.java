...
public class Float8StddevSamp extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -1901410988;

    /**
     * The parameter <code>pg_catalog.float8_stddev_samp.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.float8_stddev_samp._1</code>.
     */
     ...
     */
    public Float8StddevSamp() {
        super("float8_stddev_samp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
