...
public class RecordRecv extends AbstractRoutine<Void> {

    private static final long serialVersionUID = -439487460;

    /**
     * The parameter <code>pg_catalog.record_recv._1</code>.
     */
