...
public class Int8not extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -484135293;

    /**
     * The parameter <code>pg_catalog.int8not.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.int8not._1</code>.
     */
     ...
     */
    public Int8not() {
        super("int8not", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
