...
public class Float8div extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 138415576;

    /**
     * The parameter <code>pg_catalog.float8div.RETURN_VALUE</code>.
     */
     ...
     */
    public Float8div() {
        super("float8div", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
