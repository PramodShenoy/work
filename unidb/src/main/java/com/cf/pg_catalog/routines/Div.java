...
public class Div extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -186933555;

    /**
     * The parameter <code>pg_catalog.div.RETURN_VALUE</code>.
     */
     ...
     */
    public Div() {
        super("div", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
