...
public class Bpcharrecv extends AbstractRoutine<String> {

    private static final long serialVersionUID = -792315060;
    ...
    /**
     * The parameter <code>pg_catalog.bpcharrecv._1</code>.
     */
     ...
     */
    public Bpcharrecv() {
        super("bpcharrecv", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CHAR);
