...
public class IntervalLt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -653624632;
     ...
     */
    public IntervalLt() {
        super("interval_lt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
