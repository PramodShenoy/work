...
public class Int28mul extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -1998317429;

    /**
     * The parameter <code>pg_catalog.int28mul.RETURN_VALUE</code>.
     */
     ...
     */
    public Int28mul() {
        super("int28mul", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
