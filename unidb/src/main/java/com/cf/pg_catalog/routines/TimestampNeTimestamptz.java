...
public class TimestampNeTimestamptz extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1966858116;

    /**
     * The parameter <code>pg_catalog.timestamp_ne_timestamptz.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.timestamp_ne_timestamptz._1</code>.
     */
    public static final Parameter<Timestamp> _1 = createParameter("_1", org.jooq.impl.SQLDataType.TIMESTAMP, false, true);

    /**
     * The parameter <code>pg_catalog.timestamp_ne_timestamptz._2</code>.
     */
     ...
     */
    public TimestampNeTimestamptz() {
        super("timestamp_ne_timestamptz", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
