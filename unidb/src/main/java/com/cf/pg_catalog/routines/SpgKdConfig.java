...
public class SpgKdConfig extends AbstractRoutine<Void> {

    private static final long serialVersionUID = -128391998;

    /**
     * The parameter <code>pg_catalog.spg_kd_config._1</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.spg_kd_config._2</code>.
     */
     ...
     */
    public SpgKdConfig() {
        super("spg_kd_config", PgCatalog.PG_CATALOG);
