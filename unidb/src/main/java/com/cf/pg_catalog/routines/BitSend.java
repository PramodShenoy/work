...
public class BitSend extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = 305140129;
     ...
     */
    public BitSend() {
        super("bit_send", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
