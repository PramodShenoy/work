...
public class SpgKdPicksplit extends AbstractRoutine<Void> {

    private static final long serialVersionUID = 1711281059;

    /**
     * The parameter <code>pg_catalog.spg_kd_picksplit._1</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.spg_kd_picksplit._2</code>.
     */
     ...
     */
    public SpgKdPicksplit() {
        super("spg_kd_picksplit", PgCatalog.PG_CATALOG);
