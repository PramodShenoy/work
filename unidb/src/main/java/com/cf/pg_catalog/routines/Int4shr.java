...
public class Int4shr extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1595008720;

    /**
     * The parameter <code>pg_catalog.int4shr.RETURN_VALUE</code>.
     */
    public static final Parameter<Integer> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>pg_catalog.int4shr._1</code>.
     */
    public static final Parameter<Integer> _1 = createParameter("_1", org.jooq.impl.SQLDataType.INTEGER, false, true);

    /**
     * The parameter <code>pg_catalog.int4shr._2</code>.
     */
     ...
     */
    public Int4shr() {
        super("int4shr", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
