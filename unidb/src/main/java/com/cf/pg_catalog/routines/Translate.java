...
public class Translate extends AbstractRoutine<String> {

    private static final long serialVersionUID = -1032619213;

    /**
     * The parameter <code>pg_catalog.translate.RETURN_VALUE</code>.
     */
     ...
     */
    public Translate() {
        super("translate", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
