...
public class LoTell64 extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -971202761;
     ...
     */
    public LoTell64() {
        super("lo_tell64", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
