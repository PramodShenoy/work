...
public class GinCompareJsonb extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 222684720;
     ...
     */
    public GinCompareJsonb() {
        super("gin_compare_jsonb", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
