...
public class SchemaToXmlschema extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 419896437;
    ...
    public SchemaToXmlschema() {
        super("schema_to_xmlschema", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("xml"));
