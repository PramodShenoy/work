...
public class IntervalPlTimestamptz extends AbstractRoutine<Timestamp> {

    private static final long serialVersionUID = -1991082793;

    /**
     * The parameter <code>pg_catalog.interval_pl_timestamptz.RETURN_VALUE</code>.
     */
     ...
     */
    public IntervalPlTimestamptz() {
        super("interval_pl_timestamptz", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIMESTAMP);
