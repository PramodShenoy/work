...
public class Int42lt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1176373392;

    /**
     * The parameter <code>pg_catalog.int42lt.RETURN_VALUE</code>.
     */
     ...
     */
    public Int42lt() {
        super("int42lt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
