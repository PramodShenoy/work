...
public class TimestamptzGtDate extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 2086372724;

    /**
     * The parameter <code>pg_catalog.timestamptz_gt_date.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.timestamptz_gt_date._1</code>.
     */
    public static final Parameter<Timestamp> _1 = createParameter("_1", org.jooq.impl.SQLDataType.TIMESTAMP, false, true);

    /**
     * The parameter <code>pg_catalog.timestamptz_gt_date._2</code>.
     */
     ...
     */
    public TimestamptzGtDate() {
        super("timestamptz_gt_date", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
