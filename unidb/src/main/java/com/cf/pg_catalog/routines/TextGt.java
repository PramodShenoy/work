...
public class TextGt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1549855022;

    /**
     * The parameter <code>pg_catalog.text_gt.RETURN_VALUE</code>.
     */
     ...
     */
    public TextGt() {
        super("text_gt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
