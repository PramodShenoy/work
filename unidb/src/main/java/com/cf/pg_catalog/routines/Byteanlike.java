...
public class Byteanlike extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -2126023242;

    /**
     * The parameter <code>pg_catalog.byteanlike.RETURN_VALUE</code>.
     */
     ...
     */
    public Byteanlike() {
        super("byteanlike", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
