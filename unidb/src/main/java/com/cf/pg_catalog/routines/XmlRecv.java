...
public class XmlRecv extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 971489035;

    /**
     * The parameter <code>pg_catalog.xml_recv.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.xml_recv._1</code>.
     */
     ...
     */
    public XmlRecv() {
        super("xml_recv", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("xml"));
