...
public class HasSequencePrivilege6 extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1199486115;

    /**
     * The parameter <code>pg_catalog.has_sequence_privilege.RETURN_VALUE</code>.
     */
     ...
     */
    public HasSequencePrivilege6() {
        super("has_sequence_privilege", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
