...
public class CashDivInt2 extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -759916697;

    /**
     * The parameter <code>pg_catalog.cash_div_int2.RETURN_VALUE</code>.
     */
     ...
     */
    public CashDivInt2() {
        super("cash_div_int2", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
