...
public class ToHex1 extends AbstractRoutine<String> {

    private static final long serialVersionUID = -1061214128;
     ...
     */
    public ToHex1() {
        super("to_hex", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
