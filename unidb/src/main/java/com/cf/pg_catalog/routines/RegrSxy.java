...
public class RegrSxy extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -146824672;
     ...
     */
    public RegrSxy() {
        super("regr_sxy", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
