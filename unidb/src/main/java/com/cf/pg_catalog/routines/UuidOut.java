...
public class UuidOut extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -161628407;

    /**
     * The parameter <code>pg_catalog.uuid_out.RETURN_VALUE</code>.
     */
     ...
     */
    public UuidOut() {
        super("uuid_out", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("cstring"));
