...
public class NumericExp extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 558414332;

    /**
     * The parameter <code>pg_catalog.numeric_exp.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.numeric_exp._1</code>.
     */
     ...
     */
    public NumericExp() {
        super("numeric_exp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
