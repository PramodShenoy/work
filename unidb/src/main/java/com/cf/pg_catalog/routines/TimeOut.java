...
public class TimeOut extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 543355597;

    /**
     * The parameter <code>pg_catalog.time_out.RETURN_VALUE</code>.
     */
     ...
     */
    public TimeOut() {
        super("time_out", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("cstring"));
