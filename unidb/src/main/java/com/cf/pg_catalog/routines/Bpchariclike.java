...
public class Bpchariclike extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1816022112;

    /**
     * The parameter <code>pg_catalog.bpchariclike.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.bpchariclike._1</code>.
     */
    public static final Parameter<String> _1 = createParameter("_1", org.jooq.impl.SQLDataType.CHAR, false, true);

    /**
     * The parameter <code>pg_catalog.bpchariclike._2</code>.
     */
     ...
     */
    public Bpchariclike() {
        super("bpchariclike", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
