...
public class RecordGt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 986734344;
     ...
     */
    public RecordGt() {
        super("record_gt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
