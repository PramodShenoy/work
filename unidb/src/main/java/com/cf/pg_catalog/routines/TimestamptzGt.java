...
public class TimestamptzGt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1462929946;

    /**
     * The parameter <code>pg_catalog.timestamptz_gt.RETURN_VALUE</code>.
     */
     ...
     */
    public TimestamptzGt() {
        super("timestamptz_gt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
