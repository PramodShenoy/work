...
public class TimeIn extends AbstractRoutine<Time> {

    private static final long serialVersionUID = -1041719885;
    ...
    /**
     * The parameter <code>pg_catalog.time_in._1</code>.
     */
     ...
     */
    public TimeIn() {
        super("time_in", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIME);
