...
public class Xidin extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 35429002;

    /**
     * The parameter <code>pg_catalog.xidin.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.xidin._1</code>.
     */
     ...
     */
    public Xidin() {
        super("xidin", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
