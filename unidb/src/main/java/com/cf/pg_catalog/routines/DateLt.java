...
public class DateLt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 779276744;
     ...
     */
    public DateLt() {
        super("date_lt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
