...
public class BitOr3 extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -1762663135;
     ...
     */
    public BitOr3() {
        super("bit_or", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
