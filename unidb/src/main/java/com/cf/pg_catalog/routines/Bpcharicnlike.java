...
public class Bpcharicnlike extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1311437386;

    /**
     * The parameter <code>pg_catalog.bpcharicnlike.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.bpcharicnlike._1</code>.
     */
    public static final Parameter<String> _1 = createParameter("_1", org.jooq.impl.SQLDataType.CHAR, false, true);

    /**
     * The parameter <code>pg_catalog.bpcharicnlike._2</code>.
     */
     ...
     */
    public Bpcharicnlike() {
        super("bpcharicnlike", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
