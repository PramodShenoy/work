...
public class Texticregexne extends AbstractRoutine<Boolean> {
    ...
    private static final long serialVersionUID = 444761604;

    /**
     * The parameter <code>pg_catalog.texticregexne.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.texticregexne._1</code>.
     */
    public static final Parameter<String> _1 = createParameter("_1", org.jooq.impl.SQLDataType.CLOB, false, true);

    /**
     * The parameter <code>pg_catalog.texticregexne._2</code>.
     */
    ...
    public Texticregexne() {
        super("texticregexne", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
