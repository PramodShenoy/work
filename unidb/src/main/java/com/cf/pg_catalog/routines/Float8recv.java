...
public class Float8recv extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -1335005235;

    /**
     * The parameter <code>pg_catalog.float8recv.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.float8recv._1</code>.
     */
     ...
     */
    public Float8recv() {
        super("float8recv", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
