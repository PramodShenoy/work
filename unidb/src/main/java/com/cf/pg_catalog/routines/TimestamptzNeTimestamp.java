...
public class TimestamptzNeTimestamp extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1188572932;

    /**
     * The parameter <code>pg_catalog.timestamptz_ne_timestamp.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.timestamptz_ne_timestamp._1</code>.
     */
    public static final Parameter<Timestamp> _1 = createParameter("_1", org.jooq.impl.SQLDataType.TIMESTAMP, false, true);

    /**
     * The parameter <code>pg_catalog.timestamptz_ne_timestamp._2</code>.
     */
     ...
     */
    public TimestamptzNeTimestamp() {
        super("timestamptz_ne_timestamp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
