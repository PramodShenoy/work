...
public class PgConfLoadTime extends AbstractRoutine<Timestamp> {

    private static final long serialVersionUID = -414858661;
    ...
    public PgConfLoadTime() {
        super("pg_conf_load_time", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIMESTAMP);
