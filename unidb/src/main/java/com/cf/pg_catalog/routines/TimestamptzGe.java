...
public class TimestamptzGe extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 2034028286;
     ...
     */
    public TimestamptzGe() {
        super("timestamptz_ge", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
