...
public class NumericSub extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -2068579333;

    /**
     * The parameter <code>pg_catalog.numeric_sub.RETURN_VALUE</code>.
     */
     ...
     */
    public NumericSub() {
        super("numeric_sub", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
