...
public class GistPolyConsistent extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1714760846;

    /**
     * The parameter <code>pg_catalog.gist_poly_consistent.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.gist_poly_consistent._1</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.gist_poly_consistent._2</code>.
     */
    public static final Parameter<Object> _2 = createParameter("_2", org.jooq.impl.DefaultDataType.getDefaultDataType("polygon"), false, true);

    /**
     * The parameter <code>pg_catalog.gist_poly_consistent._3</code>.
     */
    public static final Parameter<Integer> _3 = createParameter("_3", org.jooq.impl.SQLDataType.INTEGER, false, true);

    /**
     * The parameter <code>pg_catalog.gist_poly_consistent._4</code>.
     */
    public static final Parameter<Long> _4 = createParameter("_4", org.jooq.impl.SQLDataType.BIGINT, false, true);

    /**
     * The parameter <code>pg_catalog.gist_poly_consistent._5</code>.
     */
     ...
     */
    public GistPolyConsistent() {
        super("gist_poly_consistent", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
