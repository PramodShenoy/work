...
public class LsegSend extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = -1280415663;

    /**
     * The parameter <code>pg_catalog.lseg_send.RETURN_VALUE</code>.
     */
    public static final Parameter<byte[]> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.BLOB, false, false);

    /**
     * The parameter <code>pg_catalog.lseg_send._1</code>.
     */
     ...
     */
    public LsegSend() {
        super("lseg_send", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
