...
public class Namenlike extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1965108731;
     ...
     */
    public Namenlike() {
        super("namenlike", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
