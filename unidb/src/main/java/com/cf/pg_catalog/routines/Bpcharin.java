...
public class Bpcharin extends AbstractRoutine<String> {

    private static final long serialVersionUID = 74301850;

    /**
     * The parameter <code>pg_catalog.bpcharin.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.bpcharin._1</code>.
     */
     ...
     */
    public Bpcharin() {
        super("bpcharin", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CHAR);
