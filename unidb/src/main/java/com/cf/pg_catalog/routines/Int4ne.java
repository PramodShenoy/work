...
public class Int4ne extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1554823986;

    /**
     * The parameter <code>pg_catalog.int4ne.RETURN_VALUE</code>.
     */
     ...
     */
    public Int4ne() {
        super("int4ne", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
