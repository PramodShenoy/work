...
public class Int8plInet extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -1719765089;

    /**
     * The parameter <code>pg_catalog.int8pl_inet.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.int8pl_inet._2</code>.
     */
     ...
     */
    public Int8plInet() {
        super("int8pl_inet", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("inet"));
