...
public class Bittypmodout extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 833671370;

    /**
     * The parameter <code>pg_catalog.bittypmodout.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.bittypmodout._1</code>.
     */
     ...
     */
    public Bittypmodout() {
        super("bittypmodout", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("cstring"));
