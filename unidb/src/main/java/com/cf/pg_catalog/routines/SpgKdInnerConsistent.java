...
public class SpgKdInnerConsistent extends AbstractRoutine<Void> {

    private static final long serialVersionUID = -935325335;

    /**
     * The parameter <code>pg_catalog.spg_kd_inner_consistent._1</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.spg_kd_inner_consistent._2</code>.
     */
     ...
     */
    public SpgKdInnerConsistent() {
        super("spg_kd_inner_consistent", PgCatalog.PG_CATALOG);
