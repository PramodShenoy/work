...
public class CashDivFlt8 extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 1748410131;

    /**
     * The parameter <code>pg_catalog.cash_div_flt8.RETURN_VALUE</code>.
     */
     ...
     */
    public CashDivFlt8() {
        super("cash_div_flt8", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
