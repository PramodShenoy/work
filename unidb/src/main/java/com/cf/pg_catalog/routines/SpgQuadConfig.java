...
public class SpgQuadConfig extends AbstractRoutine<Void> {

    private static final long serialVersionUID = 1803210636;

    /**
     * The parameter <code>pg_catalog.spg_quad_config._1</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.spg_quad_config._2</code>.
     */
     ...
     */
    public SpgQuadConfig() {
        super("spg_quad_config", PgCatalog.PG_CATALOG);
