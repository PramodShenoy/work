...
public class Neqjoinsel extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -1115843008;

    /**
     * The parameter <code>pg_catalog.neqjoinsel.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.neqjoinsel._1</code>.
     */
     ...
     */
    public Neqjoinsel() {
        super("neqjoinsel", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
