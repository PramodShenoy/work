...
public class Bpcharregexeq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 974535258;

    /**
     * The parameter <code>pg_catalog.bpcharregexeq.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.bpcharregexeq._1</code>.
     */
    public static final Parameter<String> _1 = createParameter("_1", org.jooq.impl.SQLDataType.CHAR, false, true);

    /**
     * The parameter <code>pg_catalog.bpcharregexeq._2</code>.
     */
     ...
     */
    public Bpcharregexeq() {
        super("bpcharregexeq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
