...
public class Bit1 extends AbstractRoutine<String> {

    private static final long serialVersionUID = 143323149;
     ...
     */
    public Bit1() {
        super("bit", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CHAR);
