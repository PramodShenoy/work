...
public class TimestampGeDate extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1318484026;

    /**
     * The parameter <code>pg_catalog.timestamp_ge_date.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.timestamp_ge_date._1</code>.
     */
    public static final Parameter<Timestamp> _1 = createParameter("_1", org.jooq.impl.SQLDataType.TIMESTAMP, false, true);

    /**
     * The parameter <code>pg_catalog.timestamp_ge_date._2</code>.
     */
     ...
     */
    public TimestampGeDate() {
        super("timestamp_ge_date", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
