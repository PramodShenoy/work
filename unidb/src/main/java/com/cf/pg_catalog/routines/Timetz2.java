...
public class Timetz2 extends AbstractRoutine<Time> {

    private static final long serialVersionUID = 1487867190;
     ...
     */
    public Timetz2() {
        super("timetz", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIME);
