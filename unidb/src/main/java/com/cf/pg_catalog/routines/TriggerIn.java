...
public class TriggerIn extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 870166664;

    /**
     * The parameter <code>pg_catalog.trigger_in.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.trigger_in._1</code>.
     */
     ...
     */
    public TriggerIn() {
        super("trigger_in", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("trigger"));
