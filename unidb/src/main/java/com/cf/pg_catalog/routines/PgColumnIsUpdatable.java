...
public class PgColumnIsUpdatable extends AbstractRoutine<Boolean> {
    ...
    private static final long serialVersionUID = -863812722;

    /**
     * The parameter <code>pg_catalog.pg_column_is_updatable.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.pg_column_is_updatable._1</code>.
     */
    ...
    public PgColumnIsUpdatable() {
        super("pg_column_is_updatable", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
