...
public class Boolrecv extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -555893517;

    /**
     * The parameter <code>pg_catalog.boolrecv.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.boolrecv._1</code>.
     */
     ...
     */
    public Boolrecv() {
        super("boolrecv", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
