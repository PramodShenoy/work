...
public class PgReplicationOriginAdvance extends AbstractRoutine<Void> {

    private static final long serialVersionUID = 26509041;
    ...
    /**
     * The parameter <code>pg_catalog.pg_replication_origin_advance._2</code>.
     */
