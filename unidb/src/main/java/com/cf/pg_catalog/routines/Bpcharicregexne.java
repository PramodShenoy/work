...
public class Bpcharicregexne extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1406026116;

    /**
     * The parameter <code>pg_catalog.bpcharicregexne.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.bpcharicregexne._1</code>.
     */
    public static final Parameter<String> _1 = createParameter("_1", org.jooq.impl.SQLDataType.CHAR, false, true);

    /**
     * The parameter <code>pg_catalog.bpcharicregexne._2</code>.
     */
    ...
    public Bpcharicregexne() {
        super("bpcharicregexne", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
