...
public class Degrees extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1380666739;

    /**
     * The parameter <code>pg_catalog.degrees.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.degrees._1</code>.
     */
     ...
     */
    public Degrees() {
        super("degrees", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
