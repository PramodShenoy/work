...
public class Oidsmaller extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 2072090486;

    /**
     * The parameter <code>pg_catalog.oidsmaller.RETURN_VALUE</code>.
     */
     ...
     */
    public Oidsmaller() {
        super("oidsmaller", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
