...
public class DateGt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 772263486;
     ...
     */
    public DateGt() {
        super("date_gt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
