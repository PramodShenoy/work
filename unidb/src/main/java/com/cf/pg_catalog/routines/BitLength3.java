...
public class BitLength3 extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 2020737948;
     ...
     */
    public BitLength3() {
        super("bit_length", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
