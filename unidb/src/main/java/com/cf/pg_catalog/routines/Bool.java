...
public class Bool extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1924470930;
     ...
     */
    public Bool() {
        super("bool", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
