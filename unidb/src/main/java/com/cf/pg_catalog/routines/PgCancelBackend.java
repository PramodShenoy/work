...
public class PgCancelBackend extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 433684083;
     ...
     */
    public PgCancelBackend() {
        super("pg_cancel_backend", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
