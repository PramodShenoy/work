...
public class Int8mod extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1664660638;

    /**
     * The parameter <code>pg_catalog.int8mod.RETURN_VALUE</code>.
     */
     ...
     */
    public Int8mod() {
        super("int8mod", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
