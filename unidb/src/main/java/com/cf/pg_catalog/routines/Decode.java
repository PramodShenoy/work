...
public class Decode extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = -994005030;
     ...
     */
    public Decode() {
        super("decode", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
