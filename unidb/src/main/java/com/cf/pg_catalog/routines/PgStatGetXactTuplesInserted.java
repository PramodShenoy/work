...
public class PgStatGetXactTuplesInserted extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -1528695486;
    ...
    public PgStatGetXactTuplesInserted() {
        super("pg_stat_get_xact_tuples_inserted", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
