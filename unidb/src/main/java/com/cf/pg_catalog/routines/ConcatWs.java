...
public class ConcatWs extends AbstractRoutine<String> {

    private static final long serialVersionUID = -230131804;

    /**
     * The parameter <code>pg_catalog.concat_ws.RETURN_VALUE</code>.
     */
     ...
     */
    public ConcatWs() {
        super("concat_ws", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
