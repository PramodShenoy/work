...
public class Mod1 extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -2091967098;
     ...
     */
    public Mod1() {
        super("mod", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
