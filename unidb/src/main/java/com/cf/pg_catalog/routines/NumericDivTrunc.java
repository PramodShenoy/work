...
public class NumericDivTrunc extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 1619502147;

    /**
     * The parameter <code>pg_catalog.numeric_div_trunc.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.numeric_div_trunc._1</code>.
     */
    public static final Parameter<BigDecimal> _1 = createParameter("_1", org.jooq.impl.SQLDataType.NUMERIC, false, true);

    /**
     * The parameter <code>pg_catalog.numeric_div_trunc._2</code>.
     */
     ...
     */
    public NumericDivTrunc() {
        super("numeric_div_trunc", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
