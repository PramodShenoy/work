...
public class TimestampRecv extends AbstractRoutine<Timestamp> {

    private static final long serialVersionUID = -1969698519;

    /**
     * The parameter <code>pg_catalog.timestamp_recv.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.timestamp_recv._1</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.timestamp_recv._2</code>.
     */
    public static final Parameter<Long> _2 = createParameter("_2", org.jooq.impl.SQLDataType.BIGINT, false, true);

    /**
     * The parameter <code>pg_catalog.timestamp_recv._3</code>.
     */
    ...
    public TimestampRecv() {
        super("timestamp_recv", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIMESTAMP);
