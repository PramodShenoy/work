...
public class Byteaeq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -295799072;
     ...
     */
    public Byteaeq() {
        super("byteaeq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
