...
public class RecordLe extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1386242032;

    /**
     * The parameter <code>pg_catalog.record_le.RETURN_VALUE</code>.
     */
     ...
     */
    public RecordLe() {
        super("record_le", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
