...
public class Float48pl extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -809860318;

    /**
     * The parameter <code>pg_catalog.float48pl.RETURN_VALUE</code>.
     */
     ...
     */
    public Float48pl() {
        super("float48pl", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
