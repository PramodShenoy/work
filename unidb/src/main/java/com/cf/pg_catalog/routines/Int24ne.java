...
public class Int24ne extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 785544444;

    /**
     * The parameter <code>pg_catalog.int24ne.RETURN_VALUE</code>.
     */
     ...
     */
    public Int24ne() {
        super("int24ne", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
