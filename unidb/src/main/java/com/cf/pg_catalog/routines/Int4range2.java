...
public class Int4range2 extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -1757494608;

    /**
     * The parameter <code>pg_catalog.int4range.RETURN_VALUE</code>.
     */
     ...
     */
    public Int4range2() {
        super("int4range", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("int4range"));
