...
public class Int8dec extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -175891532;

    /**
     * The parameter <code>pg_catalog.int8dec.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.int8dec._1</code>.
     */
     ...
     */
    public Int8dec() {
        super("int8dec", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
