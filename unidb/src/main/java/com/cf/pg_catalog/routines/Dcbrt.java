...
public class Dcbrt extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -1532960683;

    /**
     * The parameter <code>pg_catalog.dcbrt.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.dcbrt._1</code>.
     */
     ...
     */
    public Dcbrt() {
        super("dcbrt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
