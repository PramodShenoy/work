...
public class Int2not extends AbstractRoutine<Short> {

    private static final long serialVersionUID = -1036350446;
     ...
     */
    public Int2not() {
        super("int2not", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.SMALLINT);
