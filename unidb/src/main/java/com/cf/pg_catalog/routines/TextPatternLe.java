...
public class TextPatternLe extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -466470902;

    /**
     * The parameter <code>pg_catalog.text_pattern_le.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.text_pattern_le._1</code>.
     */
    public static final Parameter<String> _1 = createParameter("_1", org.jooq.impl.SQLDataType.CLOB, false, true);

    /**
     * The parameter <code>pg_catalog.text_pattern_le._2</code>.
     */
     ...
     */
    public TextPatternLe() {
        super("text_pattern_le", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
