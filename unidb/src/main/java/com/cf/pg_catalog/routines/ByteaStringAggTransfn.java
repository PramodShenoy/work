...
public class ByteaStringAggTransfn extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 991797557;

    /**
     * The parameter <code>pg_catalog.bytea_string_agg_transfn.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.bytea_string_agg_transfn._1</code>.
     */
    ...
    public ByteaStringAggTransfn() {
        super("bytea_string_agg_transfn", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
