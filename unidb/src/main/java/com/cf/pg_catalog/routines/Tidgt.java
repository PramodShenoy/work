...
public class Tidgt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 2008463758;
     ...
     */
    public Tidgt() {
        super("tidgt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
