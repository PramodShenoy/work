...
public class DatePli extends AbstractRoutine<Date> {

    private static final long serialVersionUID = 294908634;
     ...
     */
    public DatePli() {
        super("date_pli", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DATE);
