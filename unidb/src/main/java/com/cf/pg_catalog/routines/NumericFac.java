...
public class NumericFac extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -2138046320;

    /**
     * The parameter <code>pg_catalog.numeric_fac.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.numeric_fac._1</code>.
     */
     ...
     */
    public NumericFac() {
        super("numeric_fac", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
