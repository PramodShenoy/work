...
public class Ln2 extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -874538116;
     ...
     */
    public Ln2() {
        super("ln", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
