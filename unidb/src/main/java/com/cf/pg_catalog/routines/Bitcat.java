...
public class Bitcat extends AbstractRoutine<String> {

    private static final long serialVersionUID = 220066202;

    /**
     * The parameter <code>pg_catalog.bitcat.RETURN_VALUE</code>.
     */
     ...
     */
    public Bitcat() {
        super("bitcat", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.VARCHAR);
