...
public class TimestampLeDate extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 765796176;
     ...
     */
    public TimestampLeDate() {
        super("timestamp_le_date", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
