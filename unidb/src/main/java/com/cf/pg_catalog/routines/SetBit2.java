...
public class SetBit2 extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = -655464142;
     ...
     */
    public SetBit2() {
        super("set_bit", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
