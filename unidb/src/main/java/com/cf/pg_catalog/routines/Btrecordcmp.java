...
public class Btrecordcmp extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 106314878;

    /**
     * The parameter <code>pg_catalog.btrecordcmp.RETURN_VALUE</code>.
     */
    public static final Parameter<Integer> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>pg_catalog.btrecordcmp._1</code>.
     */
    public static final Parameter<Record> _1 = createParameter("_1", org.jooq.impl.SQLDataType.RECORD, false, true);

    /**
     * The parameter <code>pg_catalog.btrecordcmp._2</code>.
     */
     ...
     */
    public Btrecordcmp() {
        super("btrecordcmp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
