...
public class JsonbExtractPath extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -321282965;
    ...
    public JsonbExtractPath() {
        super("jsonb_extract_path", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("jsonb"));
