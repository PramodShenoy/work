...
public class EucJpToMic extends AbstractRoutine<Void> {

    private static final long serialVersionUID = -1934972177;

    /**
     * The parameter <code>pg_catalog.euc_jp_to_mic._1</code>.
     */
    public static final Parameter<Integer> _1 = createParameter("_1", org.jooq.impl.SQLDataType.INTEGER, false, true);

    /**
     * The parameter <code>pg_catalog.euc_jp_to_mic._2</code>.
     */
    public static final Parameter<Integer> _2 = createParameter("_2", org.jooq.impl.SQLDataType.INTEGER, false, true);

    /**
     * The parameter <code>pg_catalog.euc_jp_to_mic._3</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.euc_jp_to_mic._4</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.euc_jp_to_mic._5</code>.
     */
     ...
     */
    public EucJpToMic() {
        super("euc_jp_to_mic", PgCatalog.PG_CATALOG);
