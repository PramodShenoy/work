...
public class Bitshiftright extends AbstractRoutine<String> {

    private static final long serialVersionUID = -1137233665;
    ...
    public Bitshiftright() {
        super("bitshiftright", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CHAR);
