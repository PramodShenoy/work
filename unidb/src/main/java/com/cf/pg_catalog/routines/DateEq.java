...
public class DateEq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1724529536;
     ...
     */
    public DateEq() {
        super("date_eq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
