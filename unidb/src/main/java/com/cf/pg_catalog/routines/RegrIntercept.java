...
public class RegrIntercept extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -1569477948;
    ...
    public RegrIntercept() {
        super("regr_intercept", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
