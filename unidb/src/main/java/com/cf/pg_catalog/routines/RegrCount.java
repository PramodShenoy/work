...
public class RegrCount extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1033929482;
     ...
     */
    public RegrCount() {
        super("regr_count", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
