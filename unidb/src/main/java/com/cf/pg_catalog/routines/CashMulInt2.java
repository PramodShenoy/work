...
public class CashMulInt2 extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -658323071;

    /**
     * The parameter <code>pg_catalog.cash_mul_int2.RETURN_VALUE</code>.
     */
     ...
     */
    public CashMulInt2() {
        super("cash_mul_int2", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
