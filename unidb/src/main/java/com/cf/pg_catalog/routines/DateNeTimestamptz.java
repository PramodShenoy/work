...
public class DateNeTimestamptz extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 669538542;

    /**
     * The parameter <code>pg_catalog.date_ne_timestamptz.RETURN_VALUE</code>.
     */
     ...
     */
    public DateNeTimestamptz() {
        super("date_ne_timestamptz", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
