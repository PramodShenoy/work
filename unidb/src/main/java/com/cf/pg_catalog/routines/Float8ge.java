...
public class Float8ge extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -288945072;

    /**
     * The parameter <code>pg_catalog.float8ge.RETURN_VALUE</code>.
     */
     ...
     */
    public Float8ge() {
        super("float8ge", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
