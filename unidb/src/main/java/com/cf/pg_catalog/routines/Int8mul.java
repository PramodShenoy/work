...
public class Int8mul extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -1170834082;

    /**
     * The parameter <code>pg_catalog.int8mul.RETURN_VALUE</code>.
     */
     ...
     */
    public Int8mul() {
        super("int8mul", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
