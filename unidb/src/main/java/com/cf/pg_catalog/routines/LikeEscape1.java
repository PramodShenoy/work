...
public class LikeEscape1 extends AbstractRoutine<String> {

    private static final long serialVersionUID = 227613051;

    /**
     * The parameter <code>pg_catalog.like_escape.RETURN_VALUE</code>.
     */
     ...
     */
    public LikeEscape1() {
        super("like_escape", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
