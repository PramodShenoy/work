...
public class Float84mul extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -633238510;

    /**
     * The parameter <code>pg_catalog.float84mul.RETURN_VALUE</code>.
     */
     ...
     */
    public Float84mul() {
        super("float84mul", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
