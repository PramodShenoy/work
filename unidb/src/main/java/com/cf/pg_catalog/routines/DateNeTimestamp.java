...
public class DateNeTimestamp extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1399894430;

    /**
     * The parameter <code>pg_catalog.date_ne_timestamp.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.date_ne_timestamp._1</code>.
     */
    public static final Parameter<Date> _1 = createParameter("_1", org.jooq.impl.SQLDataType.DATE, false, true);

    /**
     * The parameter <code>pg_catalog.date_ne_timestamp._2</code>.
     */
     ...
     */
    public DateNeTimestamp() {
        super("date_ne_timestamp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
