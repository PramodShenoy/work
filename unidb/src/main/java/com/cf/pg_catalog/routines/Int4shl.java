...
public class Int4shl extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -1388841532;

    /**
     * The parameter <code>pg_catalog.int4shl.RETURN_VALUE</code>.
     */
    public static final Parameter<Integer> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>pg_catalog.int4shl._1</code>.
     */
    public static final Parameter<Integer> _1 = createParameter("_1", org.jooq.impl.SQLDataType.INTEGER, false, true);

    /**
     * The parameter <code>pg_catalog.int4shl._2</code>.
     */
     ...
     */
    public Int4shl() {
        super("int4shl", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
