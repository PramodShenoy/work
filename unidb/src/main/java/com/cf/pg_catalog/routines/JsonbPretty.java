...
public class JsonbPretty extends AbstractRoutine<String> {

    private static final long serialVersionUID = 2144064537;
     ...
     */
    public JsonbPretty() {
        super("jsonb_pretty", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
