...
public class LoLseek extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1584124360;
     ...
     */
    public LoLseek() {
        super("lo_lseek", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
