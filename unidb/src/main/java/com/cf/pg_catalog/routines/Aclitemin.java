...
public class Aclitemin extends AbstractRoutine<String> {

    private static final long serialVersionUID = 205175468;

    /**
     * The parameter <code>pg_catalog.aclitemin.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.aclitemin._1</code>.
     */
     ...
     */
    public Aclitemin() {
        super("aclitemin", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.VARCHAR);
