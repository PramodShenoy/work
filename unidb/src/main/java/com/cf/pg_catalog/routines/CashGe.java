...
public class CashGe extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 845547579;

    /**
     * The parameter <code>pg_catalog.cash_ge.RETURN_VALUE</code>.
     */
     ...
     */
    public CashGe() {
        super("cash_ge", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
