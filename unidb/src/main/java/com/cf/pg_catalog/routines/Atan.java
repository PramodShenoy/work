...
public class Atan extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -265243280;
     ...
     */
    public Atan() {
        super("atan", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
