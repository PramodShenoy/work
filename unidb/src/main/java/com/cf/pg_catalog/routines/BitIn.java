...
public class BitIn extends AbstractRoutine<String> {

    private static final long serialVersionUID = 1711525434;

    /**
     * The parameter <code>pg_catalog.bit_in.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.bit_in._1</code>.
     */
     ...
     */
    public BitIn() {
        super("bit_in", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CHAR);
