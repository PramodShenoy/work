...
public class PgExtensionConfigDump extends AbstractRoutine<Void> {

    private static final long serialVersionUID = -2083419489;

    /**
     * The parameter <code>pg_catalog.pg_extension_config_dump._1</code>.
     */
