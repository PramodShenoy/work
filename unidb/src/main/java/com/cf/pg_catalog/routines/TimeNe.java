...
public class TimeNe extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1076599085;

    /**
     * The parameter <code>pg_catalog.time_ne.RETURN_VALUE</code>.
     */
     ...
     */
    public TimeNe() {
        super("time_ne", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
