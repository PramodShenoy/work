...
public class Int42le extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1299252338;

    /**
     * The parameter <code>pg_catalog.int42le.RETURN_VALUE</code>.
     */
     ...
     */
    public Int42le() {
        super("int42le", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
