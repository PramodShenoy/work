...
public class NumericIn extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 1685819935;

    /**
     * The parameter <code>pg_catalog.numeric_in.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.numeric_in._1</code>.
     */
     ...
     */
    public NumericIn() {
        super("numeric_in", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
