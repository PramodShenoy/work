...
public class Spggettuple extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1477218766;

    /**
     * The parameter <code>pg_catalog.spggettuple.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.spggettuple._1</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.spggettuple._2</code>.
     */
     ...
     */
    public Spggettuple() {
        super("spggettuple", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
