...
public class Int2eq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -343136958;

    /**
     * The parameter <code>pg_catalog.int2eq.RETURN_VALUE</code>.
     */
     ...
     */
    public Int2eq() {
        super("int2eq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
