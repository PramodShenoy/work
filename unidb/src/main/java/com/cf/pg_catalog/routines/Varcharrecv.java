...
public class Varcharrecv extends AbstractRoutine<String> {

    private static final long serialVersionUID = 954520969;
    ...
    /**
     * The parameter <code>pg_catalog.varcharrecv._1</code>.
     */
     ...
     */
    public Varcharrecv() {
        super("varcharrecv", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.VARCHAR);
