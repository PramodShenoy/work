...
public class Int4Sum extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -164903051;

    /**
     * The parameter <code>pg_catalog.int4_sum.RETURN_VALUE</code>.
     */
     ...
     */
    public Int4Sum() {
        super("int4_sum", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
