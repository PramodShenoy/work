...
public class PgStatGetLastAutovacuumTime extends AbstractRoutine<Timestamp> {

    private static final long serialVersionUID = 1778788684;
    ...
    public PgStatGetLastAutovacuumTime() {
        super("pg_stat_get_last_autovacuum_time", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIMESTAMP);
