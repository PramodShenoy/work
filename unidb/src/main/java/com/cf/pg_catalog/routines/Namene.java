...
public class Namene extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1173716026;

    /**
     * The parameter <code>pg_catalog.namene.RETURN_VALUE</code>.
     */
     ...
     */
    public Namene() {
        super("namene", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
