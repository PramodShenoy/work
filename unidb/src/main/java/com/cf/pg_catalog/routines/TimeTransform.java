...
public class TimeTransform extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1830528871;

    /**
     * The parameter <code>pg_catalog.time_transform.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.time_transform._1</code>.
     */
    ...
    public TimeTransform() {
        super("time_transform", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
