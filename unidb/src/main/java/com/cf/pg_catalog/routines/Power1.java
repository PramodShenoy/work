...
public class Power1 extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -461965237;
     ...
     */
    public Power1() {
        super("power", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
