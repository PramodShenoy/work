...
public class Dsqrt extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -732362122;
     ...
     */
    public Dsqrt() {
        super("dsqrt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
