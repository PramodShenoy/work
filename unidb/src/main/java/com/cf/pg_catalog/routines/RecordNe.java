...
public class RecordNe extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1072313460;
     ...
     */
    public RecordNe() {
        super("record_ne", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
