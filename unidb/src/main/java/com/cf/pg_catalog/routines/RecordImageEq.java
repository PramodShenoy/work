...
public class RecordImageEq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 809839284;
     ...
     */
    public RecordImageEq() {
        super("record_image_eq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
