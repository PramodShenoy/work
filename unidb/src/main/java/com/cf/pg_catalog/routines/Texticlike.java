...
public class Texticlike extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1701637030;
     ...
     */
    public Texticlike() {
        super("texticlike", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
