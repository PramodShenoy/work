...
public class DateCmpTimestamp extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1857759826;

    /**
     * The parameter <code>pg_catalog.date_cmp_timestamp.RETURN_VALUE</code>.
     */
    ...
    public DateCmpTimestamp() {
        super("date_cmp_timestamp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
