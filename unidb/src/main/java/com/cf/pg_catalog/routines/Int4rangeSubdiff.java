...
public class Int4rangeSubdiff extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 933335592;
     ...
     */
    public Int4rangeSubdiff() {
        super("int4range_subdiff", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
