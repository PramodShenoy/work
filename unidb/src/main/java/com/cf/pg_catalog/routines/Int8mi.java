...
public class Int8mi extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -219508800;

    /**
     * The parameter <code>pg_catalog.int8mi.RETURN_VALUE</code>.
     */
     ...
     */
    public Int8mi() {
        super("int8mi", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
