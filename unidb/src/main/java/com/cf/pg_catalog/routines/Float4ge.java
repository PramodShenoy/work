...
public class Float4ge extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1769378896;

    /**
     * The parameter <code>pg_catalog.float4ge.RETURN_VALUE</code>.
     */
     ...
     */
    public Float4ge() {
        super("float4ge", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
