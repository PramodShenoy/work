...
public class Int4mi extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 706569602;
     ...
     */
    public Int4mi() {
        super("int4mi", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
