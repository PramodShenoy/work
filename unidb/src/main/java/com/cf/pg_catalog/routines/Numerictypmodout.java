...
public class Numerictypmodout extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -2074512822;

    /**
     * The parameter <code>pg_catalog.numerictypmodout.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.numerictypmodout._1</code>.
     */
     ...
     */
    public Numerictypmodout() {
        super("numerictypmodout", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("cstring"));
