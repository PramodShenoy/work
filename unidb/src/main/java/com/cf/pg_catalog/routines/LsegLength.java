...
public class LsegLength extends AbstractRoutine<Double> {
    ...
    private static final long serialVersionUID = -1442954027;
    ...
    /**
     * The parameter <code>pg_catalog.lseg_length._1</code>.
     */
     ...
     */
    public LsegLength() {
        super("lseg_length", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
