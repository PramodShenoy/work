...
public class BitOr1 extends AbstractRoutine<Short> {

    private static final long serialVersionUID = -431386894;
     ...
     */
    public BitOr1() {
        super("bit_or", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.SMALLINT);
