...
public class PgReplicationOriginXactSetup extends AbstractRoutine<Void> {

    private static final long serialVersionUID = -790768675;

    /**
     * The parameter <code>pg_catalog.pg_replication_origin_xact_setup._1</code>.
     */
