...
public class RegrAvgx extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1129777438;
     ...
     */
    public RegrAvgx() {
        super("regr_avgx", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
