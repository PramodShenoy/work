...
public class IntervalMul extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -37815975;
     ...
     */
    public IntervalMul() {
        super("interval_mul", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("interval"));
