...
public class IntervalPlTimestamp extends AbstractRoutine<Timestamp> {

    private static final long serialVersionUID = -1413944181;
    ...
    public IntervalPlTimestamp() {
        super("interval_pl_timestamp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIMESTAMP);
