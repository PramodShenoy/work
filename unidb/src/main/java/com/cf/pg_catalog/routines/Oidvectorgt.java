...
public class Oidvectorgt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 699656114;

    /**
     * The parameter <code>pg_catalog.oidvectorgt.RETURN_VALUE</code>.
     */
     ...
     */
    public Oidvectorgt() {
        super("oidvectorgt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
