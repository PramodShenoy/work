...
public class Textregexeq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 402189922;
     ...
     */
    public Textregexeq() {
        super("textregexeq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
