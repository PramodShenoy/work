...
public class Abs2 extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -797143635;
     ...
     */
    public Abs2() {
        super("abs", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
