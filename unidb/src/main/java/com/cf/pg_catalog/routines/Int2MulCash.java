...
public class Int2MulCash extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -582395681;

    /**
     * The parameter <code>pg_catalog.int2_mul_cash.RETURN_VALUE</code>.
     */
     ...
     */
    public Int2MulCash() {
        super("int2_mul_cash", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
