...
public class CashMulFlt8 extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 1435199277;

    /**
     * The parameter <code>pg_catalog.cash_mul_flt8.RETURN_VALUE</code>.
     */
     ...
     */
    public CashMulFlt8() {
        super("cash_mul_flt8", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
