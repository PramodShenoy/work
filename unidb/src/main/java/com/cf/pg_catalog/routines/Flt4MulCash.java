...
public class Flt4MulCash extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1883037553;

    /**
     * The parameter <code>pg_catalog.flt4_mul_cash.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.flt4_mul_cash._1</code>.
     */
    public static final Parameter<Float> _1 = createParameter("_1", org.jooq.impl.SQLDataType.REAL, false, true);

    /**
     * The parameter <code>pg_catalog.flt4_mul_cash._2</code>.
     */
     ...
     */
    public Flt4MulCash() {
        super("flt4_mul_cash", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
