...
public class Int42eq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1546942168;
     ...
     */
    public Int42eq() {
        super("int42eq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
