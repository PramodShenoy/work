...
public class CashEq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -2029410877;

    /**
     * The parameter <code>pg_catalog.cash_eq.RETURN_VALUE</code>.
     */
     ...
     */
    public CashEq() {
        super("cash_eq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
