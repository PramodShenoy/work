...
public class Int84lt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -900564473;

    /**
     * The parameter <code>pg_catalog.int84lt.RETURN_VALUE</code>.
     */
     ...
     */
    public Int84lt() {
        super("int84lt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
