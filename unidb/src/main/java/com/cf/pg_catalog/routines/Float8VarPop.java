...
public class Float8VarPop extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -1968093699;

    /**
     * The parameter <code>pg_catalog.float8_var_pop.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.float8_var_pop._1</code>.
     */
     ...
     */
    public Float8VarPop() {
        super("float8_var_pop", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
