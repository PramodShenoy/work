...
public class Sin extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -1204303518;

    /**
     * The parameter <code>pg_catalog.sin.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.sin._1</code>.
     */
     ...
     */
    public Sin() {
        super("sin", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
