...
public class Int4AvgAccumInv extends AbstractRoutine<Long[]> {

    private static final long serialVersionUID = 1457333729;

    /**
     * The parameter <code>pg_catalog.int4_avg_accum_inv.RETURN_VALUE</code>.
     */
     ...
     */
    public Int4AvgAccumInv() {
        super("int4_avg_accum_inv", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT.getArrayDataType());
