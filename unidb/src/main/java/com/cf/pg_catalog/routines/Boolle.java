...
public class Boolle extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -100616874;
     ...
     */
    public Boolle() {
        super("boolle", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
