...
public class Int48mul extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -533479769;

    /**
     * The parameter <code>pg_catalog.int48mul.RETURN_VALUE</code>.
     */
     ...
     */
    public Int48mul() {
        super("int48mul", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
