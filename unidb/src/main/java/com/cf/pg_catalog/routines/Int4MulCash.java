...
public class Int4MulCash extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1658654305;

    /**
     * The parameter <code>pg_catalog.int4_mul_cash.RETURN_VALUE</code>.
     */
     ...
     */
    public Int4MulCash() {
        super("int4_mul_cash", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
