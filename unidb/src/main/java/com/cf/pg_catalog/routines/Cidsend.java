...
public class Cidsend extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = -812226965;

    /**
     * The parameter <code>pg_catalog.cidsend.RETURN_VALUE</code>.
     */
    public static final Parameter<byte[]> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.BLOB, false, false);

    /**
     * The parameter <code>pg_catalog.cidsend._1</code>.
     */
     ...
     */
    public Cidsend() {
        super("cidsend", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
