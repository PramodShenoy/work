...
public class Avg6 extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1996060373;
     ...
     */
    public Avg6() {
        super("avg", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
