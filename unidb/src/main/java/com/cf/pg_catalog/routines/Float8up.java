...
public class Float8up extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -1268845547;
     ...
     */
    public Float8up() {
        super("float8up", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
