...
public class Cashsmaller extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 90892141;

    /**
     * The parameter <code>pg_catalog.cashsmaller.RETURN_VALUE</code>.
     */
     ...
     */
    public Cashsmaller() {
        super("cashsmaller", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
