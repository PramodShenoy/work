...
public class NumericLog extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1875962637;

    /**
     * The parameter <code>pg_catalog.numeric_log.RETURN_VALUE</code>.
     */
     ...
     */
    public NumericLog() {
        super("numeric_log", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
