...
public class ToDate extends AbstractRoutine<Date> {

    private static final long serialVersionUID = -392390166;
     ...
     */
    public ToDate() {
        super("to_date", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DATE);
