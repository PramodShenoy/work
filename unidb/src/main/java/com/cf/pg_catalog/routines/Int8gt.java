...
public class Int8gt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1171107062;

    /**
     * The parameter <code>pg_catalog.int8gt.RETURN_VALUE</code>.
     */
     ...
     */
    public Int8gt() {
        super("int8gt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
