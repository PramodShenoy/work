...
public class EnumSend extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = 1731909199;

    /**
     * The parameter <code>pg_catalog.enum_send.RETURN_VALUE</code>.
     */
    public static final Parameter<byte[]> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.BLOB, false, false);

    /**
     * The parameter <code>pg_catalog.enum_send._1</code>.
     */
     ...
     */
    public EnumSend() {
        super("enum_send", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
