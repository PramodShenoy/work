...
public class LikeEscape2 extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = -704556695;
     ...
     */
    public LikeEscape2() {
        super("like_escape", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
