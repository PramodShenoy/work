...
public class NumericOut extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -543920479;

    /**
     * The parameter <code>pg_catalog.numeric_out.RETURN_VALUE</code>.
     */
     ...
     */
    public NumericOut() {
        super("numeric_out", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("cstring"));
