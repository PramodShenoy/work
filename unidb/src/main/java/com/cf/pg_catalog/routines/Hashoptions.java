...
public class Hashoptions extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = 1371407989;

    /**
     * The parameter <code>pg_catalog.hashoptions.RETURN_VALUE</code>.
     */
    public static final Parameter<byte[]> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.BLOB, false, false);

    /**
     * The parameter <code>pg_catalog.hashoptions._1</code>.
     */
    public static final Parameter<String[]> _1 = createParameter("_1", org.jooq.impl.SQLDataType.CLOB.getArrayDataType(), false, true);

    /**
     * The parameter <code>pg_catalog.hashoptions._2</code>.
     */
     ...
     */
    public Hashoptions() {
        super("hashoptions", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
