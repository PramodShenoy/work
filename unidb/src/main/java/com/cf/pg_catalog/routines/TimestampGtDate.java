...
public class TimestampGtDate extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1377072488;

    /**
     * The parameter <code>pg_catalog.timestamp_gt_date.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.timestamp_gt_date._1</code>.
     */
    public static final Parameter<Timestamp> _1 = createParameter("_1", org.jooq.impl.SQLDataType.TIMESTAMP, false, true);

    /**
     * The parameter <code>pg_catalog.timestamp_gt_date._2</code>.
     */
     ...
     */
    public TimestampGtDate() {
        super("timestamp_gt_date", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
