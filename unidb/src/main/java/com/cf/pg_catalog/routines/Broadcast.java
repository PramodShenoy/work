...
public class Broadcast extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1368160629;

    /**
     * The parameter <code>pg_catalog.broadcast.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.broadcast._1</code>.
     */
     ...
     */
    public Broadcast() {
        super("broadcast", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("inet"));
