...
public class EnumOut extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 707335493;

    /**
     * The parameter <code>pg_catalog.enum_out.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.enum_out._1</code>.
     */
     ...
     */
    public EnumOut() {
        super("enum_out", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("cstring"));
