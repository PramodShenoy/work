...
public class Int82le extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1330743561;

    /**
     * The parameter <code>pg_catalog.int82le.RETURN_VALUE</code>.
     */
     ...
     */
    public Int82le() {
        super("int82le", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
