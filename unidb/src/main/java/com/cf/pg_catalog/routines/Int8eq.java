...
public class Int8eq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -643273386;

    /**
     * The parameter <code>pg_catalog.int8eq.RETURN_VALUE</code>.
     */
     ...
     */
    public Int8eq() {
        super("int8eq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
