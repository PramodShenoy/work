...
public class DatePlInterval extends AbstractRoutine<Timestamp> {

    private static final long serialVersionUID = 284500509;
    ...
    public DatePlInterval() {
        super("date_pl_interval", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIMESTAMP);
