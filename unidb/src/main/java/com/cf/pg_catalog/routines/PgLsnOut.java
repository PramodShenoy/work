...
public class PgLsnOut extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 337941783;

    /**
     * The parameter <code>pg_catalog.pg_lsn_out.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.pg_lsn_out._1</code>.
     */
     ...
     */
    public PgLsnOut() {
        super("pg_lsn_out", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("cstring"));
