...
public class Int2ne extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1693272088;

    /**
     * The parameter <code>pg_catalog.int2ne.RETURN_VALUE</code>.
     */
     ...
     */
    public Int2ne() {
        super("int2ne", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
