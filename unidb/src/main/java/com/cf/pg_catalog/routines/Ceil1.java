...
public class Ceil1 extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1287580999;

    /**
     * The parameter <code>pg_catalog.ceil.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.ceil._1</code>.
     */
     ...
     */
    public Ceil1() {
        super("ceil", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
