...
public class JsonObject1 extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1170868930;
     ...
     */
    public JsonObject1() {
        super("json_object", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.OTHER);
