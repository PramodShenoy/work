...
public class Bpcharregexne extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 902365488;

    /**
     * The parameter <code>pg_catalog.bpcharregexne.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.bpcharregexne._1</code>.
     */
    public static final Parameter<String> _1 = createParameter("_1", org.jooq.impl.SQLDataType.CHAR, false, true);

    /**
     * The parameter <code>pg_catalog.bpcharregexne._2</code>.
     */
     ...
     */
    public Bpcharregexne() {
        super("bpcharregexne", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
