...
public class Int2int4Sum extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -1940692523;
     ...
     */
    public Int2int4Sum() {
        super("int2int4_sum", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
