...
public class TimetzLt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1654529025;

    /**
     * The parameter <code>pg_catalog.timetz_lt.RETURN_VALUE</code>.
     */
     ...
     */
    public TimetzLt() {
        super("timetz_lt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
