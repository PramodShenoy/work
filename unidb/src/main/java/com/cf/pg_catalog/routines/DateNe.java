...
public class DateNe extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 338051882;
     ...
     */
    public DateNe() {
        super("date_ne", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
