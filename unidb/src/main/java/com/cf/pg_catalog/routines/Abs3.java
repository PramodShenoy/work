...
public class Abs3 extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 2007120638;
     ...
     */
    public Abs3() {
        super("abs", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
