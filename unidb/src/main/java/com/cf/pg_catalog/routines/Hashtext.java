...
public class Hashtext extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -1325064408;
     ...
     */
    public Hashtext() {
        super("hashtext", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
