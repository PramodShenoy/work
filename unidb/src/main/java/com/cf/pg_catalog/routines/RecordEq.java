...
public class RecordEq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1108032010;

    /**
     * The parameter <code>pg_catalog.record_eq.RETURN_VALUE</code>.
     */
     ...
     */
    public RecordEq() {
        super("record_eq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
