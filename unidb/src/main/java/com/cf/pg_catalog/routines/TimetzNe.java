...
public class TimetzNe extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1678604961;

    /**
     * The parameter <code>pg_catalog.timetz_ne.RETURN_VALUE</code>.
     */
     ...
     */
    public TimetzNe() {
        super("timetz_ne", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
