...
public class SpgQuadChoose extends AbstractRoutine<Void> {

    private static final long serialVersionUID = -1416651487;

    /**
     * The parameter <code>pg_catalog.spg_quad_choose._1</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.spg_quad_choose._2</code>.
     */
     ...
     */
    public SpgQuadChoose() {
        super("spg_quad_choose", PgCatalog.PG_CATALOG);
