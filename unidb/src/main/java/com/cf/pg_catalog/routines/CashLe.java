...
public class CashLe extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 738487471;

    /**
     * The parameter <code>pg_catalog.cash_le.RETURN_VALUE</code>.
     */
     ...
     */
    public CashLe() {
        super("cash_le", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
