...
public class Min16 extends AbstractRoutine<String> {

    private static final long serialVersionUID = -1784700710;
     ...
     */
    public Min16() {
        super("min", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
