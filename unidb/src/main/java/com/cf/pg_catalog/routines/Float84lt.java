...
public class Float84lt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 26010630;

    /**
     * The parameter <code>pg_catalog.float84lt.RETURN_VALUE</code>.
     */
     ...
     */
    public Float84lt() {
        super("float84lt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
