...
public class BinaryUpgradeSetNextArrayPgTypeOid extends AbstractRoutine<Void> {

    private static final long serialVersionUID = -588283757;

    /**
     * The parameter <code>pg_catalog.binary_upgrade_set_next_array_pg_type_oid._1</code>.
     */
