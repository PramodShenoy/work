...
public class Int8shl extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -1220199821;
     ...
     */
    public Int8shl() {
        super("int8shl", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
