...
public class RegrSxx extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1459103586;
     ...
     */
    public RegrSxx() {
        super("regr_sxx", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
