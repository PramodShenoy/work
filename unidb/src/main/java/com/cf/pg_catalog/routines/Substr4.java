...
public class Substr4 extends AbstractRoutine<String> {

    private static final long serialVersionUID = -2019583662;
     ...
     */
    public Substr4() {
        super("substr", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
