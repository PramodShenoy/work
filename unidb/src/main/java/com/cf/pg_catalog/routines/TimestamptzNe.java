...
public class TimestamptzNe extends AbstractRoutine<Boolean> {
    ...
    private static final long serialVersionUID = 930417794;

    /**
     * The parameter <code>pg_catalog.timestamptz_ne.RETURN_VALUE</code>.
     */
    ...
    public TimestamptzNe() {
        super("timestamptz_ne", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
