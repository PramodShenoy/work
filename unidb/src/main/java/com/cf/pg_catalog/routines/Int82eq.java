...
public class Int82eq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 247901603;

    /**
     * The parameter <code>pg_catalog.int82eq.RETURN_VALUE</code>.
     */
     ...
     */
    public Int82eq() {
        super("int82eq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
