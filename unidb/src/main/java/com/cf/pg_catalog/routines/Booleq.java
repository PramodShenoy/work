...
public class Booleq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -987783498;

    /**
     * The parameter <code>pg_catalog.booleq.RETURN_VALUE</code>.
     */
     ...
     */
    public Booleq() {
        super("booleq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
