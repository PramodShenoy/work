...
public class Byteacat extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = 905207340;
     ...
     */
    public Byteacat() {
        super("byteacat", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
