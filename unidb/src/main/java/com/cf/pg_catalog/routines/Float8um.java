...
public class Float8um extends AbstractRoutine<Double> {
    ...
    private static final long serialVersionUID = -1500514708;

    /**
     * The parameter <code>pg_catalog.float8um.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.float8um._1</code>.
     */
     ...
     */
    public Float8um() {
        super("float8um", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
