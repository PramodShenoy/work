...
public class Float8le extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 930375728;

    /**
     * The parameter <code>pg_catalog.float8le.RETURN_VALUE</code>.
     */
     ...
     */
    public Float8le() {
        super("float8le", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
