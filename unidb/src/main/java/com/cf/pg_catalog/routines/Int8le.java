...
public class Int8le extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1859020682;

    /**
     * The parameter <code>pg_catalog.int8le.RETURN_VALUE</code>.
     */
     ...
     */
    public Int8le() {
        super("int8le", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
