...
public class UuidGt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1696979639;

    /**
     * The parameter <code>pg_catalog.uuid_gt.RETURN_VALUE</code>.
     */
     ...
     */
    public UuidGt() {
        super("uuid_gt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
