...
public class GetByte extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -1292367187;
     ...
     */
    public GetByte() {
        super("get_byte", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
