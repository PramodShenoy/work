...
public class TextGe extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 443984588;

    /**
     * The parameter <code>pg_catalog.text_ge.RETURN_VALUE</code>.
     */
     ...
     */
    public TextGe() {
        super("text_ge", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
