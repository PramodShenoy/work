...
public class Int2le extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1349086236;

    /**
     * The parameter <code>pg_catalog.int2le.RETURN_VALUE</code>.
     */
     ...
     */
    public Int2le() {
        super("int2le", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
