...
public class Varbiteq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1039285222;

    /**
     * The parameter <code>pg_catalog.varbiteq.RETURN_VALUE</code>.
     */
     ...
     */
    public Varbiteq() {
        super("varbiteq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
