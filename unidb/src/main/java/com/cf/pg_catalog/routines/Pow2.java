...
public class Pow2 extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 626145756;
     ...
     */
    public Pow2() {
        super("pow", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
