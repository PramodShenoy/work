...
public class Int8Sum extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -845321224;
     ...
     */
    public Int8Sum() {
        super("int8_sum", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
