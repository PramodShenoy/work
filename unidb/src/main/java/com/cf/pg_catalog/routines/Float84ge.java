...
public class Float84ge extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1306060710;

    /**
     * The parameter <code>pg_catalog.float84ge.RETURN_VALUE</code>.
     */
     ...
     */
    public Float84ge() {
        super("float84ge", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
