...
public class Float8RegrSxy extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 241384111;
     ...
     */
    public Float8RegrSxy() {
        super("float8_regr_sxy", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
