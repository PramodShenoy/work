...
public class UuidNe extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1262768035;

    /**
     * The parameter <code>pg_catalog.uuid_ne.RETURN_VALUE</code>.
     */
     ...
     */
    public UuidNe() {
        super("uuid_ne", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
