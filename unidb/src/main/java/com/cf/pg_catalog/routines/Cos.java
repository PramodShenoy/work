...
public class Cos extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1307939731;

    /**
     * The parameter <code>pg_catalog.cos.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.cos._1</code>.
     */
     ...
     */
    public Cos() {
        super("cos", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
