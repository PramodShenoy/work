...
public class DateGeTimestamp extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 745622768;
     ...
     */
    public DateGeTimestamp() {
        super("date_ge_timestamp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
