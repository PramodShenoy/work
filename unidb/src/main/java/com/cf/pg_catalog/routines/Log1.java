...
public class Log1 extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -1021395183;
     ...
     */
    public Log1() {
        super("log", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
