...
public class Float84le extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1929636004;
     ...
     */
    public Float84le() {
        super("float84le", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
