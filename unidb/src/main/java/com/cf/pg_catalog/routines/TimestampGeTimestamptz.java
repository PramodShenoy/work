...
public class TimestampGeTimestamptz extends AbstractRoutine<Boolean> {
    ...
    private static final long serialVersionUID = -1366327196;

    /**
     * The parameter <code>pg_catalog.timestamp_ge_timestamptz.RETURN_VALUE</code>.
     */
    ...
    public TimestampGeTimestamptz() {
        super("timestamp_ge_timestamptz", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
