...
public class PgStatGetLastAnalyzeTime extends AbstractRoutine<Timestamp> {

    private static final long serialVersionUID = 596602314;
    ...
    public PgStatGetLastAnalyzeTime() {
        super("pg_stat_get_last_analyze_time", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIMESTAMP);
