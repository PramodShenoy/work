...
public class Sign2 extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -58774108;
     ...
     */
    public Sign2() {
        super("sign", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
