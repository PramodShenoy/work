...
public class Contjoinsel extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -2054599844;

    /**
     * The parameter <code>pg_catalog.contjoinsel.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.contjoinsel._1</code>.
     */
     ...
     */
    public Contjoinsel() {
        super("contjoinsel", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
