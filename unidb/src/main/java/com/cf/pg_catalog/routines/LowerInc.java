...
public class LowerInc extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 71671213;

    /**
     * The parameter <code>pg_catalog.lower_inc.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.lower_inc._1</code>.
     */
     ...
     */
    public LowerInc() {
        super("lower_inc", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
