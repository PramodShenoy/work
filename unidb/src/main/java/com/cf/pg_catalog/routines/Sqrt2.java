...
public class Sqrt2 extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 286992414;

    /**
     * The parameter <code>pg_catalog.sqrt.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.sqrt._1</code>.
     */
     ...
     */
    public Sqrt2() {
        super("sqrt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
