...
public class Like1 extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1069023111;
     ...
     */
    public Like1() {
        super("like", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
