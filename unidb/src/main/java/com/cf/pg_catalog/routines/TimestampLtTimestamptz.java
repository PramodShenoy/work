...
public class TimestampLtTimestamptz extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -991625820;

    /**
     * The parameter <code>pg_catalog.timestamp_lt_timestamptz.RETURN_VALUE</code>.
     */
     ...
     */
    public TimestampLtTimestamptz() {
        super("timestamp_lt_timestamptz", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
