...
public class QueryToXmlschema extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 663286232;
    ...
    public QueryToXmlschema() {
        super("query_to_xmlschema", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("xml"));
