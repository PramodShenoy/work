...
public class Power2 extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -862076158;

    /**
     * The parameter <code>pg_catalog.power.RETURN_VALUE</code>.
     */
     ...
     */
    public Power2() {
        super("power", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
