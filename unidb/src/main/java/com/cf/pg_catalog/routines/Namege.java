...
public class Namege extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -107787564;

    /**
     * The parameter <code>pg_catalog.namege.RETURN_VALUE</code>.
     */
     ...
     */
    public Namege() {
        super("namege", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
