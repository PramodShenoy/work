...
public class TimestamptzEqDate extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 2062058358;

    /**
     * The parameter <code>pg_catalog.timestamptz_eq_date.RETURN_VALUE</code>.
     */
     ...
     */
    public TimestamptzEqDate() {
        super("timestamptz_eq_date", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
