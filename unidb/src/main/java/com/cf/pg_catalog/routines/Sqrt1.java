...
public class Sqrt1 extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -1334475327;
     ...
     */
    public Sqrt1() {
        super("sqrt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
