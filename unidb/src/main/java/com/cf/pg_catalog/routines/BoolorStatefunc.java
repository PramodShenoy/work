...
public class BoolorStatefunc extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1478956512;
     ...
     */
    public BoolorStatefunc() {
        super("boolor_statefunc", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
