...
public class Float84pl extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -1520946398;

    /**
     * The parameter <code>pg_catalog.float84pl.RETURN_VALUE</code>.
     */
     ...
     */
    public Float84pl() {
        super("float84pl", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
