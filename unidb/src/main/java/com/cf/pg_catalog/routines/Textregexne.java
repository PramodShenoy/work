...
public class Textregexne extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1095722504;

    /**
     * The parameter <code>pg_catalog.textregexne.RETURN_VALUE</code>.
     */
     ...
     */
    public Textregexne() {
        super("textregexne", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
