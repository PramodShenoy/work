...
public class Atan2 extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -1675424392;

    /**
     * The parameter <code>pg_catalog.atan2.RETURN_VALUE</code>.
     */
     ...
     */
    public Atan2() {
        super("atan2", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
