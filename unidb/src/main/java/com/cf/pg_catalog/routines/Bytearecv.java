...
public class Bytearecv extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = 1799976736;

    /**
     * The parameter <code>pg_catalog.bytearecv.RETURN_VALUE</code>.
     */
    public static final Parameter<byte[]> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.BLOB, false, false);

    /**
     * The parameter <code>pg_catalog.bytearecv._1</code>.
     */
     ...
     */
    public Bytearecv() {
        super("bytearecv", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
