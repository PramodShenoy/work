...
public class JsonbCmp extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1262739670;
     ...
     */
    public JsonbCmp() {
        super("jsonb_cmp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
