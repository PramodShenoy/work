...
public class BoolAccum extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 1159970469;

    /**
     * The parameter <code>pg_catalog.bool_accum.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.bool_accum._1</code>.
     */
     ...
     */
    public BoolAccum() {
        super("bool_accum", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
