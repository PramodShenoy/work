...
public class Bytealike extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 2004181046;
     ...
     */
    public Bytealike() {
        super("bytealike", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
