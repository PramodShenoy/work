...
public class Namegt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 808154546;

    /**
     * The parameter <code>pg_catalog.namegt.RETURN_VALUE</code>.
     */
     ...
     */
    public Namegt() {
        super("namegt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
