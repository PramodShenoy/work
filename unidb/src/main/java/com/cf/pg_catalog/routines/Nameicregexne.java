...
public class Nameicregexne extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1577438879;

    /**
     * The parameter <code>pg_catalog.nameicregexne.RETURN_VALUE</code>.
     */
     ...
     */
    public Nameicregexne() {
        super("nameicregexne", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
