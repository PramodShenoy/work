...
public class Xidrecv extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1870926082;

    /**
     * The parameter <code>pg_catalog.xidrecv.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.xidrecv._1</code>.
     */
     ...
     */
    public Xidrecv() {
        super("xidrecv", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
