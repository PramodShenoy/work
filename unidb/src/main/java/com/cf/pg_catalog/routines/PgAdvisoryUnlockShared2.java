...
public class PgAdvisoryUnlockShared2 extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 367538289;

    /**
     * The parameter <code>pg_catalog.pg_advisory_unlock_shared.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.pg_advisory_unlock_shared._1</code>.
     */
    public static final Parameter<Integer> _1 = createParameter("_1", org.jooq.impl.SQLDataType.INTEGER, false, true);

    /**
     * The parameter <code>pg_catalog.pg_advisory_unlock_shared._2</code>.
     */
     ...
     */
    public PgAdvisoryUnlockShared2() {
        super("pg_advisory_unlock_shared", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
