...
public class Tidin extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -1252446074;

    /**
     * The parameter <code>pg_catalog.tidin.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.tidin._1</code>.
     */
     ...
     */
    public Tidin() {
        super("tidin", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
