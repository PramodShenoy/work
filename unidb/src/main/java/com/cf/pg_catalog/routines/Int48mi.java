...
public class Int48mi extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 522253163;

    /**
     * The parameter <code>pg_catalog.int48mi.RETURN_VALUE</code>.
     */
     ...
     */
    public Int48mi() {
        super("int48mi", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
