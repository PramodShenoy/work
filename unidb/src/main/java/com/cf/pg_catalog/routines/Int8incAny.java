...
public class Int8incAny extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -539781506;
    ...
    /**
     * The parameter <code>pg_catalog.int8inc_any._2</code>.
     */
     ...
     */
    public Int8incAny() {
        super("int8inc_any", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
