...
public class Byteacmp extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -1533837270;

    /**
     * The parameter <code>pg_catalog.byteacmp.RETURN_VALUE</code>.
     */
    public static final Parameter<Integer> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>pg_catalog.byteacmp._1</code>.
     */
    public static final Parameter<byte[]> _1 = createParameter("_1", org.jooq.impl.SQLDataType.BLOB, false, true);

    /**
     * The parameter <code>pg_catalog.byteacmp._2</code>.
     */
     ...
     */
    public Byteacmp() {
        super("byteacmp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
