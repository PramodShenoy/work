...
public class NumericLt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 999176241;

    /**
     * The parameter <code>pg_catalog.numeric_lt.RETURN_VALUE</code>.
     */
     ...
     */
    public NumericLt() {
        super("numeric_lt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
