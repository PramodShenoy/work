...
public class RangeSend extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = -1259636445;

    /**
     * The parameter <code>pg_catalog.range_send.RETURN_VALUE</code>.
     */
    public static final Parameter<byte[]> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.BLOB, false, false);

    /**
     * The parameter <code>pg_catalog.range_send._1</code>.
     */
     ...
     */
    public RangeSend() {
        super("range_send", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
