...
public class Timetztypmodout extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1906045730;

    /**
     * The parameter <code>pg_catalog.timetztypmodout.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.timetztypmodout._1</code>.
     */
     ...
     */
    public Timetztypmodout() {
        super("timetztypmodout", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("cstring"));
