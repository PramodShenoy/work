...
public class Int28lt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 106016829;

    /**
     * The parameter <code>pg_catalog.int28lt.RETURN_VALUE</code>.
     */
     ...
     */
    public Int28lt() {
        super("int28lt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
