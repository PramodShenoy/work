...
public class Int8lt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1109935402;

    /**
     * The parameter <code>pg_catalog.int8lt.RETURN_VALUE</code>.
     */
     ...
     */
    public Int8lt() {
        super("int8lt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
