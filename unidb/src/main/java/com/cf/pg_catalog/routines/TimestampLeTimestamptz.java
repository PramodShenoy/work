...
public class TimestampLeTimestamptz extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1628086212;

    /**
     * The parameter <code>pg_catalog.timestamp_le_timestamptz.RETURN_VALUE</code>.
     */
     ...
     */
    public TimestampLeTimestamptz() {
        super("timestamp_le_timestamptz", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
