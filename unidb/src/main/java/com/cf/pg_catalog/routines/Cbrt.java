...
public class Cbrt extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 8691731;

    /**
     * The parameter <code>pg_catalog.cbrt.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.cbrt._1</code>.
     */
     ...
     */
    public Cbrt() {
        super("cbrt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
