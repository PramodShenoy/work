...
public class Int8or extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -808910670;

    /**
     * The parameter <code>pg_catalog.int8or.RETURN_VALUE</code>.
     */
     ...
     */
    public Int8or() {
        super("int8or", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
