...
public class Nameicnlike extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 456949219;

    /**
     * The parameter <code>pg_catalog.nameicnlike.RETURN_VALUE</code>.
     */
     ...
     */
    public Nameicnlike() {
        super("nameicnlike", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
