...
public class Int28mi extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 844869519;

    /**
     * The parameter <code>pg_catalog.int28mi.RETURN_VALUE</code>.
     */
     ...
     */
    public Int28mi() {
        super("int28mi", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
