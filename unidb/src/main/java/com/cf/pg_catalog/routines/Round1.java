...
public class Round1 extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -2051891873;
     ...
     */
    public Round1() {
        super("round", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
