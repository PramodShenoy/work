...
public class Float8larger extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -1560490194;

    /**
     * The parameter <code>pg_catalog.float8larger.RETURN_VALUE</code>.
     */
     ...
     */
    public Float8larger() {
        super("float8larger", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
