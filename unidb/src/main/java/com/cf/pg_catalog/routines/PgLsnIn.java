...
public class PgLsnIn extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1294175235;

    /**
     * The parameter <code>pg_catalog.pg_lsn_in.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.pg_lsn_in._1</code>.
     */
     ...
     */
    public PgLsnIn() {
        super("pg_lsn_in", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("pg_lsn"));
