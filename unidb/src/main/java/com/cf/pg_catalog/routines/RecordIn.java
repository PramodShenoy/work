...
public class RecordIn extends AbstractRoutine<Void> {

    private static final long serialVersionUID = -1618079175;

    /**
     * The parameter <code>pg_catalog.record_in._1</code>.
     */
     ...
     */
    public RecordIn() {
        super("record_in", PgCatalog.PG_CATALOG);
