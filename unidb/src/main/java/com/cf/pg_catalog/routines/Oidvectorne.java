...
public class Oidvectorne extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -146611302;

    /**
     * The parameter <code>pg_catalog.oidvectorne.RETURN_VALUE</code>.
     */
     ...
     */
    public Oidvectorne() {
        super("oidvectorne", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
