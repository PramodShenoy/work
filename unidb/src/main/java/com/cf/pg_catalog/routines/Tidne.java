...
public class Tidne extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 2039609250;

    /**
     * The parameter <code>pg_catalog.tidne.RETURN_VALUE</code>.
     */
     ...
     */
    public Tidne() {
        super("tidne", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
