...
public class Timezone5 extends AbstractRoutine<Timestamp> {

    private static final long serialVersionUID = 1147720636;
     ...
     */
    public Timezone5() {
        super("timezone", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIMESTAMP);
