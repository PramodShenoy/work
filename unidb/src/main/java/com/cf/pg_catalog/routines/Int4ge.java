...
public class Int4ge extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 921100462;

    /**
     * The parameter <code>pg_catalog.int4ge.RETURN_VALUE</code>.
     */
     ...
     */
    public Int4ge() {
        super("int4ge", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
