...
public class JsonbExists extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 2990497;
     ...
     */
    public JsonbExists() {
        super("jsonb_exists", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
