...
public class NumericVarSamp extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -643641039;

    /**
     * The parameter <code>pg_catalog.numeric_var_samp.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.numeric_var_samp._1</code>.
     */
    ...
    public NumericVarSamp() {
        super("numeric_var_samp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
