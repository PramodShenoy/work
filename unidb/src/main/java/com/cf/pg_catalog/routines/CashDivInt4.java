...
public class CashDivInt4 extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 2092735249;

    /**
     * The parameter <code>pg_catalog.cash_div_int4.RETURN_VALUE</code>.
     */
     ...
     */
    public CashDivInt4() {
        super("cash_div_int4", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
