...
public class Float4smaller extends AbstractRoutine<Float> {

    private static final long serialVersionUID = 215666544;
     ...
     */
    public Float4smaller() {
        super("float4smaller", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.REAL);
