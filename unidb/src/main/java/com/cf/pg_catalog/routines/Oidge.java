...
public class Oidge extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 451040614;

    /**
     * The parameter <code>pg_catalog.oidge.RETURN_VALUE</code>.
     */
     ...
     */
    public Oidge() {
        super("oidge", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
