...
public class JsonArrayElementText extends AbstractRoutine<String> {
    ...
    private static final long serialVersionUID = -1160625443;

    /**
     * The parameter <code>pg_catalog.json_array_element_text.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.json_array_element_text.element_index</code>.
     */
    ...
    public JsonArrayElementText() {
        super("json_array_element_text", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
