...
public class DatabaseToXml extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1229713919;
    ...
    public DatabaseToXml() {
        super("database_to_xml", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("xml"));
