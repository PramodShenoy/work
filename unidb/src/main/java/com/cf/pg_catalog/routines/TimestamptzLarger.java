...
public class TimestamptzLarger extends AbstractRoutine<Timestamp> {

    private static final long serialVersionUID = 875876154;
    ...
    public TimestamptzLarger() {
        super("timestamptz_larger", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIMESTAMP);
