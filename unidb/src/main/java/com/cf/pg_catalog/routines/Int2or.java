...
public class Int2or extends AbstractRoutine<Short> {

    private static final long serialVersionUID = 1161861806;

    /**
     * The parameter <code>pg_catalog.int2or.RETURN_VALUE</code>.
     */
     ...
     */
    public Int2or() {
        super("int2or", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.SMALLINT);
