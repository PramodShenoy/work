...
public class PgLsDir2 extends AbstractRoutine<String> {

    private static final long serialVersionUID = 1267062039;

    /**
     * The parameter <code>pg_catalog.pg_ls_dir.RETURN_VALUE</code>.
     */
     ...
     */
    public PgLsDir2() {
        super("pg_ls_dir", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
