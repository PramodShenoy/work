...
public class PgStatGetXactTuplesUpdated extends AbstractRoutine<Long> {
    ...
    private static final long serialVersionUID = 1287093841;

    /**
     * The parameter <code>pg_catalog.pg_stat_get_xact_tuples_updated.RETURN_VALUE</code>.
     */
    ...
    public PgStatGetXactTuplesUpdated() {
        super("pg_stat_get_xact_tuples_updated", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
