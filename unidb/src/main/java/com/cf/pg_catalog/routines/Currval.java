...
public class Currval extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 509041459;

    /**
     * The parameter <code>pg_catalog.currval.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.currval._1</code>.
     */
     ...
     */
    public Currval() {
        super("currval", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
