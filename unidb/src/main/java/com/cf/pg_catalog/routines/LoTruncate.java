...
public class LoTruncate extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1786163326;
     ...
     */
    public LoTruncate() {
        super("lo_truncate", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
