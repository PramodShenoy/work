...
public class NumericPower extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -54490127;

    /**
     * The parameter <code>pg_catalog.numeric_power.RETURN_VALUE</code>.
     */
     ...
     */
    public NumericPower() {
        super("numeric_power", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
