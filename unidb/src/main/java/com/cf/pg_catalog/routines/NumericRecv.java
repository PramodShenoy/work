...
public class NumericRecv extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 1989767031;
    ...
    /**
     * The parameter <code>pg_catalog.numeric_recv._1</code>.
     */
     ...
     */
    public NumericRecv() {
        super("numeric_recv", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
