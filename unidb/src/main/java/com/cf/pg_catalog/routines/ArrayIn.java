...
public class ArrayIn extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 150486086;
    ...
    /**
     * The parameter <code>pg_catalog.array_in._1</code>.
     */
     ...
     */
    public ArrayIn() {
        super("array_in", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("anyarray"));
