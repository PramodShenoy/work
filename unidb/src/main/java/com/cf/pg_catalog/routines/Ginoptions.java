...
public class Ginoptions extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = 717609977;

    /**
     * The parameter <code>pg_catalog.ginoptions.RETURN_VALUE</code>.
     */
    public static final Parameter<byte[]> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.BLOB, false, false);

    /**
     * The parameter <code>pg_catalog.ginoptions._1</code>.
     */
    public static final Parameter<String[]> _1 = createParameter("_1", org.jooq.impl.SQLDataType.CLOB.getArrayDataType(), false, true);

    /**
     * The parameter <code>pg_catalog.ginoptions._2</code>.
     */
     ...
     */
    public Ginoptions() {
        super("ginoptions", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
