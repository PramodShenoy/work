...
public class PgStatGetXactTuplesDeleted extends AbstractRoutine<Long> {
    ...
    private static final long serialVersionUID = -530391505;

    /**
     * The parameter <code>pg_catalog.pg_stat_get_xact_tuples_deleted.RETURN_VALUE</code>.
     */
    ...
    public PgStatGetXactTuplesDeleted() {
        super("pg_stat_get_xact_tuples_deleted", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
