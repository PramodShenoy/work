...
public class Sum8 extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1682937929;
     ...
     */
    public Sum8() {
        super("sum", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
