...
public class Int4pl extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -428355198;

    /**
     * The parameter <code>pg_catalog.int4pl.RETURN_VALUE</code>.
     */
    public static final Parameter<Integer> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>pg_catalog.int4pl._1</code>.
     */
    public static final Parameter<Integer> _1 = createParameter("_1", org.jooq.impl.SQLDataType.INTEGER, false, true);

    /**
     * The parameter <code>pg_catalog.int4pl._2</code>.
     */
     ...
     */
    public Int4pl() {
        super("int4pl", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
