...
public class Abs5 extends AbstractRoutine<Short> {

    private static final long serialVersionUID = -1184809877;
     ...
     */
    public Abs5() {
        super("abs", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.SMALLINT);
