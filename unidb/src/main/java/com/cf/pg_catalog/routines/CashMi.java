...
public class CashMi extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 656261891;

    /**
     * The parameter <code>pg_catalog.cash_mi.RETURN_VALUE</code>.
     */
     ...
     */
    public CashMi() {
        super("cash_mi", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
