...
public class Float8RegrSxx extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1930963408;

    /**
     * The parameter <code>pg_catalog.float8_regr_sxx.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.float8_regr_sxx._1</code>.
     */
    ...
    public Float8RegrSxx() {
        super("float8_regr_sxx", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
