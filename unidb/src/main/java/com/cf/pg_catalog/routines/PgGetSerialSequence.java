...
public class PgGetSerialSequence extends AbstractRoutine<String> {

    private static final long serialVersionUID = 1674304902;

    /**
     * The parameter <code>pg_catalog.pg_get_serial_sequence.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.pg_get_serial_sequence._1</code>.
     */
    public static final Parameter<String> _1 = createParameter("_1", org.jooq.impl.SQLDataType.CLOB, false, true);

    /**
     * The parameter <code>pg_catalog.pg_get_serial_sequence._2</code>.
     */
     ...
     */
    public PgGetSerialSequence() {
        super("pg_get_serial_sequence", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
