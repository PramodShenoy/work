...
public class Textnlike extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1709517946;
     ...
     */
    public Textnlike() {
        super("textnlike", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
