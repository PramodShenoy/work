...
public class HasDatabasePrivilege4 extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -2048007856;

    /**
     * The parameter <code>pg_catalog.has_database_privilege.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.has_database_privilege._3</code>.
     */
     ...
     */
    public HasDatabasePrivilege4() {
        super("has_database_privilege", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
