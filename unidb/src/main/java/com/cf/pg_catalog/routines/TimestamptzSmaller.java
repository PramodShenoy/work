...
public class TimestamptzSmaller extends AbstractRoutine<Timestamp> {

    private static final long serialVersionUID = 1744551686;
    ...
    public TimestamptzSmaller() {
        super("timestamptz_smaller", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIMESTAMP);
