...
public class TimeLe extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1932787241;

    /**
     * The parameter <code>pg_catalog.time_le.RETURN_VALUE</code>.
     */
     ...
     */
    public TimeLe() {
        super("time_le", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
