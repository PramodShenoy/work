...
public class Dround extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1237689102;

    /**
     * The parameter <code>pg_catalog.dround.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.dround._1</code>.
     */
     ...
     */
    public Dround() {
        super("dround", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
