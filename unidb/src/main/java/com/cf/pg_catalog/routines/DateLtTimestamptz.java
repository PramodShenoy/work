...
public class DateLtTimestamptz extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1473745296;

    /**
     * The parameter <code>pg_catalog.date_lt_timestamptz.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.date_lt_timestamptz._1</code>.
     */
    public static final Parameter<Date> _1 = createParameter("_1", org.jooq.impl.SQLDataType.DATE, false, true);

    /**
     * The parameter <code>pg_catalog.date_lt_timestamptz._2</code>.
     */
     ...
     */
    public DateLtTimestamptz() {
        super("date_lt_timestamptz", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
