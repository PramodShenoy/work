...
public class NumericLe extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 518608723;

    /**
     * The parameter <code>pg_catalog.numeric_le.RETURN_VALUE</code>.
     */
     ...
     */
    public NumericLe() {
        super("numeric_le", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
