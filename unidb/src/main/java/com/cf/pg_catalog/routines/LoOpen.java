...
public class LoOpen extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 363557545;
     ...
     */
    public LoOpen() {
        super("lo_open", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
