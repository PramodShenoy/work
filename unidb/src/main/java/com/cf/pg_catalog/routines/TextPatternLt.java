...
public class TextPatternLt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1680691112;

    /**
     * The parameter <code>pg_catalog.text_pattern_lt.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.text_pattern_lt._1</code>.
     */
    public static final Parameter<String> _1 = createParameter("_1", org.jooq.impl.SQLDataType.CLOB, false, true);

    /**
     * The parameter <code>pg_catalog.text_pattern_lt._2</code>.
     */
     ...
     */
    public TextPatternLt() {
        super("text_pattern_lt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
