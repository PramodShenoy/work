...
public class TimetzdatePl extends AbstractRoutine<Timestamp> {

    private static final long serialVersionUID = 749675319;
     ...
     */
    public TimetzdatePl() {
        super("timetzdate_pl", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIMESTAMP);
