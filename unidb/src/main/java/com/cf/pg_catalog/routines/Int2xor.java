...
public class Int2xor extends AbstractRoutine<Short> {

    private static final long serialVersionUID = -228979088;
     ...
     */
    public Int2xor() {
        super("int2xor", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.SMALLINT);
