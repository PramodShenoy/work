...
public class Spggetbitmap extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -1711144572;

    /**
     * The parameter <code>pg_catalog.spggetbitmap.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.spggetbitmap._1</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.spggetbitmap._2</code>.
     */
     ...
     */
    public Spggetbitmap() {
        super("spggetbitmap", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
