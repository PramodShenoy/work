...
public class Textin extends AbstractRoutine<String> {

    private static final long serialVersionUID = -712027280;

    /**
     * The parameter <code>pg_catalog.textin.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.textin._1</code>.
     */
     ...
     */
    public Textin() {
        super("textin", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
