...
public class TimestampNe extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1804323582;

    /**
     * The parameter <code>pg_catalog.timestamp_ne.RETURN_VALUE</code>.
     */
     ...
     */
    public TimestampNe() {
        super("timestamp_ne", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
