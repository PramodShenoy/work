...
public class SpgKdChoose extends AbstractRoutine<Void> {

    private static final long serialVersionUID = -48324777;

    /**
     * The parameter <code>pg_catalog.spg_kd_choose._1</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.spg_kd_choose._2</code>.
     */
     ...
     */
    public SpgKdChoose() {
        super("spg_kd_choose", PgCatalog.PG_CATALOG);
