...
public class RegrR2 extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -1388794978;

    /**
     * The parameter <code>pg_catalog.regr_r2.RETURN_VALUE</code>.
     */
     ...
     */
    public RegrR2() {
        super("regr_r2", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
