...
public class TimeLt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1517823947;
     ...
     */
    public TimeLt() {
        super("time_lt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
