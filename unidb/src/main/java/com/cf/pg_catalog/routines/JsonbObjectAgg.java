...
public class JsonbObjectAgg extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -850486374;
    ...
    /**
     * The parameter <code>pg_catalog.jsonb_object_agg._1</code>.
     */
    public static final Parameter<Object> _1 = createParameter("_1", org.jooq.impl.SQLDataType.OTHER, false, true);

    /**
     * The parameter <code>pg_catalog.jsonb_object_agg._2</code>.
     */
    ...
    public JsonbObjectAgg() {
        super("jsonb_object_agg", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("jsonb"));
