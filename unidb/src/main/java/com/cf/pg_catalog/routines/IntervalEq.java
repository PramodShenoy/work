...
public class IntervalEq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1675520896;
     ...
     */
    public IntervalEq() {
        super("interval_eq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
