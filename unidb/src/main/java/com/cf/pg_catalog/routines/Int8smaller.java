...
public class Int8smaller extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 548337374;

    /**
     * The parameter <code>pg_catalog.int8smaller.RETURN_VALUE</code>.
     */
     ...
     */
    public Int8smaller() {
        super("int8smaller", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
