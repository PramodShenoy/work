...
public class Int82gt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -456311263;

    /**
     * The parameter <code>pg_catalog.int82gt.RETURN_VALUE</code>.
     */
     ...
     */
    public Int82gt() {
        super("int82gt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
