...
public class Byteale extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1048825210;

    /**
     * The parameter <code>pg_catalog.byteale.RETURN_VALUE</code>.
     */
     ...
     */
    public Byteale() {
        super("byteale", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
