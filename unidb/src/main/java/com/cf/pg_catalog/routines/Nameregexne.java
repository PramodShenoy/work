...
public class Nameregexne extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1073983607;

    /**
     * The parameter <code>pg_catalog.nameregexne.RETURN_VALUE</code>.
     */
     ...
     */
    public Nameregexne() {
        super("nameregexne", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
