...
public class JsonPopulateRecord extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 362518563;

    /**
     * The parameter <code>pg_catalog.json_populate_record.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.json_populate_record.base</code>.
     */
    ...
    public JsonPopulateRecord() {
        super("json_populate_record", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("anyelement"));
