...
public class Oidlarger extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -548298274;
     ...
     */
    public Oidlarger() {
        super("oidlarger", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
