...
public class Likejoinsel extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 810656513;

    /**
     * The parameter <code>pg_catalog.likejoinsel.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.likejoinsel._1</code>.
     */
     ...
     */
    public Likejoinsel() {
        super("likejoinsel", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
