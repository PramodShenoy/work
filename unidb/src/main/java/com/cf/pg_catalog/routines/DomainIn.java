...
public class DomainIn extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 780204191;

    /**
     * The parameter <code>pg_catalog.domain_in.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.domain_in._1</code>.
     */
     ...
     */
    public DomainIn() {
        super("domain_in", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.OTHER);
