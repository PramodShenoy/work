...
public class BitAnd2 extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -840541362;
     ...
     */
    public BitAnd2() {
        super("bit_and", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
