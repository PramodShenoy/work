...
public class Int2pl extends AbstractRoutine<Short> {

    private static final long serialVersionUID = 134183036;

    /**
     * The parameter <code>pg_catalog.int2pl.RETURN_VALUE</code>.
     */
     ...
     */
    public Int2pl() {
        super("int2pl", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.SMALLINT);
