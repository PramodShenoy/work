...
public class CashIn extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 662922088;

    /**
     * The parameter <code>pg_catalog.cash_in.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.cash_in._1</code>.
     */
     ...
     */
    public CashIn() {
        super("cash_in", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
