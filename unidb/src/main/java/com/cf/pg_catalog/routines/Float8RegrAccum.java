...
public class Float8RegrAccum extends AbstractRoutine<Double[]> {

    private static final long serialVersionUID = -662646654;
     ...
     */
    public Float8RegrAccum() {
        super("float8_regr_accum", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.FLOAT.getArrayDataType());
