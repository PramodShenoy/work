...
public class Int8rangeSubdiff extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 129307166;
     ...
     */
    public Int8rangeSubdiff() {
        super("int8range_subdiff", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
