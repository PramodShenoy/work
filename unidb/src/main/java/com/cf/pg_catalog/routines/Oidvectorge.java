...
public class Oidvectorge extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -109253034;
     ...
     */
    public Oidvectorge() {
        super("oidvectorge", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
