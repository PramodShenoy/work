...
public class Int2div extends AbstractRoutine<Short> {

    private static final long serialVersionUID = -1922216528;

    /**
     * The parameter <code>pg_catalog.int2div.RETURN_VALUE</code>.
     */
     ...
     */
    public Int2div() {
        super("int2div", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.SMALLINT);
