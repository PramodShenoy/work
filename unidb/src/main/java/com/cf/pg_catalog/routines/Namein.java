...
public class Namein extends AbstractRoutine<String> {

    private static final long serialVersionUID = 1946834920;

    /**
     * The parameter <code>pg_catalog.namein.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.namein._1</code>.
     */
     ...
     */
    public Namein() {
        super("namein", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.VARCHAR);
