...
public class Varcharin extends AbstractRoutine<String> {

    private static final long serialVersionUID = -108553663;

    /**
     * The parameter <code>pg_catalog.varcharin.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.varcharin._1</code>.
     */
     ...
     */
    public Varcharin() {
        super("varcharin", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.VARCHAR);
