...
public class Float84ne extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 646934312;

    /**
     * The parameter <code>pg_catalog.float84ne.RETURN_VALUE</code>.
     */
     ...
     */
    public Float84ne() {
        super("float84ne", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
