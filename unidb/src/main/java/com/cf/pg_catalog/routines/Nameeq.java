...
public class Nameeq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -297616400;

    /**
     * The parameter <code>pg_catalog.nameeq.RETURN_VALUE</code>.
     */
     ...
     */
    public Nameeq() {
        super("nameeq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
