...
public class TimetzRecv extends AbstractRoutine<Time> {

    private static final long serialVersionUID = -1337864297;
    ...
    /**
     * The parameter <code>pg_catalog.timetz_recv._1</code>.
     */
     ...
     */
    public TimetzRecv() {
        super("timetz_recv", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIME);
