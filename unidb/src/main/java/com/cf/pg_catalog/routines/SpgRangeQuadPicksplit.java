...
public class SpgRangeQuadPicksplit extends AbstractRoutine<Void> {

    private static final long serialVersionUID = 633278699;

    /**
     * The parameter <code>pg_catalog.spg_range_quad_picksplit._1</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.spg_range_quad_picksplit._2</code>.
     */
     ...
     */
    public SpgRangeQuadPicksplit() {
        super("spg_range_quad_picksplit", PgCatalog.PG_CATALOG);
