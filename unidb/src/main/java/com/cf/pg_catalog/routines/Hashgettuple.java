...
public class Hashgettuple extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1088875974;

    /**
     * The parameter <code>pg_catalog.hashgettuple.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.hashgettuple._1</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.hashgettuple._2</code>.
     */
     ...
     */
    public Hashgettuple() {
        super("hashgettuple", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
