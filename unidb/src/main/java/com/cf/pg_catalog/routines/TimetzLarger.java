...
public class TimetzLarger extends AbstractRoutine<Time> {

    private static final long serialVersionUID = -844874615;
     ...
     */
    public TimetzLarger() {
        super("timetz_larger", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIME);
