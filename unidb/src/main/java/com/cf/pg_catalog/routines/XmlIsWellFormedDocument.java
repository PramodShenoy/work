...
public class XmlIsWellFormedDocument extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1173271102;

    /**
     * The parameter <code>pg_catalog.xml_is_well_formed_document.RETURN_VALUE</code>.
     */
     ...
     */
    public XmlIsWellFormedDocument() {
        super("xml_is_well_formed_document", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
