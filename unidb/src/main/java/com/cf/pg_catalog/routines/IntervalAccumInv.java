...
public class IntervalAccumInv extends AbstractRoutine<Object[]> {

    private static final long serialVersionUID = -1560844656;

    /**
     * The parameter <code>pg_catalog.interval_accum_inv.RETURN_VALUE</code>.
     */
     ...
     */
    public IntervalAccumInv() {
        super("interval_accum_inv", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("interval").getArrayDataType());
