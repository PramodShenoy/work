...
public class Tidge extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1906096464;
     ...
     */
    public Tidge() {
        super("tidge", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
