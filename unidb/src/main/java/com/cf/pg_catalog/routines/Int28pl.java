...
public class Int28pl extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -1409822641;
     ...
     */
    public Int28pl() {
        super("int28pl", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
