...
public class Oidout extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 834369745;

    /**
     * The parameter <code>pg_catalog.oidout.RETURN_VALUE</code>.
     */
     ...
     */
    public Oidout() {
        super("oidout", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("cstring"));
