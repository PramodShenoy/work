...
public class RegexpMatches2 extends AbstractRoutine<String[]> {

    private static final long serialVersionUID = -443754987;

    /**
     * The parameter <code>pg_catalog.regexp_matches.RETURN_VALUE</code>.
     */
     ...
     */
    public RegexpMatches2() {
        super("regexp_matches", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB.getArrayDataType());
