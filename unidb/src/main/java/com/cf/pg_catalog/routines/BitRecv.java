...
public class BitRecv extends AbstractRoutine<String> {

    private static final long serialVersionUID = 158713110;
    ...
    /**
     * The parameter <code>pg_catalog.bit_recv._1</code>.
     */
     ...
     */
    public BitRecv() {
        super("bit_recv", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CHAR);
