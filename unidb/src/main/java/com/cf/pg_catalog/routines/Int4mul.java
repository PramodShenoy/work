...
public class Int4mul extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1584343902;
     ...
     */
    public Int4mul() {
        super("int4mul", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
