...
public class TimetzPlInterval extends AbstractRoutine<Time> {

    private static final long serialVersionUID = 1195413048;

    /**
     * The parameter <code>pg_catalog.timetz_pl_interval.RETURN_VALUE</code>.
     */
     ...
     */
    public TimetzPlInterval() {
        super("timetz_pl_interval", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIME);
