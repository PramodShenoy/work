...
public class Cot extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1900047026;
     ...
     */
    public Cot() {
        super("cot", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
