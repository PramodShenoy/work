...
public class Varchartypmodout extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 98956378;

    /**
     * The parameter <code>pg_catalog.varchartypmodout.RETURN_VALUE</code>.
     */
    ...
    public Varchartypmodout() {
        super("varchartypmodout", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("cstring"));
