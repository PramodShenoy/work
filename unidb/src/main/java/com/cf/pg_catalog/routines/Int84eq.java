...
public class Int84eq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -326989233;

    /**
     * The parameter <code>pg_catalog.int84eq.RETURN_VALUE</code>.
     */
     ...
     */
    public Int84eq() {
        super("int84eq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
