...
public class Repeat extends AbstractRoutine<String> {

    private static final long serialVersionUID = -240565951;

    /**
     * The parameter <code>pg_catalog.repeat.RETURN_VALUE</code>.
     */
     ...
     */
    public Repeat() {
        super("repeat", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
