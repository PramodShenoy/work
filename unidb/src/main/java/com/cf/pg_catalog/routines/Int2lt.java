...
public class Int2lt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 739620346;

    /**
     * The parameter <code>pg_catalog.int2lt.RETURN_VALUE</code>.
     */
     ...
     */
    public Int2lt() {
        super("int2lt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
