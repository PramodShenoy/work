...
public class ToAscii1 extends AbstractRoutine<String> {

    private static final long serialVersionUID = 2059107077;
     ...
     */
    public ToAscii1() {
        super("to_ascii", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
