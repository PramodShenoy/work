...
public class Min5 extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 2093987234;
     ...
     */
    public Min5() {
        super("min", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
