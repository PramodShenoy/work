...
public class Int84pl extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1641627603;

    /**
     * The parameter <code>pg_catalog.int84pl.RETURN_VALUE</code>.
     */
     ...
     */
    public Int84pl() {
        super("int84pl", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
