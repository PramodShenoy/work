...
public class Byteane extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1476443126;

    /**
     * The parameter <code>pg_catalog.byteane.RETURN_VALUE</code>.
     */
     ...
     */
    public Byteane() {
        super("byteane", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
