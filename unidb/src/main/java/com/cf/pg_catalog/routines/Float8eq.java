...
public class Float8eq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1811577616;

    /**
     * The parameter <code>pg_catalog.float8eq.RETURN_VALUE</code>.
     */
     ...
     */
    public Float8eq() {
        super("float8eq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
