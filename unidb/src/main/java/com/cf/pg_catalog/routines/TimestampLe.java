...
public class TimestampLe extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -611330614;

    /**
     * The parameter <code>pg_catalog.timestamp_le.RETURN_VALUE</code>.
     */
     ...
     */
    public TimestampLe() {
        super("timestamp_le", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
