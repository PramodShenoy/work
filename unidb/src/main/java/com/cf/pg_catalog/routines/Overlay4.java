...
public class Overlay4 extends AbstractRoutine<String> {

    private static final long serialVersionUID = -2065219299;
     ...
     */
    public Overlay4() {
        super("overlay", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CHAR);
