...
public class TimestampSmaller extends AbstractRoutine<Timestamp> {

    private static final long serialVersionUID = -2111293702;
    ...
    public TimestampSmaller() {
        super("timestamp_smaller", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIMESTAMP);
