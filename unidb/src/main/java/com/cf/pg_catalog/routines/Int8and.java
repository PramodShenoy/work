...
public class Int8and extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 2146796670;

    /**
     * The parameter <code>pg_catalog.int8and.RETURN_VALUE</code>.
     */
     ...
     */
    public Int8and() {
        super("int8and", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
