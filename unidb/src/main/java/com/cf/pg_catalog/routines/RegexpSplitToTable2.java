...
public class RegexpSplitToTable2 extends AbstractRoutine<String> {

    private static final long serialVersionUID = 1233815465;

    /**
     * The parameter <code>pg_catalog.regexp_split_to_table.RETURN_VALUE</code>.
     */
     ...
     */
    public RegexpSplitToTable2() {
        super("regexp_split_to_table", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
