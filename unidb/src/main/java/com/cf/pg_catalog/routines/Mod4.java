...
public class Mod4 extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1731211669;
     ...
     */
    public Mod4() {
        super("mod", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
