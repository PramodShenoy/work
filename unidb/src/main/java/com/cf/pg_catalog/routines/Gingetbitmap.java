...
public class Gingetbitmap extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1521086792;

    /**
     * The parameter <code>pg_catalog.gingetbitmap.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.gingetbitmap._1</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.gingetbitmap._2</code>.
     */
     ...
     */
    public Gingetbitmap() {
        super("gingetbitmap", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
