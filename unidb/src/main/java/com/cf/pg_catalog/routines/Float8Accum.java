...
public class Float8Accum extends AbstractRoutine<Double[]> {

    private static final long serialVersionUID = 542860413;
     ...
     */
    public Float8Accum() {
        super("float8_accum", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.FLOAT.getArrayDataType());
