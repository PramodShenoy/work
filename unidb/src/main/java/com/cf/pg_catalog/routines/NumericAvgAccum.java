...
public class NumericAvgAccum extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 688037726;

    /**
     * The parameter <code>pg_catalog.numeric_avg_accum.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.numeric_avg_accum._1</code>.
     */
    ...
    public NumericAvgAccum() {
        super("numeric_avg_accum", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
