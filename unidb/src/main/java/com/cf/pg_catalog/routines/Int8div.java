...
public class Int8div extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 46205502;

    /**
     * The parameter <code>pg_catalog.int8div.RETURN_VALUE</code>.
     */
     ...
     */
    public Int8div() {
        super("int8div", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
