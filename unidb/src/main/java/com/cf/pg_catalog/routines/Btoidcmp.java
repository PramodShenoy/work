...
public class Btoidcmp extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 95716874;

    /**
     * The parameter <code>pg_catalog.btoidcmp.RETURN_VALUE</code>.
     */
    public static final Parameter<Integer> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>pg_catalog.btoidcmp._1</code>.
     */
    public static final Parameter<Long> _1 = createParameter("_1", org.jooq.impl.SQLDataType.BIGINT, false, true);

    /**
     * The parameter <code>pg_catalog.btoidcmp._2</code>.
     */
     ...
     */
    public Btoidcmp() {
        super("btoidcmp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
