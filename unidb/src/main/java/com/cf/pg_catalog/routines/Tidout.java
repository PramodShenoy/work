...
public class Tidout extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 242092588;

    /**
     * The parameter <code>pg_catalog.tidout.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.tidout._1</code>.
     */
     ...
     */
    public Tidout() {
        super("tidout", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("cstring"));
