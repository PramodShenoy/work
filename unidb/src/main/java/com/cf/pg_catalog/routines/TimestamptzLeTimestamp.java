...
public class TimestamptzLeTimestamp extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1809448772;

    /**
     * The parameter <code>pg_catalog.timestamptz_le_timestamp.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.timestamptz_le_timestamp._1</code>.
     */
    public static final Parameter<Timestamp> _1 = createParameter("_1", org.jooq.impl.SQLDataType.TIMESTAMP, false, true);

    /**
     * The parameter <code>pg_catalog.timestamptz_le_timestamp._2</code>.
     */
     ...
     */
    public TimestamptzLeTimestamp() {
        super("timestamptz_le_timestamp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
