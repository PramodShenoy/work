...
public class Float4eq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1333139436;

    /**
     * The parameter <code>pg_catalog.float4eq.RETURN_VALUE</code>.
     */
     ...
     */
    public Float4eq() {
        super("float4eq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
