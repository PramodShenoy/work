...
public class DatetimePl extends AbstractRoutine<Timestamp> {

    private static final long serialVersionUID = 560184191;
     ...
     */
    public DatetimePl() {
        super("datetime_pl", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIMESTAMP);
