...
public class Currtid extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 654969374;

    /**
     * The parameter <code>pg_catalog.currtid.RETURN_VALUE</code>.
     */
     ...
     */
    public Currtid() {
        super("currtid", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
