...
public class Int8up extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -970632727;

    /**
     * The parameter <code>pg_catalog.int8up.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.int8up._1</code>.
     */
     ...
     */
    public Int8up() {
        super("int8up", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
