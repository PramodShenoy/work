...
public class Boolsend extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = 645410252;
     ...
     */
    public Boolsend() {
        super("boolsend", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
