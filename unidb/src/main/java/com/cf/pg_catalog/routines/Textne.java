...
public class Textne extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -560957850;

    /**
     * The parameter <code>pg_catalog.textne.RETURN_VALUE</code>.
     */
     ...
     */
    public Textne() {
        super("textne", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
