...
public class NumericInc extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 412916541;
     ...
     */
    public NumericInc() {
        super("numeric_inc", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
