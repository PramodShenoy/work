...
public class LoLseek64 extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1381888213;
     ...
     */
    public LoLseek64() {
        super("lo_lseek64", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
