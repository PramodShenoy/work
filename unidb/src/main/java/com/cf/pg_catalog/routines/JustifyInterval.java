...
public class JustifyInterval extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -391863495;
    ...
    public JustifyInterval() {
        super("justify_interval", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("interval"));
