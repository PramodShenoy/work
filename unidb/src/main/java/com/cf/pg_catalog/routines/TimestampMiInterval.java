...
public class TimestampMiInterval extends AbstractRoutine<Timestamp> {

    private static final long serialVersionUID = 1658810927;
    ...
    public TimestampMiInterval() {
        super("timestamp_mi_interval", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIMESTAMP);
