...
public class Int48ge extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1549889015;

    /**
     * The parameter <code>pg_catalog.int48ge.RETURN_VALUE</code>.
     */
     ...
     */
    public Int48ge() {
        super("int48ge", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
