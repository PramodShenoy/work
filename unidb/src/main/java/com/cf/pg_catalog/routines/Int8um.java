...
public class Int8um extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1287168064;

    /**
     * The parameter <code>pg_catalog.int8um.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.int8um._1</code>.
     */
     ...
     */
    public Int8um() {
        super("int8um", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
