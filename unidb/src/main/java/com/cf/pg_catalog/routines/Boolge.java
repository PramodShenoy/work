...
public class Boolge extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1399933194;
     ...
     */
    public Boolge() {
        super("boolge", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
