...
public class Int8AccumInv extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -748176912;

    /**
     * The parameter <code>pg_catalog.int8_accum_inv.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.int8_accum_inv._1</code>.
     */
     ...
     */
    public Int8AccumInv() {
        super("int8_accum_inv", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
