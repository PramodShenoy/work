...
public class TstzrangeSubdiff extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 640264734;
    ...
    public TstzrangeSubdiff() {
        super("tstzrange_subdiff", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
