...
public class GtsqueryCompress extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -1816458230;

    /**
     * The parameter <code>pg_catalog.gtsquery_compress.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.gtsquery_compress._1</code>.
     */
     ...
     */
    public GtsqueryCompress() {
        super("gtsquery_compress", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("internal"));
