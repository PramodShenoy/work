...
public class JsonRecv extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -54718786;

    /**
     * The parameter <code>pg_catalog.json_recv.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.json_recv._1</code>.
     */
     ...
     */
    public JsonRecv() {
        super("json_recv", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.OTHER);
