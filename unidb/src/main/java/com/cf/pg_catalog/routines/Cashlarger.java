...
public class Cashlarger extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 560028079;

    /**
     * The parameter <code>pg_catalog.cashlarger.RETURN_VALUE</code>.
     */
     ...
     */
    public Cashlarger() {
        super("cashlarger", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
