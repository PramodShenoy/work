...
public class Nextval extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -1572231244;

    /**
     * The parameter <code>pg_catalog.nextval.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.nextval._1</code>.
     */
     ...
     */
    public Nextval() {
        super("nextval", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
