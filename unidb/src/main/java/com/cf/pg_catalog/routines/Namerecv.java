...
public class Namerecv extends AbstractRoutine<String> {

    private static final long serialVersionUID = -73706628;

    /**
     * The parameter <code>pg_catalog.namerecv.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.namerecv._1</code>.
     */
     ...
     */
    public Namerecv() {
        super("namerecv", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.VARCHAR);
