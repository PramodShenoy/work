...
public class Int48le extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -91363539;
     ...
     */
    public Int48le() {
        super("int48le", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
