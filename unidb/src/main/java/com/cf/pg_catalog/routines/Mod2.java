...
public class Mod2 extends AbstractRoutine<Short> {

    private static final long serialVersionUID = 1981216309;
     ...
     */
    public Mod2() {
        super("mod", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.SMALLINT);
