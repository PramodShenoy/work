...
public class TimestampNeDate extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1836465580;

    /**
     * The parameter <code>pg_catalog.timestamp_ne_date.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.timestamp_ne_date._1</code>.
     */
    public static final Parameter<Timestamp> _1 = createParameter("_1", org.jooq.impl.SQLDataType.TIMESTAMP, false, true);

    /**
     * The parameter <code>pg_catalog.timestamp_ne_date._2</code>.
     */
     ...
     */
    public TimestampNeDate() {
        super("timestamp_ne_date", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
