...
public class Tidlt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1922409340;
     ...
     */
    public Tidlt() {
        super("tidlt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
