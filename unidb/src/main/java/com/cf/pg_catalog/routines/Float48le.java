...
public class Float48le extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 997825390;

    /**
     * The parameter <code>pg_catalog.float48le.RETURN_VALUE</code>.
     */
     ...
     */
    public Float48le() {
        super("float48le", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
