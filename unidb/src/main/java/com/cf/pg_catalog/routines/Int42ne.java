...
public class Int42ne extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1499296530;

    /**
     * The parameter <code>pg_catalog.int42ne.RETURN_VALUE</code>.
     */
     ...
     */
    public Int42ne() {
        super("int42ne", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
