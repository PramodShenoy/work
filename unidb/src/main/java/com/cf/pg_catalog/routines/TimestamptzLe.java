...
public class TimestamptzLe extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1859301834;

    /**
     * The parameter <code>pg_catalog.timestamptz_le.RETURN_VALUE</code>.
     */
     ...
     */
    public TimestamptzLe() {
        super("timestamptz_le", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
