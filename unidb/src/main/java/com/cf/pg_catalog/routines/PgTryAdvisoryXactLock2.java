...
public class PgTryAdvisoryXactLock2 extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -481067023;

    /**
     * The parameter <code>pg_catalog.pg_try_advisory_xact_lock.RETURN_VALUE</code>.
     */
     ...
     */
    public PgTryAdvisoryXactLock2() {
        super("pg_try_advisory_xact_lock", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
