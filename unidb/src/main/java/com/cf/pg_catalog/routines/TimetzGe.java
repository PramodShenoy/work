...
public class TimetzGe extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -917025965;

    /**
     * The parameter <code>pg_catalog.timetz_ge.RETURN_VALUE</code>.
     */
     ...
     */
    public TimetzGe() {
        super("timetz_ge", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
