...
public class PgFilenodeRelation extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 1456160108;

    /**
     * The parameter <code>pg_catalog.pg_filenode_relation.RETURN_VALUE</code>.
     */
    ...
    public PgFilenodeRelation() {
        super("pg_filenode_relation", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("regclass"));
