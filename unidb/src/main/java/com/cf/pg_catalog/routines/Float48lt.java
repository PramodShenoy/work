...
public class Float48lt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -162986798;

    /**
     * The parameter <code>pg_catalog.float48lt.RETURN_VALUE</code>.
     */
     ...
     */
    public Float48lt() {
        super("float48lt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
