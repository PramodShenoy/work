...
public class Int8Avg extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 259464012;
     ...
     */
    public Int8Avg() {
        super("int8_avg", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
