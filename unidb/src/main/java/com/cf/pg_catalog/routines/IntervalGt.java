...
public class IntervalGt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -867280706;
     ...
     */
    public IntervalGt() {
        super("interval_gt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
