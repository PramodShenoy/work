...
public class PgStatGetTuplesDeleted extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -831901100;
    ...
    public PgStatGetTuplesDeleted() {
        super("pg_stat_get_tuples_deleted", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
