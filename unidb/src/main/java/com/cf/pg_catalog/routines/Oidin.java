...
public class Oidin extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1432677377;

    /**
     * The parameter <code>pg_catalog.oidin.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.oidin._1</code>.
     */
     ...
     */
    public Oidin() {
        super("oidin", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
