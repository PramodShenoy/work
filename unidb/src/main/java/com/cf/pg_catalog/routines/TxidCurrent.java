...
public class TxidCurrent extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 88143431;
     ...
     */
    public TxidCurrent() {
        super("txid_current", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
