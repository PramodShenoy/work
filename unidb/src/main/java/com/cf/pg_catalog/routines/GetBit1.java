...
public class GetBit1 extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 345132232;
     ...
     */
    public GetBit1() {
        super("get_bit", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
