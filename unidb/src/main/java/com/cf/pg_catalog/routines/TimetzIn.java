...
public class TimetzIn extends AbstractRoutine<Time> {

    private static final long serialVersionUID = -1924645575;
    ...
    /**
     * The parameter <code>pg_catalog.timetz_in._1</code>.
     */
     ...
     */
    public TimetzIn() {
        super("timetz_in", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIME);
