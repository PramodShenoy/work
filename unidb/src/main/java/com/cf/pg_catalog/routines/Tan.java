...
public class Tan extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 61402809;

    /**
     * The parameter <code>pg_catalog.tan.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.tan._1</code>.
     */
     ...
     */
    public Tan() {
        super("tan", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
