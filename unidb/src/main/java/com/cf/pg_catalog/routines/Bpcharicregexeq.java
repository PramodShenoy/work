...
public class Bpcharicregexeq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1487465574;

    /**
     * The parameter <code>pg_catalog.bpcharicregexeq.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.bpcharicregexeq._1</code>.
     */
    public static final Parameter<String> _1 = createParameter("_1", org.jooq.impl.SQLDataType.CHAR, false, true);

    /**
     * The parameter <code>pg_catalog.bpcharicregexeq._2</code>.
     */
     ...
     */
    public Bpcharicregexeq() {
        super("bpcharicregexeq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
