...
public class SpgTextChoose extends AbstractRoutine<Void> {

    private static final long serialVersionUID = -592550893;

    /**
     * The parameter <code>pg_catalog.spg_text_choose._1</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.spg_text_choose._2</code>.
     */
     ...
     */
    public SpgTextChoose() {
        super("spg_text_choose", PgCatalog.PG_CATALOG);
