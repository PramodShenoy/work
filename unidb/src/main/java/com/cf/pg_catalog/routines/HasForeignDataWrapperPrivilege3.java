...
public class HasForeignDataWrapperPrivilege3 extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1537913834;

    /**
     * The parameter <code>pg_catalog.has_foreign_data_wrapper_privilege.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.has_foreign_data_wrapper_privilege._1</code>.
     */
    public static final Parameter<Long> _1 = createParameter("_1", org.jooq.impl.SQLDataType.BIGINT, false, true);

    /**
     * The parameter <code>pg_catalog.has_foreign_data_wrapper_privilege._2</code>.
     */
    public static final Parameter<String> _2 = createParameter("_2", org.jooq.impl.SQLDataType.CLOB, false, true);

    /**
     * The parameter <code>pg_catalog.has_foreign_data_wrapper_privilege._3</code>.
     */
     ...
     */
    public HasForeignDataWrapperPrivilege3() {
        super("has_foreign_data_wrapper_privilege", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
