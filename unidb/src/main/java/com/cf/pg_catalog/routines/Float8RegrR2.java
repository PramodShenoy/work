...
public class Float8RegrR2 extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1328820717;
     ...
     */
    public Float8RegrR2() {
        super("float8_regr_r2", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
