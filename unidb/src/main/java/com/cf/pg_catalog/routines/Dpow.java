...
public class Dpow extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 964957548;

    /**
     * The parameter <code>pg_catalog.dpow.RETURN_VALUE</code>.
     */
     ...
     */
    public Dpow() {
        super("dpow", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
