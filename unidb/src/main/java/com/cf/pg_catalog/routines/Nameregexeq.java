...
public class Nameregexeq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -76603709;

    /**
     * The parameter <code>pg_catalog.nameregexeq.RETURN_VALUE</code>.
     */
     ...
     */
    public Nameregexeq() {
        super("nameregexeq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
