...
public class Oidvectoreq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 57694670;
     ...
     */
    public Oidvectoreq() {
        super("oidvectoreq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
