...
public class TextPatternGt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1895124750;

    /**
     * The parameter <code>pg_catalog.text_pattern_gt.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.text_pattern_gt._1</code>.
     */
    public static final Parameter<String> _1 = createParameter("_1", org.jooq.impl.SQLDataType.CLOB, false, true);

    /**
     * The parameter <code>pg_catalog.text_pattern_gt._2</code>.
     */
     ...
     */
    public TextPatternGt() {
        super("text_pattern_gt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
