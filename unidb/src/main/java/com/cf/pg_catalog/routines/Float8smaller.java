...
public class Float8smaller extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 760120120;
     ...
     */
    public Float8smaller() {
        super("float8smaller", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
