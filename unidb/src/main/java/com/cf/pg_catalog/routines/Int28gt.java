...
public class Int28gt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1076679095;

    /**
     * The parameter <code>pg_catalog.int28gt.RETURN_VALUE</code>.
     */
     ...
     */
    public Int28gt() {
        super("int28gt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
