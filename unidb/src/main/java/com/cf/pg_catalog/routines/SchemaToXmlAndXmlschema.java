...
public class SchemaToXmlAndXmlschema extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -1192480619;

    /**
     * The parameter <code>pg_catalog.schema_to_xml_and_xmlschema.RETURN_VALUE</code>.
     */
    ...
    public SchemaToXmlAndXmlschema() {
        super("schema_to_xml_and_xmlschema", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("xml"));
