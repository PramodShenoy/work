...
public class Int84mi extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -697295917;
     ...
     */
    public Int84mi() {
        super("int84mi", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
