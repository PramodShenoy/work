...
public class DateMii extends AbstractRoutine<Date> {

    private static final long serialVersionUID = 397662746;
     ...
     */
    public DateMii() {
        super("date_mii", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DATE);
