...
public class Int2shr extends AbstractRoutine<Short> {

    private static final long serialVersionUID = -270557050;
     ...
     */
    public Int2shr() {
        super("int2shr", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.SMALLINT);
