...
public class UpperInf extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1125450753;

    /**
     * The parameter <code>pg_catalog.upper_inf.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.upper_inf._1</code>.
     */
     ...
     */
    public UpperInf() {
        super("upper_inf", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
