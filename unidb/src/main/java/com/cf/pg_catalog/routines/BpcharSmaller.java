...
public class BpcharSmaller extends AbstractRoutine<String> {

    private static final long serialVersionUID = -823983426;
     ...
     */
    public BpcharSmaller() {
        super("bpchar_smaller", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CHAR);
