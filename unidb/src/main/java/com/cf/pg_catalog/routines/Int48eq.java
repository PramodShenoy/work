...
public class Int48eq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1938547309;

    /**
     * The parameter <code>pg_catalog.int48eq.RETURN_VALUE</code>.
     */
     ...
     */
    public Int48eq() {
        super("int48eq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
