...
public class TimestampLarger extends AbstractRoutine<Timestamp> {

    private static final long serialVersionUID = 2040273850;
    ...
    public TimestampLarger() {
        super("timestamp_larger", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIMESTAMP);
