...
public class TimestamptzLtDate extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -829085762;

    /**
     * The parameter <code>pg_catalog.timestamptz_lt_date.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.timestamptz_lt_date._1</code>.
     */
    public static final Parameter<Timestamp> _1 = createParameter("_1", org.jooq.impl.SQLDataType.TIMESTAMP, false, true);

    /**
     * The parameter <code>pg_catalog.timestamptz_lt_date._2</code>.
     */
     ...
     */
    public TimestamptzLtDate() {
        super("timestamptz_lt_date", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
