...
public class Float4mi extends AbstractRoutine<Float> {
     ...
     */
    public Float4mi() {
        super("float4mi", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.REAL);
