...
public class BpcharPatternLt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 399290;
     ...
     */
    public BpcharPatternLt() {
        super("bpchar_pattern_lt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
