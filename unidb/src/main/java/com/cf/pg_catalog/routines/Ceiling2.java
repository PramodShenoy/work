...
public class Ceiling2 extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 2015553622;
     ...
     */
    public Ceiling2() {
        super("ceiling", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
