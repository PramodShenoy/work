...
public class Oidlt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 434727738;

    /**
     * The parameter <code>pg_catalog.oidlt.RETURN_VALUE</code>.
     */
     ...
     */
    public Oidlt() {
        super("oidlt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
