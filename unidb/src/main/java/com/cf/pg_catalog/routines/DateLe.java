...
public class DateLe extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1194240038;

    /**
     * The parameter <code>pg_catalog.date_le.RETURN_VALUE</code>.
     */
     ...
     */
    public DateLe() {
        super("date_le", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
