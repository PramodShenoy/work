...
public class JsonbDeletePath extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 1050720133;
    ...
    public JsonbDeletePath() {
        super("jsonb_delete_path", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("jsonb"));
