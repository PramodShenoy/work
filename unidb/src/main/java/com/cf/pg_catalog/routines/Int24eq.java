...
public class Int24eq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1862809544;

    /**
     * The parameter <code>pg_catalog.int24eq.RETURN_VALUE</code>.
     */
     ...
     */
    public Int24eq() {
        super("int24eq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
