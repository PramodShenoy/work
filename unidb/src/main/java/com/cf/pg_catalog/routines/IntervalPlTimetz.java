...
public class IntervalPlTimetz extends AbstractRoutine<Time> {

    private static final long serialVersionUID = 1004225520;
    ...
    public IntervalPlTimetz() {
        super("interval_pl_timetz", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIME);
