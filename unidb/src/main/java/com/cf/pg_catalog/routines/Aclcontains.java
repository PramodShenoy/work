...
public class Aclcontains extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1499321358;

    /**
     * The parameter <code>pg_catalog.aclcontains.RETURN_VALUE</code>.
     */
     ...
     */
    public Aclcontains() {
        super("aclcontains", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
