...
public class Isempty extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -349048682;

    /**
     * The parameter <code>pg_catalog.isempty.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.isempty._1</code>.
     */
     ...
     */
    public Isempty() {
        super("isempty", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
