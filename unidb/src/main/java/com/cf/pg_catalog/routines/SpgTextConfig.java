...
public class SpgTextConfig extends AbstractRoutine<Void> {

    private static final long serialVersionUID = -1667656066;

    /**
     * The parameter <code>pg_catalog.spg_text_config._1</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.spg_text_config._2</code>.
     */
     ...
     */
    public SpgTextConfig() {
        super("spg_text_config", PgCatalog.PG_CATALOG);
