...
public class NumericAbs extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 784351697;

    /**
     * The parameter <code>pg_catalog.numeric_abs.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.numeric_abs._1</code>.
     */
     ...
     */
    public NumericAbs() {
        super("numeric_abs", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
