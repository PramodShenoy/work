...
public class CashRecv extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1270791486;

    /**
     * The parameter <code>pg_catalog.cash_recv.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.cash_recv._1</code>.
     */
     ...
     */
    public CashRecv() {
        super("cash_recv", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
