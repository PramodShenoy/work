...
public class InetIn extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1720914860;

    /**
     * The parameter <code>pg_catalog.inet_in.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.inet_in._1</code>.
     */
     ...
     */
    public InetIn() {
        super("inet_in", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("inet"));
