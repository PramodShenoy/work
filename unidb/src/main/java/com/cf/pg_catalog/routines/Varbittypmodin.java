...
public class Varbittypmodin extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -134325540;
     ...
     */
    public Varbittypmodin() {
        super("varbittypmodin", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
