...
public class Bytealt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1775744152;

    /**
     * The parameter <code>pg_catalog.bytealt.RETURN_VALUE</code>.
     */
     ...
     */
    public Bytealt() {
        super("bytealt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
