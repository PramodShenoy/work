...
public class Acos extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1285147746;

    /**
     * The parameter <code>pg_catalog.acos.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.acos._1</code>.
     */
     ...
     */
    public Acos() {
        super("acos", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
