...
public class RangeOut extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -295916189;

    /**
     * The parameter <code>pg_catalog.range_out.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.range_out._1</code>.
     */
     ...
     */
    public RangeOut() {
        super("range_out", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("cstring"));
