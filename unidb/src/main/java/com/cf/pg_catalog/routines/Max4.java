...
public class Max4 extends AbstractRoutine<Short> {

    private static final long serialVersionUID = -1655374631;
     ...
     */
    public Max4() {
        super("max", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.SMALLINT);
