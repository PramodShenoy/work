...
public class RecordOut extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -29437150;

    /**
     * The parameter <code>pg_catalog.record_out.RETURN_VALUE</code>.
     */
     ...
     */
    public RecordOut() {
        super("record_out", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("cstring"));
