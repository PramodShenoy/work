...
public class MulDInterval extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1211885307;
     ...
     */
    public MulDInterval() {
        super("mul_d_interval", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("interval"));
