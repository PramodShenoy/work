...
public class Hostmask extends AbstractRoutine<Object> {

    private static final long serialVersionUID = 546144090;

    /**
     * The parameter <code>pg_catalog.hostmask.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.hostmask._1</code>.
     */
     ...
     */
    public Hostmask() {
        super("hostmask", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("inet"));
