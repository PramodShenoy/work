...
public class AnyIn extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1524119884;

    /**
     * The parameter <code>pg_catalog.any_in.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.any_in._1</code>.
     */
     ...
     */
    public AnyIn() {
        super("any_in", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.OTHER);
