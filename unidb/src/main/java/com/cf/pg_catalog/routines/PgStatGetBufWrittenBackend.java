...
public class PgStatGetBufWrittenBackend extends AbstractRoutine<Long> {
    ...
    private static final long serialVersionUID = -129106587;

    /**
     * The parameter <code>pg_catalog.pg_stat_get_buf_written_backend.RETURN_VALUE</code>.
     */
    ...
    public PgStatGetBufWrittenBackend() {
        super("pg_stat_get_buf_written_backend", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
