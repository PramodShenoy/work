...
public class Float48ne extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -2082211402;
     ...
     */
    public Float48ne() {
        super("float48ne", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
