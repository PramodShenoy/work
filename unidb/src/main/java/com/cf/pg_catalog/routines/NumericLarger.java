...
public class NumericLarger extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -624984781;
    ...
    public NumericLarger() {
        super("numeric_larger", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
