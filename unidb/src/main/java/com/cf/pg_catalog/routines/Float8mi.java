...
public class Float8mi extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1560627300;
     ...
     */
    public Float8mi() {
        super("float8mi", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
