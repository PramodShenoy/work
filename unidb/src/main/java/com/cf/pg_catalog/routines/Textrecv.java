...
public class Textrecv extends AbstractRoutine<String> {

    private static final long serialVersionUID = -1562540726;

    /**
     * The parameter <code>pg_catalog.textrecv.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.textrecv._1</code>.
     */
     ...
     */
    public Textrecv() {
        super("textrecv", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
