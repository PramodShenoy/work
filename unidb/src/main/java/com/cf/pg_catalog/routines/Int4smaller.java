...
public class Int4smaller extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -2007464002;
     ...
     */
    public Int4smaller() {
        super("int4smaller", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
