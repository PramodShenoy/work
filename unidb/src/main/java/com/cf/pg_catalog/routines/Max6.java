...
public class Max6 extends AbstractRoutine<Float> {

    private static final long serialVersionUID = -1578480241;
     ...
     */
    public Max6() {
        super("max", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.REAL);
