...
public class PgStartBackup extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = 629384699;

    /**
     * The parameter <code>pg_catalog.pg_start_backup.RETURN_VALUE</code>.
     */
     ...
     */
    public static final Parameter<Boolean> FAST = createParameter("fast", org.jooq.impl.SQLDataType.BOOLEAN, false, false);

    /**
     * Create a new routine call instance
     */
    public PgStartBackup() {
        super("pg_start_backup", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("pg_lsn"));
