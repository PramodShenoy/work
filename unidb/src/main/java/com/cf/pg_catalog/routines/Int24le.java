...
public class Int24le extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 102706740;

    /**
     * The parameter <code>pg_catalog.int24le.RETURN_VALUE</code>.
     */
     ...
     */
    public Int24le() {
        super("int24le", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
