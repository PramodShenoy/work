...
public class Spgoptions extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = 488639801;

    /**
     * The parameter <code>pg_catalog.spgoptions.RETURN_VALUE</code>.
     */
    public static final Parameter<byte[]> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.BLOB, false, false);

    /**
     * The parameter <code>pg_catalog.spgoptions._1</code>.
     */
    public static final Parameter<String[]> _1 = createParameter("_1", org.jooq.impl.SQLDataType.CLOB.getArrayDataType(), false, true);

    /**
     * The parameter <code>pg_catalog.spgoptions._2</code>.
     */
     ...
     */
    public Spgoptions() {
        super("spgoptions", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
