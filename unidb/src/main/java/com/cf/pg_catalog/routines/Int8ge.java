...
public class Int8ge extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 422021782;

    /**
     * The parameter <code>pg_catalog.int8ge.RETURN_VALUE</code>.
     */
     ...
     */
    public Int8ge() {
        super("int8ge", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
