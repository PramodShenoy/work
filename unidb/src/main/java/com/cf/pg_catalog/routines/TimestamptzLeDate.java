...
public class TimestamptzLeDate extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1808360028;

    /**
     * The parameter <code>pg_catalog.timestamptz_le_date.RETURN_VALUE</code>.
     */
     ...
     */
    public TimestamptzLeDate() {
        super("timestamptz_le_date", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
