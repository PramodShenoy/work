...
public class Int2ge extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 488621606;

    /**
     * The parameter <code>pg_catalog.int2ge.RETURN_VALUE</code>.
     */
     ...
     */
    public Int2ge() {
        super("int2ge", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
