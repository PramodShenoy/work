...
public class Xidout extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1949716056;

    /**
     * The parameter <code>pg_catalog.xidout.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.xidout._1</code>.
     */
     ...
     */
    public Xidout() {
        super("xidout", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("cstring"));
