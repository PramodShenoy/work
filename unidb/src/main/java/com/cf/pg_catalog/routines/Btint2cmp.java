...
public class Btint2cmp extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -1961910654;
     ...
     */
    public Btint2cmp() {
        super("btint2cmp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
