...
public class Int4larger extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1642550114;

    /**
     * The parameter <code>pg_catalog.int4larger.RETURN_VALUE</code>.
     */
    public static final Parameter<Integer> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>pg_catalog.int4larger._1</code>.
     */
    public static final Parameter<Integer> _1 = createParameter("_1", org.jooq.impl.SQLDataType.INTEGER, false, true);

    /**
     * The parameter <code>pg_catalog.int4larger._2</code>.
     */
     ...
     */
    public Int4larger() {
        super("int4larger", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
