...
public class Float8CovarSamp extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -2058064691;

    /**
     * The parameter <code>pg_catalog.float8_covar_samp.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.float8_covar_samp._1</code>.
     */
     ...
     */
    public Float8CovarSamp() {
        super("float8_covar_samp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
