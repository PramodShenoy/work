...
public class LoCreat extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 588448591;

    /**
     * The parameter <code>pg_catalog.lo_creat.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.lo_creat._1</code>.
     */
     ...
     */
    public LoCreat() {
        super("lo_creat", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
