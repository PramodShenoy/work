...
public class PercentileContIntervalMultiFinal extends AbstractRoutine<Object[]> {

    private static final long serialVersionUID = 126159920;

    /**
     * The parameter <code>pg_catalog.percentile_cont_interval_multi_final.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.percentile_cont_interval_multi_final._1</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.percentile_cont_interval_multi_final._2</code>.
     */
    ...
    public PercentileContIntervalMultiFinal() {
        super("percentile_cont_interval_multi_final", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("interval").getArrayDataType());
