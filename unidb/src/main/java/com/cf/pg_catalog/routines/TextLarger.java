...
public class TextLarger extends AbstractRoutine<String> {

    private static final long serialVersionUID = -1346089506;

    /**
     * The parameter <code>pg_catalog.text_larger.RETURN_VALUE</code>.
     */
     ...
     */
    public TextLarger() {
        super("text_larger", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
