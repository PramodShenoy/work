...
public class Gistoptions extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = 663279819;

    /**
     * The parameter <code>pg_catalog.gistoptions.RETURN_VALUE</code>.
     */
    public static final Parameter<byte[]> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.BLOB, false, false);

    /**
     * The parameter <code>pg_catalog.gistoptions._1</code>.
     */
    public static final Parameter<String[]> _1 = createParameter("_1", org.jooq.impl.SQLDataType.CLOB.getArrayDataType(), false, true);

    /**
     * The parameter <code>pg_catalog.gistoptions._2</code>.
     */
     ...
     */
    public Gistoptions() {
        super("gistoptions", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
