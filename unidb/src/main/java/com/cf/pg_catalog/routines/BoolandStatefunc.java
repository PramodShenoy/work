...
public class BoolandStatefunc extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 2139398868;
     ...
     */
    public BoolandStatefunc() {
        super("booland_statefunc", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
