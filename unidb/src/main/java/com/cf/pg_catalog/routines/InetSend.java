...
public class InetSend extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = -444751921;

    /**
     * The parameter <code>pg_catalog.inet_send.RETURN_VALUE</code>.
     */
    public static final Parameter<byte[]> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.BLOB, false, false);

    /**
     * The parameter <code>pg_catalog.inet_send._1</code>.
     */
     ...
     */
    public InetSend() {
        super("inet_send", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
