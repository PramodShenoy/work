...
public class BitAnd3 extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 429098033;
     ...
     */
    public BitAnd3() {
        super("bit_and", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
