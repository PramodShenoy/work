...
public class HasTypePrivilege3 extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1892826393;

    /**
     * The parameter <code>pg_catalog.has_type_privilege.RETURN_VALUE</code>.
     */
     ...
     */
    public HasTypePrivilege3() {
        super("has_type_privilege", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
