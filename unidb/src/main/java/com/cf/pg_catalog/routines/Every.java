...
public class Every extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1805870483;
     ...
     */
    public Every() {
        super("every", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
