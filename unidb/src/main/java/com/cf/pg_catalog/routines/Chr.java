...
public class Chr extends AbstractRoutine<String> {

    private static final long serialVersionUID = 212026647;

    /**
     * The parameter <code>pg_catalog.chr.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.chr._1</code>.
     */
     ...
     */
    public Chr() {
        super("chr", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
