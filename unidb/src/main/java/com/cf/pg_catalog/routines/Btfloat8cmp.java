...
public class Btfloat8cmp extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1210343974;

    /**
     * The parameter <code>pg_catalog.btfloat8cmp.RETURN_VALUE</code>.
     */
    public static final Parameter<Integer> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>pg_catalog.btfloat8cmp._1</code>.
     */
    public static final Parameter<Double> _1 = createParameter("_1", org.jooq.impl.SQLDataType.DOUBLE, false, true);

    /**
     * The parameter <code>pg_catalog.btfloat8cmp._2</code>.
     */
     ...
     */
    public Btfloat8cmp() {
        super("btfloat8cmp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
