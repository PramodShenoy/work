...
public class Ceil2 extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1892020060;
     ...
     */
    public Ceil2() {
        super("ceil", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
