...
public class CashGt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 419544927;

    /**
     * The parameter <code>pg_catalog.cash_gt.RETURN_VALUE</code>.
     */
     ...
     */
    public CashGt() {
        super("cash_gt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
