...
public class Texticnlike extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1407693906;

    /**
     * The parameter <code>pg_catalog.texticnlike.RETURN_VALUE</code>.
     */
     ...
     */
    public Texticnlike() {
        super("texticnlike", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
