...
public class NumericSmaller extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 1568835475;
     ...
     */
    public NumericSmaller() {
        super("numeric_smaller", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
