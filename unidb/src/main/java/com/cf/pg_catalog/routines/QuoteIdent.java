...
public class QuoteIdent extends AbstractRoutine<String> {

    private static final long serialVersionUID = 1329743880;
     ...
     */
    public QuoteIdent() {
        super("quote_ident", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
