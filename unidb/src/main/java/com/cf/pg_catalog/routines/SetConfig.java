...
public class SetConfig extends AbstractRoutine<String> {

    private static final long serialVersionUID = -76749687;

    /**
     * The parameter <code>pg_catalog.set_config.RETURN_VALUE</code>.
     */
     ...
     */
    public SetConfig() {
        super("set_config", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
