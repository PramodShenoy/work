...
public class Boolin extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1055861437;

    /**
     * The parameter <code>pg_catalog.boolin.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.boolin._1</code>.
     */
     ...
     */
    public Boolin() {
        super("boolin", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
