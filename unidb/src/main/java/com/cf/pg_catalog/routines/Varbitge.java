...
public class Varbitge extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1719595190;

    /**
     * The parameter <code>pg_catalog.varbitge.RETURN_VALUE</code>.
     */
     ...
     */
    public Varbitge() {
        super("varbitge", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
