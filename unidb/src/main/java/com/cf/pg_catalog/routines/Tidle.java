...
public class Tidle extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1542002266;
     ...
     */
    public Tidle() {
        super("tidle", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
