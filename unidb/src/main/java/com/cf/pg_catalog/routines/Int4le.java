...
public class Int4le extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -2074550514;

    /**
     * The parameter <code>pg_catalog.int4le.RETURN_VALUE</code>.
     */
     ...
     */
    public Int4le() {
        super("int4le", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
