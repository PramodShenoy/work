...
public class Byteage extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 2127264068;

    /**
     * The parameter <code>pg_catalog.byteage.RETURN_VALUE</code>.
     */
     ...
     */
    public Byteage() {
        super("byteage", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
