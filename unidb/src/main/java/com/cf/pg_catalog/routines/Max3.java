...
public class Max3 extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 1574548589;
     ...
     */
    public Max3() {
        super("max", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
