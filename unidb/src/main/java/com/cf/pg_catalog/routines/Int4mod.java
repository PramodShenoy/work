...
public class Int4mod extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = -1835856166;

    /**
     * The parameter <code>pg_catalog.int4mod.RETURN_VALUE</code>.
     */
    public static final Parameter<Integer> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>pg_catalog.int4mod._1</code>.
     */
    public static final Parameter<Integer> _1 = createParameter("_1", org.jooq.impl.SQLDataType.INTEGER, false, true);

    /**
     * The parameter <code>pg_catalog.int4mod._2</code>.
     */
     ...
     */
    public Int4mod() {
        super("int4mod", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
