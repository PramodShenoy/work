...
public class PgGetFunctionArgDefault extends AbstractRoutine<String> {

    private static final long serialVersionUID = -2047258845;

    /**
     * The parameter <code>pg_catalog.pg_get_function_arg_default.RETURN_VALUE</code>.
     */
     ...
     */
    public PgGetFunctionArgDefault() {
        super("pg_get_function_arg_default", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
