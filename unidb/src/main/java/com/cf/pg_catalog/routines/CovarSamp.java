...
public class CovarSamp extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -148217572;
     ...
     */
    public CovarSamp() {
        super("covar_samp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
