...
public class Max7 extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1635525117;
     ...
     */
    public Max7() {
        super("max", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
