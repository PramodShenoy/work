...
public class CashDivFlt4 extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 517683683;

    /**
     * The parameter <code>pg_catalog.cash_div_flt4.RETURN_VALUE</code>.
     */
     ...
     */
    public CashDivFlt4() {
        super("cash_div_flt4", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
