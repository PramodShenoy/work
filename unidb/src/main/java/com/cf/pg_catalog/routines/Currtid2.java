...
public class Currtid2 extends AbstractRoutine<Long> {

    private static final long serialVersionUID = -45064802;

    /**
     * The parameter <code>pg_catalog.currtid2.RETURN_VALUE</code>.
     */
     ...
     */
    public Currtid2() {
        super("currtid2", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
