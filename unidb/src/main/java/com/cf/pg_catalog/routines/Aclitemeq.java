...
public class Aclitemeq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 10916576;

    /**
     * The parameter <code>pg_catalog.aclitemeq.RETURN_VALUE</code>.
     */
     ...
     */
    public Aclitemeq() {
        super("aclitemeq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
