...
public class Radians extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 21356424;

    /**
     * The parameter <code>pg_catalog.radians.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.radians._1</code>.
     */
     ...
     */
    public Radians() {
        super("radians", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
