...
public class TimestampPlInterval extends AbstractRoutine<Timestamp> {

    private static final long serialVersionUID = -499625617;

    /**
     * The parameter <code>pg_catalog.timestamp_pl_interval.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.timestamp_pl_interval._1</code>.
     */
    public static final Parameter<Timestamp> _1 = createParameter("_1", org.jooq.impl.SQLDataType.TIMESTAMP, false, true);

    /**
     * The parameter <code>pg_catalog.timestamp_pl_interval._2</code>.
     */
     ...
     */
    public TimestampPlInterval() {
        super("timestamp_pl_interval", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIMESTAMP);
