...
public class Abstimeout extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -2121468334;

    /**
     * The parameter <code>pg_catalog.abstimeout.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.abstimeout._1</code>.
     */
     ...
     */
    public Abstimeout() {
        super("abstimeout", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("cstring"));
