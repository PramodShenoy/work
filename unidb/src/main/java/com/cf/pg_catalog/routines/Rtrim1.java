...
public class Rtrim1 extends AbstractRoutine<String> {

    private static final long serialVersionUID = 861969899;
    ...
    /**
     * The parameter <code>pg_catalog.rtrim._2</code>.
     */
     ...
     */
    public Rtrim1() {
        super("rtrim", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
