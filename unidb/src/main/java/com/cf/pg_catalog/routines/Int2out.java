...
public class Int2out extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -188973143;

    /**
     * The parameter <code>pg_catalog.int2out.RETURN_VALUE</code>.
     */
     ...
     */
    public Int2out() {
        super("int2out", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("cstring"));
