...
public class Gistgettuple extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1867334886;

    /**
     * The parameter <code>pg_catalog.gistgettuple.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.gistgettuple._1</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.gistgettuple._2</code>.
     */
     ...
     */
    public Gistgettuple() {
        super("gistgettuple", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
