...
public class Min17 extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1209084996;
     ...
     */
    public Min17() {
        super("min", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
