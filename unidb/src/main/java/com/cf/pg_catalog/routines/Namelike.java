...
public class Namelike extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 642371549;

    /**
     * The parameter <code>pg_catalog.namelike.RETURN_VALUE</code>.
     */
     ...
     */
    public Namelike() {
        super("namelike", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
