...
public class PgAdvisoryUnlock2 extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -997346525;

    /**
     * The parameter <code>pg_catalog.pg_advisory_unlock.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.pg_advisory_unlock._1</code>.
     */
    public static final Parameter<Integer> _1 = createParameter("_1", org.jooq.impl.SQLDataType.INTEGER, false, true);

    /**
     * The parameter <code>pg_catalog.pg_advisory_unlock._2</code>.
     */
     ...
     */
    public PgAdvisoryUnlock2() {
        super("pg_advisory_unlock", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
