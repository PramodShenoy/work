...
public class Float8in extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1167522303;

    /**
     * The parameter <code>pg_catalog.float8in.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.float8in._1</code>.
     */
     ...
     */
    public Float8in() {
        super("float8in", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
