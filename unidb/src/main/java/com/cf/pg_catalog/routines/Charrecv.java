...
public class Charrecv extends AbstractRoutine<String> {

    private static final long serialVersionUID = -166571471;

    /**
     * The parameter <code>pg_catalog.charrecv.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.charrecv._1</code>.
     */
     ...
     */
    public Charrecv() {
        super("charrecv", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CHAR);
