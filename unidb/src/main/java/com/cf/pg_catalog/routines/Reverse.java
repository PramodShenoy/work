...
public class Reverse extends AbstractRoutine<String> {
    ...
    private static final long serialVersionUID = 1910718051;

    /**
     * The parameter <code>pg_catalog.reverse.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.reverse._1</code>.
     */
     ...
     */
    public Reverse() {
        super("reverse", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
