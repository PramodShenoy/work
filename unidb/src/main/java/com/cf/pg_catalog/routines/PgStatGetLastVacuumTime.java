...
public class PgStatGetLastVacuumTime extends AbstractRoutine<Timestamp> {

    private static final long serialVersionUID = -651230949;

    /**
     * The parameter <code>pg_catalog.pg_stat_get_last_vacuum_time.RETURN_VALUE</code>.
     */
    ...
    public PgStatGetLastVacuumTime() {
        super("pg_stat_get_last_vacuum_time", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIMESTAMP);
