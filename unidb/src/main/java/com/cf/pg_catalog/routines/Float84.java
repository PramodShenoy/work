...
public class Float84 extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -1191661457;
     ...
     */
    public Float84() {
        super("float8", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
