...
public class Exp1 extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 413019828;
     ...
     */
    public Exp1() {
        super("exp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
