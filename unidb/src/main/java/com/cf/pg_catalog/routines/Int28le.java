...
public class Int28le extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 268657049;

    /**
     * The parameter <code>pg_catalog.int28le.RETURN_VALUE</code>.
     */
     ...
     */
    public Int28le() {
        super("int28le", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
