...
public class PgRelationIsUpdatable extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 713022828;

    /**
     * The parameter <code>pg_catalog.pg_relation_is_updatable.RETURN_VALUE</code>.
     */
    public static final Parameter<Integer> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>pg_catalog.pg_relation_is_updatable._1</code>.
     */
    ...
    public PgRelationIsUpdatable() {
        super("pg_relation_is_updatable", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
