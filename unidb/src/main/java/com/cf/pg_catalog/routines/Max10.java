...
public class Max10 extends AbstractRoutine<Time> {

    private static final long serialVersionUID = 2022609268;
     ...
     */
    public Max10() {
        super("max", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIME);
