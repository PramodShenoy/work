...
public class JsonbIn extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1594553146;

    /**
     * The parameter <code>pg_catalog.jsonb_in.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.jsonb_in._1</code>.
     */
     ...
     */
    public JsonbIn() {
        super("jsonb_in", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("jsonb"));
