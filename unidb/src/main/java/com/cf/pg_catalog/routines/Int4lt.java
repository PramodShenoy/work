...
public class Int4lt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1237778414;

    /**
     * The parameter <code>pg_catalog.int4lt.RETURN_VALUE</code>.
     */
     ...
     */
    public Int4lt() {
        super("int4lt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
