...
public class Int8xor extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 466679294;

    /**
     * The parameter <code>pg_catalog.int8xor.RETURN_VALUE</code>.
     */
     ...
     */
    public Int8xor() {
        super("int8xor", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
