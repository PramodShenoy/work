...
public class Float8gt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 798885040;

    /**
     * The parameter <code>pg_catalog.float8gt.RETURN_VALUE</code>.
     */
     ...
     */
    public Float8gt() {
        super("float8gt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
