...
public class TableToXml extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -74854095;
    ...
    /**
     * The parameter <code>pg_catalog.table_to_xml.tbl</code>.
     */
     ...
     */
    public TableToXml() {
        super("table_to_xml", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("xml"));
