...
public class Replace extends AbstractRoutine<String> {

    private static final long serialVersionUID = 1103169613;
     ...
     */
    public Replace() {
        super("replace", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
