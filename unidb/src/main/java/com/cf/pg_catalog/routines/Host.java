...
public class Host extends AbstractRoutine<String> {

    private static final long serialVersionUID = -1968976640;

    /**
     * The parameter <code>pg_catalog.host.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.host._1</code>.
     */
     ...
     */
    public Host() {
        super("host", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
