...
public class Int4send extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = 1999253833;

    /**
     * The parameter <code>pg_catalog.int4send.RETURN_VALUE</code>.
     */
    public static final Parameter<byte[]> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.BLOB, false, false);

    /**
     * The parameter <code>pg_catalog.int4send._1</code>.
     */
     ...
     */
    public Int4send() {
        super("int4send", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
