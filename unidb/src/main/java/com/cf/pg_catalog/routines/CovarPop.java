...
public class CovarPop extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -480190114;
     ...
     */
    public CovarPop() {
        super("covar_pop", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
