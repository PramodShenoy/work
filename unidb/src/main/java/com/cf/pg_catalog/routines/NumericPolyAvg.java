...
public class NumericPolyAvg extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 656584071;
    ...
    /**
     * The parameter <code>pg_catalog.numeric_poly_avg._1</code>.
     */
     ...
     */
    public NumericPolyAvg() {
        super("numeric_poly_avg", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
