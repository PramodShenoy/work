...
public class Bitshiftleft extends AbstractRoutine<String> {

    private static final long serialVersionUID = -2059187879;
     ...
     */
    public Bitshiftleft() {
        super("bitshiftleft", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CHAR);
