...
public class Namelt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1180356440;

    /**
     * The parameter <code>pg_catalog.namelt.RETURN_VALUE</code>.
     */
     ...
     */
    public Namelt() {
        super("namelt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
