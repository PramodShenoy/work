...
public class Int28ge extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -914038875;

    /**
     * The parameter <code>pg_catalog.int28ge.RETURN_VALUE</code>.
     */
     ...
     */
    public Int28ge() {
        super("int28ge", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
