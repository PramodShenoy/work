...
public class Xidsend extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = 498931638;
     ...
     */
    public Xidsend() {
        super("xidsend", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
