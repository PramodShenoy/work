...
public class Bpcharnlike extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1469595586;

    /**
     * The parameter <code>pg_catalog.bpcharnlike.RETURN_VALUE</code>.
     */
     ...
     */
    public Bpcharnlike() {
        super("bpcharnlike", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
