...
public class GinTriconsistentJsonbPath extends AbstractRoutine<String> {

    private static final long serialVersionUID = 262705392;

    /**
     * The parameter <code>pg_catalog.gin_triconsistent_jsonb_path.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.gin_triconsistent_jsonb_path._1</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.gin_triconsistent_jsonb_path._2</code>.
     */
    public static final Parameter<Short> _2 = createParameter("_2", org.jooq.impl.SQLDataType.SMALLINT, false, true);

    /**
     * The parameter <code>pg_catalog.gin_triconsistent_jsonb_path._3</code>.
     */
    public static final Parameter<Object> _3 = createParameter("_3", org.jooq.impl.DefaultDataType.getDefaultDataType("anyarray"), false, true);

    /**
     * The parameter <code>pg_catalog.gin_triconsistent_jsonb_path._4</code>.
     */
    public static final Parameter<Integer> _4 = createParameter("_4", org.jooq.impl.SQLDataType.INTEGER, false, true);

    /**
     * The parameter <code>pg_catalog.gin_triconsistent_jsonb_path._5</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.gin_triconsistent_jsonb_path._6</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.gin_triconsistent_jsonb_path._7</code>.
     */
     ...
     */
    public GinTriconsistentJsonbPath() {
        super("gin_triconsistent_jsonb_path", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CHAR);
