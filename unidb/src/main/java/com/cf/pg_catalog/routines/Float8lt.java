...
public class Float8lt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 2018205840;

    /**
     * The parameter <code>pg_catalog.float8lt.RETURN_VALUE</code>.
     */
     ...
     */
    public Float8lt() {
        super("float8lt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
