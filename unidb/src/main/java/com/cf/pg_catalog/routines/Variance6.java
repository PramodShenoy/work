...
public class Variance6 extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 2099841453;
     ...
     */
    public Variance6() {
        super("variance", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
