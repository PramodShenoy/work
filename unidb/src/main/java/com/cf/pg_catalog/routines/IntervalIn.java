...
public class IntervalIn extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -290100486;
    ...
    /**
     * The parameter <code>pg_catalog.interval_in._1</code>.
     */
     ...
     */
    public IntervalIn() {
        super("interval_in", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("interval"));
