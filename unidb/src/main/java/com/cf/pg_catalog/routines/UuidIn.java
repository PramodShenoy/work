...
public class UuidIn extends AbstractRoutine<UUID> {

    private static final long serialVersionUID = -1460115490;

    /**
     * The parameter <code>pg_catalog.uuid_in.RETURN_VALUE</code>.
     */
    public static final Parameter<UUID> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.UUID, false, false);

    /**
     * The parameter <code>pg_catalog.uuid_in._1</code>.
     */
     ...
     */
    public UuidIn() {
        super("uuid_in", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.UUID);
