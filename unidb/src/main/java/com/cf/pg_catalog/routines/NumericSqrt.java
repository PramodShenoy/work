...
public class NumericSqrt extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 1926563233;

    /**
     * The parameter <code>pg_catalog.numeric_sqrt.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.numeric_sqrt._1</code>.
     */
     ...
     */
    public NumericSqrt() {
        super("numeric_sqrt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
