...
public class Oidne extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 101779032;
     ...
     */
    public Oidne() {
        super("oidne", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
