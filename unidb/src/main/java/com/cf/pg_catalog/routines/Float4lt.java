...
public class Float4lt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -1042374236;

    /**
     * The parameter <code>pg_catalog.float4lt.RETURN_VALUE</code>.
     */
     ...
     */
    public Float4lt() {
        super("float4lt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
