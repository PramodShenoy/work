...
public class Stddev4 extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -438011511;
     ...
     */
    public Stddev4() {
        super("stddev", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
