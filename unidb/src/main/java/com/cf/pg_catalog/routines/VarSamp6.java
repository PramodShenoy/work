...
public class VarSamp6 extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = 2093381997;
     ...
     */
    public VarSamp6() {
        super("var_samp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
