...
public class Floor2 extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -494654165;
     ...
     */
    public Floor2() {
        super("floor", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
