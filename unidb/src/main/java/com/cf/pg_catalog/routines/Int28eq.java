...
public class Int28eq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1059750957;

    /**
     * The parameter <code>pg_catalog.int28eq.RETURN_VALUE</code>.
     */
     ...
     */
    public Int28eq() {
        super("int28eq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
