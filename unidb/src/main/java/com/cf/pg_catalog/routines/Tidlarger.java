...
public class Tidlarger extends AbstractRoutine<Long> {

    private static final long serialVersionUID = 1243807358;

    /**
     * The parameter <code>pg_catalog.tidlarger.RETURN_VALUE</code>.
     */
     ...
     */
    public Tidlarger() {
        super("tidlarger", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
