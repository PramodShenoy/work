...
public class Int4eq extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1333250158;

    /**
     * The parameter <code>pg_catalog.int4eq.RETURN_VALUE</code>.
     */
     ...
     */
    public Int4eq() {
        super("int4eq", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
