...
public class Max18 extends AbstractRoutine<String> {

    private static final long serialVersionUID = 2126014674;
     ...
     */
    public Max18() {
        super("max", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CHAR);
