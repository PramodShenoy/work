...
public class TimetzMiInterval extends AbstractRoutine<Time> {

    private static final long serialVersionUID = 2042955512;
    ...
    public TimetzMiInterval() {
        super("timetz_mi_interval", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIME);
