...
public class ToTimestamp2 extends AbstractRoutine<Timestamp> {

    private static final long serialVersionUID = -1031750519;
     ...
     */
    public ToTimestamp2() {
        super("to_timestamp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIMESTAMP);
