...
public class NumericCmp extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 415259011;
     ...
     */
    public NumericCmp() {
        super("numeric_cmp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
