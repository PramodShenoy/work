...
public class TimeMiInterval extends AbstractRoutine<Time> {

    private static final long serialVersionUID = -639277308;
    ...
    public TimeMiInterval() {
        super("time_mi_interval", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIME);
