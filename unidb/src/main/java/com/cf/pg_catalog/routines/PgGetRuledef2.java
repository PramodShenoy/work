...
public class PgGetRuledef2 extends AbstractRoutine<String> {

    private static final long serialVersionUID = 478878862;

    /**
     * The parameter <code>pg_catalog.pg_get_ruledef.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.pg_get_ruledef._1</code>.
     */
    public static final Parameter<Long> _1 = createParameter("_1", org.jooq.impl.SQLDataType.BIGINT, false, true);

    /**
     * The parameter <code>pg_catalog.pg_get_ruledef._2</code>.
     */
     ...
     */
    public PgGetRuledef2() {
        super("pg_get_ruledef", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
