...
public class TimestamptzGtTimestamp extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -252256828;

    /**
     * The parameter <code>pg_catalog.timestamptz_gt_timestamp.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.timestamptz_gt_timestamp._1</code>.
     */
    public static final Parameter<Timestamp> _1 = createParameter("_1", org.jooq.impl.SQLDataType.TIMESTAMP, false, true);

    /**
     * The parameter <code>pg_catalog.timestamptz_gt_timestamp._2</code>.
     */
     ...
     */
    public TimestamptzGtTimestamp() {
        super("timestamptz_gt_timestamp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
