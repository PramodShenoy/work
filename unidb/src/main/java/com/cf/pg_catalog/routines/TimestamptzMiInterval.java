...
public class TimestamptzMiInterval extends AbstractRoutine<Timestamp> {

    private static final long serialVersionUID = 935194299;
    ...
    public TimestamptzMiInterval() {
        super("timestamptz_mi_interval", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIMESTAMP);
