...
public class Int4and extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 180264964;

    /**
     * The parameter <code>pg_catalog.int4and.RETURN_VALUE</code>.
     */
    public static final Parameter<Integer> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>pg_catalog.int4and._1</code>.
     */
    public static final Parameter<Integer> _1 = createParameter("_1", org.jooq.impl.SQLDataType.INTEGER, false, true);

    /**
     * The parameter <code>pg_catalog.int4and._2</code>.
     */
     ...
     */
    public Int4and() {
        super("int4and", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
