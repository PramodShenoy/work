...
public class Overlay2 extends AbstractRoutine<String> {

    private static final long serialVersionUID = 1799850661;
     ...
     */
    public Overlay2() {
        super("overlay", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
