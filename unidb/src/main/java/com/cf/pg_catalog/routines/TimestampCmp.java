...
public class TimestampCmp extends AbstractRoutine<Integer> {

    private static final long serialVersionUID = 426814566;

    /**
     * The parameter <code>pg_catalog.timestamp_cmp.RETURN_VALUE</code>.
     */
    public static final Parameter<Integer> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.INTEGER, false, false);

    /**
     * The parameter <code>pg_catalog.timestamp_cmp._1</code>.
     */
    public static final Parameter<Timestamp> _1 = createParameter("_1", org.jooq.impl.SQLDataType.TIMESTAMP, false, true);

    /**
     * The parameter <code>pg_catalog.timestamp_cmp._2</code>.
     */
     ...
     */
    public TimestampCmp() {
        super("timestamp_cmp", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.INTEGER);
