...
public class Oidsend extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = 550573279;
     ...
     */
    public Oidsend() {
        super("oidsend", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
