...
public class Oidle extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 815134812;

    /**
     * The parameter <code>pg_catalog.oidle.RETURN_VALUE</code>.
     */
     ...
     */
    public Oidle() {
        super("oidle", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
