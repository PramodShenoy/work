...
public class Substr1 extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = 858792257;
     ...
     */
    public Substr1() {
        super("substr", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
