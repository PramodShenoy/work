...
public class JsonbExistsAll extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 519779251;
     ...
     */
    public JsonbExistsAll() {
        super("jsonb_exists_all", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
