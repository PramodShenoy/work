...
public class JsonbOut extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -313765801;

    /**
     * The parameter <code>pg_catalog.jsonb_out.RETURN_VALUE</code>.
     */
     ...
     */
    public JsonbOut() {
        super("jsonb_out", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("cstring"));
