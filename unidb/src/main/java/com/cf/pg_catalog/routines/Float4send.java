...
public class Float4send extends AbstractRoutine<byte[]> {

    private static final long serialVersionUID = -886191630;

    /**
     * The parameter <code>pg_catalog.float4send.RETURN_VALUE</code>.
     */
    public static final Parameter<byte[]> RETURN_VALUE = createParameter("RETURN_VALUE", org.jooq.impl.SQLDataType.BLOB, false, false);

    /**
     * The parameter <code>pg_catalog.float4send._1</code>.
     */
     ...
     */
    public Float4send() {
        super("float4send", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BLOB);
