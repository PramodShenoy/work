...
public class TimestampGtTimestamptz extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 308928068;

    /**
     * The parameter <code>pg_catalog.timestamp_gt_timestamptz.RETURN_VALUE</code>.
     */
     ...
     */
    public TimestampGtTimestamptz() {
        super("timestamp_gt_timestamptz", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
