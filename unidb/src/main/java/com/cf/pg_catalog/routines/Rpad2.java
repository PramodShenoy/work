...
public class Rpad2 extends AbstractRoutine<String> {

    private static final long serialVersionUID = -438646926;
     ...
     */
    public Rpad2() {
        super("rpad", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.CLOB);
