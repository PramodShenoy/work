...
public class NumericMul extends AbstractRoutine<BigDecimal> {

    private static final long serialVersionUID = -1405719565;

    /**
     * The parameter <code>pg_catalog.numeric_mul.RETURN_VALUE</code>.
     */
     ...
     */
    public NumericMul() {
        super("numeric_mul", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.NUMERIC);
