...
public class Float8mul extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1313235000;

    /**
     * The parameter <code>pg_catalog.float8mul.RETURN_VALUE</code>.
     */
     ...
     */
    public Float8mul() {
        super("float8mul", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
