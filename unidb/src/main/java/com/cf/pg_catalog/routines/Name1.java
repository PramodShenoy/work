...
public class Name1 extends AbstractRoutine<String> {

    private static final long serialVersionUID = -1552408520;
     ...
     */
    public Name1() {
        super("name", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.VARCHAR);
