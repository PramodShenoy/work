...
public class Int82mi extends AbstractRoutine<Long> {
    ...
    private static final long serialVersionUID = -635067963;

    /**
     * The parameter <code>pg_catalog.int82mi.RETURN_VALUE</code>.
     */
     ...
     */
    public Int82mi() {
        super("int82mi", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BIGINT);
