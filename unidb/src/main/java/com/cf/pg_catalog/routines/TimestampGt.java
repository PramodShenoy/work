...
public class TimestampGt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 974145818;
     ...
     */
    public TimestampGt() {
        super("timestamp_gt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
