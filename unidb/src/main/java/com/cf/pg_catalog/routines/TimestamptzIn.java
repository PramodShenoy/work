...
public class TimestamptzIn extends AbstractRoutine<Timestamp> {

    private static final long serialVersionUID = 102783187;

    /**
     * The parameter <code>pg_catalog.timestamptz_in.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.timestamptz_in._1</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.timestamptz_in._2</code>.
     */
    public static final Parameter<Long> _2 = createParameter("_2", org.jooq.impl.SQLDataType.BIGINT, false, true);

    /**
     * The parameter <code>pg_catalog.timestamptz_in._3</code>.
     */
    ...
    public TimestamptzIn() {
        super("timestamptz_in", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.TIMESTAMP);
