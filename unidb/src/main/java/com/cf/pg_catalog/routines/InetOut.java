...
public class InetOut extends AbstractRoutine<Object> {

    private static final long serialVersionUID = -1295993713;

    /**
     * The parameter <code>pg_catalog.inet_out.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.inet_out._1</code>.
     */
     ...
     */
    public InetOut() {
        super("inet_out", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("cstring"));
