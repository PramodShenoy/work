...
public class Float4ne extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -202812414;

    /**
     * The parameter <code>pg_catalog.float4ne.RETURN_VALUE</code>.
     */
     ...
     */
    public Float4ne() {
        super("float4ne", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
