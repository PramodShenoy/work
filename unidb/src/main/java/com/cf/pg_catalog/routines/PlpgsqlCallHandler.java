...
public class PlpgsqlCallHandler extends AbstractRoutine<Object> {
    ...
    private static final long serialVersionUID = -477804587;

    /**
     * The parameter <code>pg_catalog.plpgsql_call_handler.RETURN_VALUE</code>.
     */
    ...
    public PlpgsqlCallHandler() {
        super("plpgsql_call_handler", PgCatalog.PG_CATALOG, org.jooq.impl.DefaultDataType.getDefaultDataType("language_handler"));
