...
public class Corr extends AbstractRoutine<Double> {

    private static final long serialVersionUID = 1185321724;

    /**
     * The parameter <code>pg_catalog.corr.RETURN_VALUE</code>.
     */
     ...
     */
    public Corr() {
        super("corr", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
