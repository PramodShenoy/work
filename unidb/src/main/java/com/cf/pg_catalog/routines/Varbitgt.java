...
public class Varbitgt extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -2117762584;
     ...
     */
    public Varbitgt() {
        super("varbitgt", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
