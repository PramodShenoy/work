...
public class Float8RegrSyy extends AbstractRoutine<Double> {

    private static final long serialVersionUID = -595966544;

    /**
     * The parameter <code>pg_catalog.float8_regr_syy.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.float8_regr_syy._1</code>.
     */
     ...
     */
    public Float8RegrSyy() {
        super("float8_regr_syy", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.DOUBLE);
