...
public class Regprocin extends AbstractRoutine<String> {

    private static final long serialVersionUID = 1533919167;

    /**
     * The parameter <code>pg_catalog.regprocin.RETURN_VALUE</code>.
     */
    ...
    /**
     * The parameter <code>pg_catalog.regprocin._1</code>.
     */
     ...
     */
    public Regprocin() {
        super("regprocin", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.VARCHAR);
