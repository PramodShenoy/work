...
public class Varbitle extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = 1324287232;
     ...
     */
    public Varbitle() {
        super("varbitle", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
