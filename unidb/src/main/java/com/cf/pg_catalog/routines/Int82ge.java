...
public class Int82ge extends AbstractRoutine<Boolean> {

    private static final long serialVersionUID = -954564801;

    /**
     * The parameter <code>pg_catalog.int82ge.RETURN_VALUE</code>.
     */
     ...
     */
    public Int82ge() {
        super("int82ge", PgCatalog.PG_CATALOG, org.jooq.impl.SQLDataType.BOOLEAN);
