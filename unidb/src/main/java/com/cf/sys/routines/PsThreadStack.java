...
public class PsThreadStack extends AbstractRoutine<String> {
    ...
    private static final long serialVersionUID = -144115621;
     ...
     */
    public static final Parameter<ULong> THD_ID = createParameter("thd_id", org.jooq.impl.SQLDataType.BIGINTUNSIGNED, false, false);

    /**
     * The parameter <code>sys.ps_thread_stack.debug</code>.
     */
    public static final Parameter<Byte> DEBUG = createParameter("debug", org.jooq.impl.SQLDataType.TINYINT, false, false);
