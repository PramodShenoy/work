...
public class PsIsAccountEnabled extends AbstractRoutine<String> {
    ...
    private static final long serialVersionUID = 2065442020;
     ...
     */
    public static final Parameter<String> IN_HOST = createParameter("in_host", org.jooq.impl.SQLDataType.VARCHAR(60), false, false);

    /**
     * The parameter <code>sys.ps_is_account_enabled.in_user</code>.
     */
    public static final Parameter<String> IN_USER = createParameter("in_user", org.jooq.impl.SQLDataType.VARCHAR(32), false, false);
