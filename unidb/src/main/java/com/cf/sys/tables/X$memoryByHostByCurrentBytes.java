...
import com.cf.sys.tables.records.X$memoryByHostByCurrentBytesRecord;
...
public class X$memoryByHostByCurrentBytes extends TableImpl<X$memoryByHostByCurrentBytesRecord> {
    ...
    private static final long serialVersionUID = -1588705954;
     ...
     */
    public final TableField<X$memoryByHostByCurrentBytesRecord, String> HOST = createField("host", org.jooq.impl.SQLDataType.VARCHAR(60), this, "");
