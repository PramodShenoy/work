...
import com.cf.sys.enums.X$processlistTrxAutocommit;
import com.cf.sys.enums.X$processlistTrxState;
import com.cf.sys.tables.records.X$processlistRecord;
...
public class X$processlist extends TableImpl<X$processlistRecord> {
    ...
    private static final long serialVersionUID = 692288327;
     ...
     */
    public final TableField<X$processlistRecord, X$processlistTrxState> TRX_STATE = createField("trx_state", org.jooq.impl.SQLDataType.VARCHAR(11).asEnumDataType(com.cf.sys.enums.X$processlistTrxState.class), this, "");

    /**
     * The column <code>sys.x$processlist.trx_autocommit</code>.
     */
    public final TableField<X$processlistRecord, X$processlistTrxAutocommit> TRX_AUTOCOMMIT = createField("trx_autocommit", org.jooq.impl.SQLDataType.VARCHAR(3).asEnumDataType(com.cf.sys.enums.X$processlistTrxAutocommit.class), this, "");
