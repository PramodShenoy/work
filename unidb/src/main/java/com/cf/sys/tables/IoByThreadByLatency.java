...
import com.cf.sys.tables.records.IoByThreadByLatencyRecord;
...
public class IoByThreadByLatency extends TableImpl<IoByThreadByLatencyRecord> {
    ...
    private static final long serialVersionUID = -726023009;
     ...
     */
    public final TableField<IoByThreadByLatencyRecord, String> USER = createField("user", org.jooq.impl.SQLDataType.VARCHAR(128), this, "");
