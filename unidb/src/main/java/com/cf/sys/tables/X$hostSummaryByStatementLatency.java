...
import com.cf.sys.tables.records.X$hostSummaryByStatementLatencyRecord;
...
public class X$hostSummaryByStatementLatency extends TableImpl<X$hostSummaryByStatementLatencyRecord> {
    ...
    private static final long serialVersionUID = -22635697;
     ...
     */
    public final TableField<X$hostSummaryByStatementLatencyRecord, String> HOST = createField("host", org.jooq.impl.SQLDataType.VARCHAR(60), this, "");
