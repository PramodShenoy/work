...
import com.cf.sys.tables.records.StatementsWithErrorsOrWarningsRecord;
...
public class StatementsWithErrorsOrWarnings extends TableImpl<StatementsWithErrorsOrWarningsRecord> {
    ...
    private static final long serialVersionUID = -1009239059;
     ...
     */
    public final TableField<StatementsWithErrorsOrWarningsRecord, Timestamp> FIRST_SEEN = createField("first_seen", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0000-00-00 00:00:00", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>sys.statements_with_errors_or_warnings.last_seen</code>.
     */
    public final TableField<StatementsWithErrorsOrWarningsRecord, Timestamp> LAST_SEEN = createField("last_seen", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0000-00-00 00:00:00", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>sys.statements_with_errors_or_warnings.digest</code>.
     */
    public final TableField<StatementsWithErrorsOrWarningsRecord, String> DIGEST = createField("digest", org.jooq.impl.SQLDataType.VARCHAR(32), this, "");
