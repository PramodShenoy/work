...
import com.cf.sys.tables.records.SchemaAutoIncrementColumnsRecord;
...
public class SchemaAutoIncrementColumns extends TableImpl<SchemaAutoIncrementColumnsRecord> {
    ...
    private static final long serialVersionUID = 986213839;
     ...
     */
    public final TableField<SchemaAutoIncrementColumnsRecord, String> TABLE_SCHEMA = createField("table_schema", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>sys.schema_auto_increment_columns.table_name</code>.
     */
    public final TableField<SchemaAutoIncrementColumnsRecord, String> TABLE_NAME = createField("table_name", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>sys.schema_auto_increment_columns.column_name</code>.
     */
    public final TableField<SchemaAutoIncrementColumnsRecord, String> COLUMN_NAME = createField("column_name", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>sys.schema_auto_increment_columns.data_type</code>.
     */
    public final TableField<SchemaAutoIncrementColumnsRecord, String> DATA_TYPE = createField("data_type", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
     ...
     */
    public final TableField<SchemaAutoIncrementColumnsRecord, Integer> IS_SIGNED = createField("is_signed", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>sys.schema_auto_increment_columns.is_unsigned</code>.
     */
    public final TableField<SchemaAutoIncrementColumnsRecord, Integer> IS_UNSIGNED = createField("is_unsigned", org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");
     ...
     */
    public final TableField<SchemaAutoIncrementColumnsRecord, BigDecimal> AUTO_INCREMENT_RATIO = createField("auto_increment_ratio", org.jooq.impl.SQLDataType.DECIMAL(25, 4), this, "");
