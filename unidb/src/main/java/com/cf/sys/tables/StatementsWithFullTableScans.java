...
import com.cf.sys.tables.records.StatementsWithFullTableScansRecord;
...
public class StatementsWithFullTableScans extends TableImpl<StatementsWithFullTableScansRecord> {
    ...
    private static final long serialVersionUID = -1198833802;
     ...
     */
    public final TableField<StatementsWithFullTableScansRecord, Timestamp> FIRST_SEEN = createField("first_seen", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0000-00-00 00:00:00", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>sys.statements_with_full_table_scans.last_seen</code>.
     */
    public final TableField<StatementsWithFullTableScansRecord, Timestamp> LAST_SEEN = createField("last_seen", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0000-00-00 00:00:00", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>sys.statements_with_full_table_scans.digest</code>.
     */
    public final TableField<StatementsWithFullTableScansRecord, String> DIGEST = createField("digest", org.jooq.impl.SQLDataType.VARCHAR(32), this, "");
