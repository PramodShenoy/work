...
import com.cf.sys.enums.ProcesslistTrxAutocommit;
import com.cf.sys.enums.ProcesslistTrxState;
import com.cf.sys.tables.records.ProcesslistRecord;
...
public class Processlist extends TableImpl<ProcesslistRecord> {
    ...
    private static final long serialVersionUID = 1772070008;
     ...
     */
    public final TableField<ProcesslistRecord, String> USER = createField("user", org.jooq.impl.SQLDataType.VARCHAR(128), this, "");
     ...
     */
    public final TableField<ProcesslistRecord, ProcesslistTrxState> TRX_STATE = createField("trx_state", org.jooq.impl.SQLDataType.VARCHAR(11).asEnumDataType(com.cf.sys.enums.ProcesslistTrxState.class), this, "");

    /**
     * The column <code>sys.processlist.trx_autocommit</code>.
     */
    public final TableField<ProcesslistRecord, ProcesslistTrxAutocommit> TRX_AUTOCOMMIT = createField("trx_autocommit", org.jooq.impl.SQLDataType.VARCHAR(3).asEnumDataType(com.cf.sys.enums.ProcesslistTrxAutocommit.class), this, "");
