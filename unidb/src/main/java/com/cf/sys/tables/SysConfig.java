...
import com.cf.sys.Indexes;
import com.cf.sys.Keys;
import com.cf.sys.Sys;
import com.cf.sys.tables.records.SysConfigRecord;
...
public class SysConfig extends TableImpl<SysConfigRecord> {
    ...
    private static final long serialVersionUID = -70005893;
     ...
     */
    public final TableField<SysConfigRecord, Timestamp> SET_TIME = createField("set_time", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("CURRENT_TIMESTAMP", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
