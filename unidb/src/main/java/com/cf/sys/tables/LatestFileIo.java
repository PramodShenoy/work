...
import com.cf.sys.tables.records.LatestFileIoRecord;
...
public class LatestFileIo extends TableImpl<LatestFileIoRecord> {
    ...
    private static final long serialVersionUID = -179930449;
     ...
     */
    public final TableField<LatestFileIoRecord, String> THREAD = createField("thread", org.jooq.impl.SQLDataType.VARCHAR(149), this, "");
