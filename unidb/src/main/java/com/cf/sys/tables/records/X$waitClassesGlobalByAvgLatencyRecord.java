...
public class X$waitClassesGlobalByAvgLatencyRecord extends TableRecordImpl<X$waitClassesGlobalByAvgLatencyRecord> implements Record6<String, BigInteger, BigInteger, ULong, BigDecimal, ULong> {
    ...
    private static final long serialVersionUID = -1339374680;
    ...
    public Field<String> field1() {
        return X$waitClassesGlobalByAvgLatency.X$WAIT_CLASSES_GLOBAL_BY_AVG_LATENCY.EVENT_CLASS;
    }
    ...
    public Field<BigInteger> field2() {
        return X$waitClassesGlobalByAvgLatency.X$WAIT_CLASSES_GLOBAL_BY_AVG_LATENCY.TOTAL;
    }
    ...
    public Field<BigInteger> field3() {
        return X$waitClassesGlobalByAvgLatency.X$WAIT_CLASSES_GLOBAL_BY_AVG_LATENCY.TOTAL_LATENCY;
    }
    ...
    public Field<ULong> field4() {
        return X$waitClassesGlobalByAvgLatency.X$WAIT_CLASSES_GLOBAL_BY_AVG_LATENCY.MIN_LATENCY;
    }
    ...
    public Field<BigDecimal> field5() {
        return X$waitClassesGlobalByAvgLatency.X$WAIT_CLASSES_GLOBAL_BY_AVG_LATENCY.AVG_LATENCY;
    }
    ...
    public Field<ULong> field6() {
        return X$waitClassesGlobalByAvgLatency.X$WAIT_CLASSES_GLOBAL_BY_AVG_LATENCY.MAX_LATENCY;
    }
    ...
    public X$waitClassesGlobalByAvgLatencyRecord() {
        super(X$waitClassesGlobalByAvgLatency.X$WAIT_CLASSES_GLOBAL_BY_AVG_LATENCY);
    }
