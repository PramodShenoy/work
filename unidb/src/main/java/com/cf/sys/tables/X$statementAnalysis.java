...
import com.cf.sys.tables.records.X$statementAnalysisRecord;
...
public class X$statementAnalysis extends TableImpl<X$statementAnalysisRecord> {
    ...
    private static final long serialVersionUID = 1653458293;
     ...
     */
    public final TableField<X$statementAnalysisRecord, String> DIGEST = createField("digest", org.jooq.impl.SQLDataType.VARCHAR(32), this, "");

    /**
     * The column <code>sys.x$statement_analysis.first_seen</code>.
     */
    public final TableField<X$statementAnalysisRecord, Timestamp> FIRST_SEEN = createField("first_seen", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0000-00-00 00:00:00", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>sys.x$statement_analysis.last_seen</code>.
     */
    public final TableField<X$statementAnalysisRecord, Timestamp> LAST_SEEN = createField("last_seen", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0000-00-00 00:00:00", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
