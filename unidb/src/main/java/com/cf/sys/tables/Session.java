...
import com.cf.sys.enums.SessionTrxAutocommit;
import com.cf.sys.enums.SessionTrxState;
import com.cf.sys.tables.records.SessionRecord;
...
public class Session extends TableImpl<SessionRecord> {
    ...
    private static final long serialVersionUID = -1556646850;
     ...
     */
    public final TableField<SessionRecord, String> USER = createField("user", org.jooq.impl.SQLDataType.VARCHAR(128), this, "");
     ...
     */
    public final TableField<SessionRecord, SessionTrxState> TRX_STATE = createField("trx_state", org.jooq.impl.SQLDataType.VARCHAR(11).asEnumDataType(com.cf.sys.enums.SessionTrxState.class), this, "");

    /**
     * The column <code>sys.session.trx_autocommit</code>.
     */
    public final TableField<SessionRecord, SessionTrxAutocommit> TRX_AUTOCOMMIT = createField("trx_autocommit", org.jooq.impl.SQLDataType.VARCHAR(3).asEnumDataType(com.cf.sys.enums.SessionTrxAutocommit.class), this, "");
