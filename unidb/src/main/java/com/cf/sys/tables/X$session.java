...
import com.cf.sys.enums.X$sessionTrxAutocommit;
import com.cf.sys.enums.X$sessionTrxState;
import com.cf.sys.tables.records.X$sessionRecord;
...
public class X$session extends TableImpl<X$sessionRecord> {
    ...
    private static final long serialVersionUID = -1865273829;
     ...
     */
    public final TableField<X$sessionRecord, String> USER = createField("user", org.jooq.impl.SQLDataType.VARCHAR(128), this, "");
     ...
     */
    public final TableField<X$sessionRecord, X$sessionTrxState> TRX_STATE = createField("trx_state", org.jooq.impl.SQLDataType.VARCHAR(11).asEnumDataType(com.cf.sys.enums.X$sessionTrxState.class), this, "");

    /**
     * The column <code>sys.x$session.trx_autocommit</code>.
     */
    public final TableField<X$sessionRecord, X$sessionTrxAutocommit> TRX_AUTOCOMMIT = createField("trx_autocommit", org.jooq.impl.SQLDataType.VARCHAR(3).asEnumDataType(com.cf.sys.enums.X$sessionTrxAutocommit.class), this, "");
