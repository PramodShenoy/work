...
import com.cf.sys.tables.records.StatementsWithTempTablesRecord;
...
public class StatementsWithTempTables extends TableImpl<StatementsWithTempTablesRecord> {
    ...
    private static final long serialVersionUID = -1059635501;
     ...
     */
    public final TableField<StatementsWithTempTablesRecord, Timestamp> FIRST_SEEN = createField("first_seen", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0000-00-00 00:00:00", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>sys.statements_with_temp_tables.last_seen</code>.
     */
    public final TableField<StatementsWithTempTablesRecord, Timestamp> LAST_SEEN = createField("last_seen", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0000-00-00 00:00:00", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>sys.statements_with_temp_tables.digest</code>.
     */
    public final TableField<StatementsWithTempTablesRecord, String> DIGEST = createField("digest", org.jooq.impl.SQLDataType.VARCHAR(32), this, "");
