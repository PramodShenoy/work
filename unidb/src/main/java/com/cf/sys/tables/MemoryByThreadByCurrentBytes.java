...
import com.cf.sys.tables.records.MemoryByThreadByCurrentBytesRecord;
...
public class MemoryByThreadByCurrentBytes extends TableImpl<MemoryByThreadByCurrentBytesRecord> {
    ...
    private static final long serialVersionUID = -522918062;
     ...
     */
    public final TableField<MemoryByThreadByCurrentBytesRecord, String> USER = createField("user", org.jooq.impl.SQLDataType.VARCHAR(128), this, "");
