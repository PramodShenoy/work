...
public class X$hostSummaryByStagesRecord extends TableRecordImpl<X$hostSummaryByStagesRecord> implements Record5<String, String, ULong, ULong, ULong> {
    ...
    private static final long serialVersionUID = -1317598145;
    ...
    public Field<String> field1() {
        return X$hostSummaryByStages.X$HOST_SUMMARY_BY_STAGES.HOST;
    }
    ...
    public Field<String> field2() {
        return X$hostSummaryByStages.X$HOST_SUMMARY_BY_STAGES.EVENT_NAME;
    }
    ...
    public Field<ULong> field3() {
        return X$hostSummaryByStages.X$HOST_SUMMARY_BY_STAGES.TOTAL;
    }
    ...
    public Field<ULong> field4() {
        return X$hostSummaryByStages.X$HOST_SUMMARY_BY_STAGES.TOTAL_LATENCY;
    }
    ...
    public Field<ULong> field5() {
        return X$hostSummaryByStages.X$HOST_SUMMARY_BY_STAGES.AVG_LATENCY;
    }
    ...
    public X$hostSummaryByStagesRecord() {
        super(X$hostSummaryByStages.X$HOST_SUMMARY_BY_STAGES);
    }
