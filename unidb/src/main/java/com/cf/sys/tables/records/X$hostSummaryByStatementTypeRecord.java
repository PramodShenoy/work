...
public class X$hostSummaryByStatementTypeRecord extends TableRecordImpl<X$hostSummaryByStatementTypeRecord> implements Record10<String, String, ULong, ULong, ULong, ULong, ULong, ULong, ULong, ULong> {

    private static final long serialVersionUID = -1054504258;
     ...
     */
    @Override
    public X$hostSummaryByStatementTypeRecord values(String value1, String value2, ULong value3, ULong value4, ULong value5, ULong value6, ULong value7, ULong value8, ULong value9, ULong value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public X$hostSummaryByStatementTypeRecord(String host, String statement, ULong total, ULong totalLatency, ULong maxLatency, ULong lockLatency, ULong rowsSent, ULong rowsExamined, ULong rowsAffected, ULong fullScans) {
        super(X$hostSummaryByStatementType.X$HOST_SUMMARY_BY_STATEMENT_TYPE);
