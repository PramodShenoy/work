...
import com.cf.sys.tables.records.X$latestFileIoRecord;
...
public class X$latestFileIo extends TableImpl<X$latestFileIoRecord> {
    ...
    private static final long serialVersionUID = -1421068722;
     ...
     */
    public final TableField<X$latestFileIoRecord, String> THREAD = createField("thread", org.jooq.impl.SQLDataType.VARCHAR(149), this, "");
