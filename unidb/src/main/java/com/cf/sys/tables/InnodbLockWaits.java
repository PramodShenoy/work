...
import com.cf.sys.tables.records.InnodbLockWaitsRecord;
...
public class InnodbLockWaits extends TableImpl<InnodbLockWaitsRecord> {
    ...
    private static final long serialVersionUID = -1111439943;
     ...
     */
    public final TableField<InnodbLockWaitsRecord, String> LOCKED_TABLE = createField("locked_table", org.jooq.impl.SQLDataType.VARCHAR(1024).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>sys.innodb_lock_waits.locked_index</code>.
     */
    public final TableField<InnodbLockWaitsRecord, String> LOCKED_INDEX = createField("locked_index", org.jooq.impl.SQLDataType.VARCHAR(1024), this, "");

    /**
     * The column <code>sys.innodb_lock_waits.locked_type</code>.
     */
    public final TableField<InnodbLockWaitsRecord, String> LOCKED_TYPE = createField("locked_type", org.jooq.impl.SQLDataType.VARCHAR(32).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>sys.innodb_lock_waits.waiting_trx_id</code>.
     */
    public final TableField<InnodbLockWaitsRecord, String> WAITING_TRX_ID = createField("waiting_trx_id", org.jooq.impl.SQLDataType.VARCHAR(18).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
     ...
     */
    public final TableField<InnodbLockWaitsRecord, String> WAITING_LOCK_ID = createField("waiting_lock_id", org.jooq.impl.SQLDataType.VARCHAR(81).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>sys.innodb_lock_waits.waiting_lock_mode</code>.
     */
    public final TableField<InnodbLockWaitsRecord, String> WAITING_LOCK_MODE = createField("waiting_lock_mode", org.jooq.impl.SQLDataType.VARCHAR(32).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
     ...
     */
    public final TableField<InnodbLockWaitsRecord, String> BLOCKING_LOCK_MODE = createField("blocking_lock_mode", org.jooq.impl.SQLDataType.VARCHAR(32).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
     ...
     */
    public final TableField<InnodbLockWaitsRecord, String> SQL_KILL_BLOCKING_QUERY = createField("sql_kill_blocking_query", org.jooq.impl.SQLDataType.VARCHAR(32), this, "");

    /**
     * The column <code>sys.innodb_lock_waits.sql_kill_blocking_connection</code>.
     */
    public final TableField<InnodbLockWaitsRecord, String> SQL_KILL_BLOCKING_CONNECTION = createField("sql_kill_blocking_connection", org.jooq.impl.SQLDataType.VARCHAR(26), this, "");
