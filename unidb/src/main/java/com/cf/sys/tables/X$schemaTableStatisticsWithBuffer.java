...
import com.cf.sys.tables.records.X$schemaTableStatisticsWithBufferRecord;
...
public class X$schemaTableStatisticsWithBuffer extends TableImpl<X$schemaTableStatisticsWithBufferRecord> {
    ...
    private static final long serialVersionUID = -2136552646;
     ...
     */
    public final TableField<X$schemaTableStatisticsWithBufferRecord, String> TABLE_SCHEMA = createField("table_schema", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>sys.x$schema_table_statistics_with_buffer.table_name</code>.
     */
    public final TableField<X$schemaTableStatisticsWithBufferRecord, String> TABLE_NAME = createField("table_name", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");
