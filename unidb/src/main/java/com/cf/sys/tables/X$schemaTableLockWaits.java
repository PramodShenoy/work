...
import com.cf.sys.tables.records.X$schemaTableLockWaitsRecord;
...
public class X$schemaTableLockWaits extends TableImpl<X$schemaTableLockWaitsRecord> {
    ...
    private static final long serialVersionUID = -1702544498;
     ...
     */
    public final TableField<X$schemaTableLockWaitsRecord, String> OBJECT_SCHEMA = createField("object_schema", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>sys.x$schema_table_lock_waits.object_name</code>.
     */
    public final TableField<X$schemaTableLockWaitsRecord, String> OBJECT_NAME = createField("object_name", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");
     ...
     */
    public final TableField<X$schemaTableLockWaitsRecord, String> WAITING_LOCK_TYPE = createField("waiting_lock_type", org.jooq.impl.SQLDataType.VARCHAR(32).nullable(false), this, "");

    /**
     * The column <code>sys.x$schema_table_lock_waits.waiting_lock_duration</code>.
     */
    public final TableField<X$schemaTableLockWaitsRecord, String> WAITING_LOCK_DURATION = createField("waiting_lock_duration", org.jooq.impl.SQLDataType.VARCHAR(32).nullable(false), this, "");
     ...
     */
    public final TableField<X$schemaTableLockWaitsRecord, String> BLOCKING_LOCK_TYPE = createField("blocking_lock_type", org.jooq.impl.SQLDataType.VARCHAR(32).nullable(false), this, "");

    /**
     * The column <code>sys.x$schema_table_lock_waits.blocking_lock_duration</code>.
     */
    public final TableField<X$schemaTableLockWaitsRecord, String> BLOCKING_LOCK_DURATION = createField("blocking_lock_duration", org.jooq.impl.SQLDataType.VARCHAR(32).nullable(false), this, "");

    /**
     * The column <code>sys.x$schema_table_lock_waits.sql_kill_blocking_query</code>.
     */
    public final TableField<X$schemaTableLockWaitsRecord, String> SQL_KILL_BLOCKING_QUERY = createField("sql_kill_blocking_query", org.jooq.impl.SQLDataType.VARCHAR(31), this, "");

    /**
     * The column <code>sys.x$schema_table_lock_waits.sql_kill_blocking_connection</code>.
     */
    public final TableField<X$schemaTableLockWaitsRecord, String> SQL_KILL_BLOCKING_CONNECTION = createField("sql_kill_blocking_connection", org.jooq.impl.SQLDataType.VARCHAR(25), this, "");
