...
import com.cf.information_schema.tables.records.ProfilingRecord;
...
public class Profiling extends TableImpl<ProfilingRecord> {
    ...
    private static final long serialVersionUID = 1500581810;
     ...
     */
    public final TableField<ProfilingRecord, BigDecimal> CPU_USER = createField("CPU_USER", org.jooq.impl.SQLDataType.DECIMAL(9, 6), this, "");

    /**
     * The column <code>information_schema.PROFILING.CPU_SYSTEM</code>.
     */
    public final TableField<ProfilingRecord, BigDecimal> CPU_SYSTEM = createField("CPU_SYSTEM", org.jooq.impl.SQLDataType.DECIMAL(9, 6), this, "");
     ...
     */
    public final TableField<ProfilingRecord, String> SOURCE_FUNCTION = createField("SOURCE_FUNCTION", org.jooq.impl.SQLDataType.VARCHAR(30), this, "");

    /**
     * The column <code>information_schema.PROFILING.SOURCE_FILE</code>.
     */
    public final TableField<ProfilingRecord, String> SOURCE_FILE = createField("SOURCE_FILE", org.jooq.impl.SQLDataType.VARCHAR(20), this, "");
