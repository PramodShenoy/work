...
import com.cf.information_schema.tables.records.InnodbSysTablespacesRecord;
...
public class InnodbSysTablespaces extends TableImpl<InnodbSysTablespacesRecord> {
    ...
    private static final long serialVersionUID = 1943129553;
     ...
     */
    public final TableField<InnodbSysTablespacesRecord, UInteger> FS_BLOCK_SIZE = createField("FS_BLOCK_SIZE", org.jooq.impl.SQLDataType.INTEGERUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.INTEGERUNSIGNED)), this, "");

    /**
     * The column <code>information_schema.INNODB_SYS_TABLESPACES.FILE_SIZE</code>.
     */
    public final TableField<InnodbSysTablespacesRecord, ULong> FILE_SIZE = createField("FILE_SIZE", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.BIGINTUNSIGNED)), this, "");

    /**
     * The column <code>information_schema.INNODB_SYS_TABLESPACES.ALLOCATED_SIZE</code>.
     */
    public final TableField<InnodbSysTablespacesRecord, ULong> ALLOCATED_SIZE = createField("ALLOCATED_SIZE", org.jooq.impl.SQLDataType.BIGINTUNSIGNED.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.BIGINTUNSIGNED)), this, "");
