...
import com.cf.information_schema.tables.records.EventsRecord;
...
public class Events extends TableImpl<EventsRecord> {
    ...
    private static final long serialVersionUID = 1817842417;
     ...
     */
    public final TableField<EventsRecord, Long> ORIGINATOR = createField("ORIGINATOR", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0", org.jooq.impl.SQLDataType.BIGINT)), this, "");
