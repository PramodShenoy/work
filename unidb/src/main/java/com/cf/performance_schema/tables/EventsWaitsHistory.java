...
import com.cf.performance_schema.enums.EventsWaitsHistoryNestingEventType;
import com.cf.performance_schema.tables.records.EventsWaitsHistoryRecord;
...
public class EventsWaitsHistory extends TableImpl<EventsWaitsHistoryRecord> {
    ...
    private static final long serialVersionUID = 1063908442;
     ...
     */
    public final TableField<EventsWaitsHistoryRecord, String> SOURCE = createField("SOURCE", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");
     ...
     */
    public final TableField<EventsWaitsHistoryRecord, String> OBJECT_SCHEMA = createField("OBJECT_SCHEMA", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>performance_schema.events_waits_history.OBJECT_NAME</code>.
     */
    public final TableField<EventsWaitsHistoryRecord, String> OBJECT_NAME = createField("OBJECT_NAME", org.jooq.impl.SQLDataType.VARCHAR(512), this, "");

    /**
     * The column <code>performance_schema.events_waits_history.INDEX_NAME</code>.
     */
    public final TableField<EventsWaitsHistoryRecord, String> INDEX_NAME = createField("INDEX_NAME", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>performance_schema.events_waits_history.OBJECT_TYPE</code>.
     */
    public final TableField<EventsWaitsHistoryRecord, String> OBJECT_TYPE = createField("OBJECT_TYPE", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");
     ...
     */
    public final TableField<EventsWaitsHistoryRecord, EventsWaitsHistoryNestingEventType> NESTING_EVENT_TYPE = createField("NESTING_EVENT_TYPE", org.jooq.impl.SQLDataType.VARCHAR(11).asEnumDataType(com.cf.performance_schema.enums.EventsWaitsHistoryNestingEventType.class), this, "");
