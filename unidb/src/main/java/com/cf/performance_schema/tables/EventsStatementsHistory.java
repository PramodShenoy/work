...
import com.cf.performance_schema.enums.EventsStatementsHistoryNestingEventType;
import com.cf.performance_schema.tables.records.EventsStatementsHistoryRecord;
...
public class EventsStatementsHistory extends TableImpl<EventsStatementsHistoryRecord> {
    ...
    private static final long serialVersionUID = 945975286;
     ...
     */
    public final TableField<EventsStatementsHistoryRecord, String> SOURCE = createField("SOURCE", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");
     ...
     */
    public final TableField<EventsStatementsHistoryRecord, String> DIGEST = createField("DIGEST", org.jooq.impl.SQLDataType.VARCHAR(32), this, "");
     ...
     */
    public final TableField<EventsStatementsHistoryRecord, String> CURRENT_SCHEMA = createField("CURRENT_SCHEMA", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>performance_schema.events_statements_history.OBJECT_TYPE</code>.
     */
    public final TableField<EventsStatementsHistoryRecord, String> OBJECT_TYPE = createField("OBJECT_TYPE", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>performance_schema.events_statements_history.OBJECT_SCHEMA</code>.
     */
    public final TableField<EventsStatementsHistoryRecord, String> OBJECT_SCHEMA = createField("OBJECT_SCHEMA", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>performance_schema.events_statements_history.OBJECT_NAME</code>.
     */
    public final TableField<EventsStatementsHistoryRecord, String> OBJECT_NAME = createField("OBJECT_NAME", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");
     ...
     */
    public final TableField<EventsStatementsHistoryRecord, String> RETURNED_SQLSTATE = createField("RETURNED_SQLSTATE", org.jooq.impl.SQLDataType.VARCHAR(5), this, "");

    /**
     * The column <code>performance_schema.events_statements_history.MESSAGE_TEXT</code>.
     */
    public final TableField<EventsStatementsHistoryRecord, String> MESSAGE_TEXT = createField("MESSAGE_TEXT", org.jooq.impl.SQLDataType.VARCHAR(128), this, "");
     ...
     */
    public final TableField<EventsStatementsHistoryRecord, EventsStatementsHistoryNestingEventType> NESTING_EVENT_TYPE = createField("NESTING_EVENT_TYPE", org.jooq.impl.SQLDataType.VARCHAR(11).asEnumDataType(com.cf.performance_schema.enums.EventsStatementsHistoryNestingEventType.class), this, "");
