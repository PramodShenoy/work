...
import com.cf.performance_schema.enums.ThreadsHistory;
import com.cf.performance_schema.enums.ThreadsInstrumented;
import com.cf.performance_schema.tables.records.ThreadsRecord;
...
public class Threads extends TableImpl<ThreadsRecord> {
    ...
    private static final long serialVersionUID = 342222230;
     ...
     */
    public final TableField<ThreadsRecord, String> PROCESSLIST_HOST = createField("PROCESSLIST_HOST", org.jooq.impl.SQLDataType.VARCHAR(60), this, "");
     ...
     */
    public final TableField<ThreadsRecord, ThreadsInstrumented> INSTRUMENTED = createField("INSTRUMENTED", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(com.cf.performance_schema.enums.ThreadsInstrumented.class), this, "");

    /**
     * The column <code>performance_schema.threads.HISTORY</code>.
     */
    public final TableField<ThreadsRecord, ThreadsHistory> HISTORY = createField("HISTORY", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(com.cf.performance_schema.enums.ThreadsHistory.class), this, "");
