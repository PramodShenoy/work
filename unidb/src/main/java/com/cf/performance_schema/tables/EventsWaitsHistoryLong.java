...
import com.cf.performance_schema.enums.EventsWaitsHistoryLongNestingEventType;
import com.cf.performance_schema.tables.records.EventsWaitsHistoryLongRecord;
...
public class EventsWaitsHistoryLong extends TableImpl<EventsWaitsHistoryLongRecord> {
    ...
    private static final long serialVersionUID = 1017986141;
     ...
     */
    public final TableField<EventsWaitsHistoryLongRecord, String> SOURCE = createField("SOURCE", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");
     ...
     */
    public final TableField<EventsWaitsHistoryLongRecord, String> OBJECT_SCHEMA = createField("OBJECT_SCHEMA", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>performance_schema.events_waits_history_long.OBJECT_NAME</code>.
     */
    public final TableField<EventsWaitsHistoryLongRecord, String> OBJECT_NAME = createField("OBJECT_NAME", org.jooq.impl.SQLDataType.VARCHAR(512), this, "");

    /**
     * The column <code>performance_schema.events_waits_history_long.INDEX_NAME</code>.
     */
    public final TableField<EventsWaitsHistoryLongRecord, String> INDEX_NAME = createField("INDEX_NAME", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>performance_schema.events_waits_history_long.OBJECT_TYPE</code>.
     */
    public final TableField<EventsWaitsHistoryLongRecord, String> OBJECT_TYPE = createField("OBJECT_TYPE", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");
     ...
     */
    public final TableField<EventsWaitsHistoryLongRecord, EventsWaitsHistoryLongNestingEventType> NESTING_EVENT_TYPE = createField("NESTING_EVENT_TYPE", org.jooq.impl.SQLDataType.VARCHAR(11).asEnumDataType(com.cf.performance_schema.enums.EventsWaitsHistoryLongNestingEventType.class), this, "");
