...
import com.cf.performance_schema.enums.EventsTransactionsCurrentAccessMode;
import com.cf.performance_schema.enums.EventsTransactionsCurrentAutocommit;
import com.cf.performance_schema.enums.EventsTransactionsCurrentNestingEventType;
import com.cf.performance_schema.enums.EventsTransactionsCurrentState;
import com.cf.performance_schema.tables.records.EventsTransactionsCurrentRecord;
...
public class EventsTransactionsCurrent extends TableImpl<EventsTransactionsCurrentRecord> {
    ...
    private static final long serialVersionUID = -490132893;
     ...
     */
    public final TableField<EventsTransactionsCurrentRecord, EventsTransactionsCurrentState> STATE = createField("STATE", org.jooq.impl.SQLDataType.VARCHAR(11).asEnumDataType(com.cf.performance_schema.enums.EventsTransactionsCurrentState.class), this, "");
     ...
     */
    public final TableField<EventsTransactionsCurrentRecord, EventsTransactionsCurrentAccessMode> ACCESS_MODE = createField("ACCESS_MODE", org.jooq.impl.SQLDataType.VARCHAR(10).asEnumDataType(com.cf.performance_schema.enums.EventsTransactionsCurrentAccessMode.class), this, "");
     ...
     */
    public final TableField<EventsTransactionsCurrentRecord, EventsTransactionsCurrentAutocommit> AUTOCOMMIT = createField("AUTOCOMMIT", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(com.cf.performance_schema.enums.EventsTransactionsCurrentAutocommit.class), this, "");
     ...
     */
    public final TableField<EventsTransactionsCurrentRecord, EventsTransactionsCurrentNestingEventType> NESTING_EVENT_TYPE = createField("NESTING_EVENT_TYPE", org.jooq.impl.SQLDataType.VARCHAR(11).asEnumDataType(com.cf.performance_schema.enums.EventsTransactionsCurrentNestingEventType.class), this, "");
