...
import com.cf.performance_schema.enums.EventsWaitsCurrentNestingEventType;
import com.cf.performance_schema.tables.records.EventsWaitsCurrentRecord;
...
public class EventsWaitsCurrent extends TableImpl<EventsWaitsCurrentRecord> {
    ...
    private static final long serialVersionUID = 564144991;
     ...
     */
    public final TableField<EventsWaitsCurrentRecord, String> SOURCE = createField("SOURCE", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");
     ...
     */
    public final TableField<EventsWaitsCurrentRecord, String> OBJECT_SCHEMA = createField("OBJECT_SCHEMA", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>performance_schema.events_waits_current.OBJECT_NAME</code>.
     */
    public final TableField<EventsWaitsCurrentRecord, String> OBJECT_NAME = createField("OBJECT_NAME", org.jooq.impl.SQLDataType.VARCHAR(512), this, "");

    /**
     * The column <code>performance_schema.events_waits_current.INDEX_NAME</code>.
     */
    public final TableField<EventsWaitsCurrentRecord, String> INDEX_NAME = createField("INDEX_NAME", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");

    /**
     * The column <code>performance_schema.events_waits_current.OBJECT_TYPE</code>.
     */
    public final TableField<EventsWaitsCurrentRecord, String> OBJECT_TYPE = createField("OBJECT_TYPE", org.jooq.impl.SQLDataType.VARCHAR(64), this, "");
     ...
     */
    public final TableField<EventsWaitsCurrentRecord, EventsWaitsCurrentNestingEventType> NESTING_EVENT_TYPE = createField("NESTING_EVENT_TYPE", org.jooq.impl.SQLDataType.VARCHAR(11).asEnumDataType(com.cf.performance_schema.enums.EventsWaitsCurrentNestingEventType.class), this, "");
