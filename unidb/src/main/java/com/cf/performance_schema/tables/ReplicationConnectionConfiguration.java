...
import com.cf.performance_schema.enums.ReplicationConnectionConfigurationAutoPosition;
import com.cf.performance_schema.enums.ReplicationConnectionConfigurationSslAllowed;
import com.cf.performance_schema.enums.ReplicationConnectionConfigurationSslVerifyServerCertificate;
import com.cf.performance_schema.tables.records.ReplicationConnectionConfigurationRecord;
...
public class ReplicationConnectionConfiguration extends TableImpl<ReplicationConnectionConfigurationRecord> {
    ...
    private static final long serialVersionUID = 182415716;
     ...
     */
    public final TableField<ReplicationConnectionConfigurationRecord, ReplicationConnectionConfigurationAutoPosition> AUTO_POSITION = createField("AUTO_POSITION", org.jooq.impl.SQLDataType.VARCHAR(1).nullable(false).asEnumDataType(com.cf.performance_schema.enums.ReplicationConnectionConfigurationAutoPosition.class), this, "");

    /**
     * The column <code>performance_schema.replication_connection_configuration.SSL_ALLOWED</code>.
     */
    public final TableField<ReplicationConnectionConfigurationRecord, ReplicationConnectionConfigurationSslAllowed> SSL_ALLOWED = createField("SSL_ALLOWED", org.jooq.impl.SQLDataType.VARCHAR(7).nullable(false).asEnumDataType(com.cf.performance_schema.enums.ReplicationConnectionConfigurationSslAllowed.class), this, "");
