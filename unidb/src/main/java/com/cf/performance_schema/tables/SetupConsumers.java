...
import com.cf.performance_schema.enums.SetupConsumersEnabled;
import com.cf.performance_schema.tables.records.SetupConsumersRecord;
...
public class SetupConsumers extends TableImpl<SetupConsumersRecord> {
    ...
    private static final long serialVersionUID = 1492966204;
     ...
     */
    public final TableField<SetupConsumersRecord, SetupConsumersEnabled> ENABLED = createField("ENABLED", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(com.cf.performance_schema.enums.SetupConsumersEnabled.class), this, "");
