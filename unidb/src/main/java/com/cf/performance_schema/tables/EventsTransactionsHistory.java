...
import com.cf.performance_schema.enums.EventsTransactionsHistoryAccessMode;
import com.cf.performance_schema.enums.EventsTransactionsHistoryAutocommit;
import com.cf.performance_schema.enums.EventsTransactionsHistoryNestingEventType;
import com.cf.performance_schema.enums.EventsTransactionsHistoryState;
import com.cf.performance_schema.tables.records.EventsTransactionsHistoryRecord;
...
public class EventsTransactionsHistory extends TableImpl<EventsTransactionsHistoryRecord> {
    ...
    private static final long serialVersionUID = 1206729967;
     ...
     */
    public final TableField<EventsTransactionsHistoryRecord, EventsTransactionsHistoryState> STATE = createField("STATE", org.jooq.impl.SQLDataType.VARCHAR(11).asEnumDataType(com.cf.performance_schema.enums.EventsTransactionsHistoryState.class), this, "");
     ...
     */
    public final TableField<EventsTransactionsHistoryRecord, EventsTransactionsHistoryAccessMode> ACCESS_MODE = createField("ACCESS_MODE", org.jooq.impl.SQLDataType.VARCHAR(10).asEnumDataType(com.cf.performance_schema.enums.EventsTransactionsHistoryAccessMode.class), this, "");
     ...
     */
    public final TableField<EventsTransactionsHistoryRecord, EventsTransactionsHistoryAutocommit> AUTOCOMMIT = createField("AUTOCOMMIT", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(com.cf.performance_schema.enums.EventsTransactionsHistoryAutocommit.class), this, "");
     ...
     */
    public final TableField<EventsTransactionsHistoryRecord, EventsTransactionsHistoryNestingEventType> NESTING_EVENT_TYPE = createField("NESTING_EVENT_TYPE", org.jooq.impl.SQLDataType.VARCHAR(11).asEnumDataType(com.cf.performance_schema.enums.EventsTransactionsHistoryNestingEventType.class), this, "");
