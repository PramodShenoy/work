...
import com.cf.performance_schema.enums.SetupTimersTimerName;
import com.cf.performance_schema.tables.records.SetupTimersRecord;
...
public class SetupTimers extends TableImpl<SetupTimersRecord> {
    ...
    private static final long serialVersionUID = 1318266441;
     ...
     */
    public final TableField<SetupTimersRecord, SetupTimersTimerName> TIMER_NAME = createField("TIMER_NAME", org.jooq.impl.SQLDataType.VARCHAR(11).nullable(false).asEnumDataType(com.cf.performance_schema.enums.SetupTimersTimerName.class), this, "");
