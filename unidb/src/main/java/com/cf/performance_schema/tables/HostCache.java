...
import com.cf.performance_schema.enums.HostCacheHostValidated;
import com.cf.performance_schema.tables.records.HostCacheRecord;
...
public class HostCache extends TableImpl<HostCacheRecord> {
    ...
    private static final long serialVersionUID = 627247284;
     ...
     */
    public final TableField<HostCacheRecord, String> HOST = createField("HOST", org.jooq.impl.SQLDataType.VARCHAR(255), this, "");

    /**
     * The column <code>performance_schema.host_cache.HOST_VALIDATED</code>.
     */
    public final TableField<HostCacheRecord, HostCacheHostValidated> HOST_VALIDATED = createField("HOST_VALIDATED", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).asEnumDataType(com.cf.performance_schema.enums.HostCacheHostValidated.class), this, "");
