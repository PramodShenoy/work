...
import com.cf.performance_schema.enums.SetupObjectsEnabled;
import com.cf.performance_schema.enums.SetupObjectsObjectType;
import com.cf.performance_schema.enums.SetupObjectsTimed;
import com.cf.performance_schema.tables.records.SetupObjectsRecord;
...
public class SetupObjects extends TableImpl<SetupObjectsRecord> {
    ...
    private static final long serialVersionUID = -1286623900;
     ...
     */
    public final TableField<SetupObjectsRecord, SetupObjectsEnabled> ENABLED = createField("ENABLED", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).defaultValue(org.jooq.impl.DSL.inline("YES", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(com.cf.performance_schema.enums.SetupObjectsEnabled.class), this, "");

    /**
     * The column <code>performance_schema.setup_objects.TIMED</code>.
     */
    public final TableField<SetupObjectsRecord, SetupObjectsTimed> TIMED = createField("TIMED", org.jooq.impl.SQLDataType.VARCHAR(3).nullable(false).defaultValue(org.jooq.impl.DSL.inline("YES", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(com.cf.performance_schema.enums.SetupObjectsTimed.class), this, "");
