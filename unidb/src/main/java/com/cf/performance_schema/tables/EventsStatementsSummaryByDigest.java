...
import com.cf.performance_schema.tables.records.EventsStatementsSummaryByDigestRecord;
...
public class EventsStatementsSummaryByDigest extends TableImpl<EventsStatementsSummaryByDigestRecord> {
    ...
    private static final long serialVersionUID = 1831569536;
     ...
     */
    public final TableField<EventsStatementsSummaryByDigestRecord, String> DIGEST = createField("DIGEST", org.jooq.impl.SQLDataType.VARCHAR(32), this, "");
     ...
     */
    public final TableField<EventsStatementsSummaryByDigestRecord, Timestamp> FIRST_SEEN = createField("FIRST_SEEN", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0000-00-00 00:00:00", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>performance_schema.events_statements_summary_by_digest.LAST_SEEN</code>.
     */
    public final TableField<EventsStatementsSummaryByDigestRecord, Timestamp> LAST_SEEN = createField("LAST_SEEN", org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.inline("0000-00-00 00:00:00", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
