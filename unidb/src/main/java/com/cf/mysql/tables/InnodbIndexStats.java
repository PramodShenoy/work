...
public class InnodbIndexStats extends TableImpl<InnodbIndexStatsRecord> {
    ...
    private static final long serialVersionUID = -797582205;
     ...
     */
    public final TableField<InnodbIndexStatsRecord, String> TABLE_NAME = createField("table_name", org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");
