...
public class TablesPriv extends TableImpl<TablesPrivRecord> {
    ...
    private static final long serialVersionUID = -1433659394;
     ...
     */
    public final TableField<TablesPrivRecord, String> HOST = createField("Host", org.jooq.impl.SQLDataType.CHAR(60).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.CHAR)), this, "");

    /**
     * The column <code>mysql.tables_priv.Db</code>.
     */
    public final TableField<TablesPrivRecord, String> DB = createField("Db", org.jooq.impl.SQLDataType.CHAR(64).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.CHAR)), this, "");

    /**
     * The column <code>mysql.tables_priv.User</code>.
     */
    public final TableField<TablesPrivRecord, String> USER = createField("User", org.jooq.impl.SQLDataType.CHAR(32).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.CHAR)), this, "");

    /**
     * The column <code>mysql.tables_priv.Table_name</code>.
     */
    public final TableField<TablesPrivRecord, String> TABLE_NAME = createField("Table_name", org.jooq.impl.SQLDataType.CHAR(64).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.CHAR)), this, "");

    /**
     * The column <code>mysql.tables_priv.Grantor</code>.
     */
    public final TableField<TablesPrivRecord, String> GRANTOR = createField("Grantor", org.jooq.impl.SQLDataType.CHAR(93).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.CHAR)), this, "");
     ...
     */
    public final TableField<TablesPrivRecord, String> TABLE_PRIV = createField("Table_priv", org.jooq.impl.SQLDataType.VARCHAR(98).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>mysql.tables_priv.Column_priv</code>.
     */
    public final TableField<TablesPrivRecord, String> COLUMN_PRIV = createField("Column_priv", org.jooq.impl.SQLDataType.VARCHAR(31).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");
    ...
    private TablesPriv(Name alias, Table<TablesPrivRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, "Table privileges");
    }
