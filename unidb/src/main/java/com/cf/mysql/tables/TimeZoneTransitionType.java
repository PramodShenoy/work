...
public class TimeZoneTransitionType extends TableImpl<TimeZoneTransitionTypeRecord> {
    ...
    private static final long serialVersionUID = -1485965806;
     ...
     */
    public final TableField<TimeZoneTransitionTypeRecord, String> ABBREVIATION = createField("Abbreviation", org.jooq.impl.SQLDataType.CHAR(8).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.CHAR)), this, "");
