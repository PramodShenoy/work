...
import com.cf.mysql.enums.FuncType;
...
public class Func extends TableImpl<FuncRecord> {
    ...
    private static final long serialVersionUID = -1966380807;
     ...
     */
    public final TableField<FuncRecord, FuncType> TYPE = createField("type", org.jooq.impl.SQLDataType.VARCHAR(9).nullable(false).asEnumDataType(com.cf.mysql.enums.FuncType.class), this, "");
