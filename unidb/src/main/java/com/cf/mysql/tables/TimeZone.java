...
import com.cf.mysql.enums.TimeZoneUseLeapSeconds;
...
public class TimeZone extends TableImpl<TimeZoneRecord> {
    ...
    private static final long serialVersionUID = 1581625570;
     ...
     */
    public final TableField<TimeZoneRecord, TimeZoneUseLeapSeconds> USE_LEAP_SECONDS = createField("Use_leap_seconds", org.jooq.impl.SQLDataType.VARCHAR(1).nullable(false).defaultValue(org.jooq.impl.DSL.inline("N", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(com.cf.mysql.enums.TimeZoneUseLeapSeconds.class), this, "");
