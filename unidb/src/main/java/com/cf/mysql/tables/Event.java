...
import com.cf.mysql.enums.EventIntervalField;
import com.cf.mysql.enums.EventOnCompletion;
import com.cf.mysql.enums.EventStatus;
...
public class Event extends TableImpl<EventRecord> {
    ...
    private static final long serialVersionUID = -230069423;
     ...
     */
    public final TableField<EventRecord, String> DB = createField("db", org.jooq.impl.SQLDataType.CHAR(64).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.CHAR)), this, "");

    /**
     * The column <code>mysql.event.name</code>.
     */
    public final TableField<EventRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.CHAR(64).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.CHAR)), this, "");
     ...
     */
    public final TableField<EventRecord, String> DEFINER = createField("definer", org.jooq.impl.SQLDataType.CHAR(93).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.CHAR)), this, "");
     ...
     */
    public final TableField<EventRecord, EventIntervalField> INTERVAL_FIELD = createField("interval_field", org.jooq.impl.SQLDataType.VARCHAR(18).asEnumDataType(com.cf.mysql.enums.EventIntervalField.class), this, "");
     ...
     */
    public final TableField<EventRecord, EventStatus> STATUS = createField("status", org.jooq.impl.SQLDataType.VARCHAR(18).nullable(false).defaultValue(org.jooq.impl.DSL.inline("ENABLED", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(com.cf.mysql.enums.EventStatus.class), this, "");

    /**
     * The column <code>mysql.event.on_completion</code>.
     */
    public final TableField<EventRecord, EventOnCompletion> ON_COMPLETION = createField("on_completion", org.jooq.impl.SQLDataType.VARCHAR(8).nullable(false).defaultValue(org.jooq.impl.DSL.inline("DROP", org.jooq.impl.SQLDataType.VARCHAR)).asEnumDataType(com.cf.mysql.enums.EventOnCompletion.class), this, "");

    /**
     * The column <code>mysql.event.sql_mode</code>.
     */
    public final TableField<EventRecord, String> SQL_MODE = createField("sql_mode", org.jooq.impl.SQLDataType.VARCHAR(478).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.VARCHAR)), this, "");

    /**
     * The column <code>mysql.event.comment</code>.
     */
    public final TableField<EventRecord, String> COMMENT = createField("comment", org.jooq.impl.SQLDataType.CHAR(64).nullable(false).defaultValue(org.jooq.impl.DSL.inline("", org.jooq.impl.SQLDataType.CHAR)), this, "");
     ...
     */
    public final TableField<EventRecord, String> TIME_ZONE = createField("time_zone", org.jooq.impl.SQLDataType.CHAR(64).nullable(false).defaultValue(org.jooq.impl.DSL.inline("SYSTEM", org.jooq.impl.SQLDataType.CHAR)), this, "");

    /**
     * The column <code>mysql.event.character_set_client</code>.
     */
    public final TableField<EventRecord, String> CHARACTER_SET_CLIENT = createField("character_set_client", org.jooq.impl.SQLDataType.CHAR(32), this, "");

    /**
     * The column <code>mysql.event.collation_connection</code>.
     */
    public final TableField<EventRecord, String> COLLATION_CONNECTION = createField("collation_connection", org.jooq.impl.SQLDataType.CHAR(32), this, "");

    /**
     * The column <code>mysql.event.db_collation</code>.
     */
    public final TableField<EventRecord, String> DB_COLLATION = createField("db_collation", org.jooq.impl.SQLDataType.CHAR(32), this, "");
